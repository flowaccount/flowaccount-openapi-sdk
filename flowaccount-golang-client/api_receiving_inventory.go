...
// ReceivingInventoryApiService ReceivingInventoryApi service
type ReceivingInventoryApiService service

/*
PurchasesEmailDocumentPost Send email receiving inventory document.
...
*/
func (a *ReceivingInventoryApiService) PurchasesEmailDocumentPost(ctx _context.Context, authorization string, sendEmailCoppies SendEmailCoppies) (SendEmailResponse, *_nethttp.Response, error) {
	var (
...
// PurchasesGetOpts Optional parameters for the method 'PurchasesGet'
type PurchasesGetOpts struct {
...
// PurchasesIdAttachmentPostOpts Optional parameters for the method 'PurchasesIdAttachmentPost'
type PurchasesIdAttachmentPostOpts struct {
 ...
 * @param optional nil or *PurchasesIdAttachmentPostOpts - Optional Parameters:
 * @param "File" (optional.Interface of *os.File) -  รูปแบบ file ที่ใช้แนบในเอกสารเป็นแบบ Binary
@return AttachmentResponse
*/
func (a *ReceivingInventoryApiService) PurchasesIdAttachmentPost(ctx _context.Context, authorization string, id string, localVarOptionals *PurchasesIdAttachmentPostOpts) (AttachmentResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
PurchasesIdDelete Delete receiving inventory document.
...
*/
func (a *ReceivingInventoryApiService) PurchasesIdDelete(ctx _context.Context, authorization string, id string) (DeleteResponse, *_nethttp.Response, error) {
	var (
...
/*
PurchasesIdGet Get receiving inventory document.
...
@return InlineDocumentResponse
*/
func (a *ReceivingInventoryApiService) PurchasesIdGet(ctx _context.Context, authorization string, id string) (InlineDocumentResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
PurchasesIdPut Edit receiving inventory document.
...
@return InlineDocumentResponse
*/
func (a *ReceivingInventoryApiService) PurchasesIdPut(ctx _context.Context, authorization string, id string, updateInlineDocument UpdateInlineDocument) (InlineDocumentResponse, *_nethttp.Response, error) {
	var (
...
@return InlineDocumentResponse
*/
func (a *ReceivingInventoryApiService) PurchasesIdStatusStatusIdPost(ctx _context.Context, authorization string, id string, statusId string) (InlineDocumentResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return InlineDocumentResponse
*/
func (a *ReceivingInventoryApiService) PurchasesInlinePost(ctx _context.Context, authorization string, inlineDocument InlineDocument) (InlineDocumentResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
PurchasesPost Create receiving inventory document.
...
*/
func (a *ReceivingInventoryApiService) PurchasesPost(ctx _context.Context, authorization string, simpleDocument SimpleDocument) (SimpleDocumentResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
PurchasesSharedocumentPost Share link receiving inventory document.
...
*/
func (a *ReceivingInventoryApiService) PurchasesSharedocumentPost(ctx _context.Context, authorization string, shareDocument ShareDocument) (ShareDocumentResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
PurchasesWithPaymentPost Create receiving inventory document with payment.
