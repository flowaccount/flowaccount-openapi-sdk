...
package openapi
// SimpleDocumentWithPaymentReceivingCreditCard struct for SimpleDocumentWithPaymentReceivingCreditCard
type SimpleDocumentWithPaymentReceivingCreditCard struct {
	...
	DocumentReference []UpgradeDocument `json:"documentReference,omitempty"`
	// สร้างเอกสารแบบ Simple พร้อมรับชำระเงิน ด้วยบัตรเครดิต
	DocumentPaymentStructureType *string `json:"documentPaymentStructureType"`
