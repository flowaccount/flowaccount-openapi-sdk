...
package openapi
// InlineDocumentResponseAllOfData struct for InlineDocumentResponseAllOfData
type InlineDocumentResponseAllOfData struct {
	// id ของเอกสาร
	...
	// มูลค่าหลังหักส่วนลด
	TotalAfterDiscount float32 `json:"totalAfterDiscount,omitempty"`
	// มูลค่าไม่รวมภาษีมูลค่าเพิ่ม
	TotalWithoutVat float32 `json:"totalWithoutVat,omitempty"`
	...
	Items []InlineProductItem `json:"items,omitempty"`
	// ข้อมูลเอกสารปลายทางที่อ้างอิง ถึง เอกสารฉบับนี้
	ReferencedToMe []ReferencedToMe `json:"referencedToMe,omitempty"`
	// เอกสารต้นทางที่อ้างอิง ถึง เอกสารฉบับนี้
	ReferencedByMe []ReferencedByMe `json:"referencedByMe,omitempty"`
	Payments SimpleDocumentResponseAllOfDataPayments `json:"payments,omitempty"`
	Company SimpleDocumentResponseAllOfDataCompany `json:"company,omitempty"`
