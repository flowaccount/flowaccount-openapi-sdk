...
package openapi
// SimpleDocumentResponseAllOfData struct for SimpleDocumentResponseAllOfData
type SimpleDocumentResponseAllOfData struct {
	// id ของเอกสาร
	...
	Items []SimpleProductItem `json:"items,omitempty"`
