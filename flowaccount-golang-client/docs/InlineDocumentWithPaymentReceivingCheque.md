...
**DocumentPaymentStructureType** | Pointer to **string** | สร้างเอกสารแบบ Inline พร้อมรับชำระเงิน ด้วยเช็ค | 
**PaymentMethod** | **int64** | ประเภทการเก็บเงิน &lt;br&gt; 3 &#x3D; เช็ค | [default to 1]
