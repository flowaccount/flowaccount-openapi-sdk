...
**ExpensePaymentStructureType** | Pointer to **string** | สร้างเอกสารแบบ Simple พร้อมชำระเงิน ด้วยเช็ค | 
**PaymentMethod** | **int64** | ประเภทการชำระเงิน &lt;br&gt; 3 &#x3D; เช็ค | [default to 1]
...
**PaymentCharge** | **float32** | ค่าธรรมเนียม ที่ชำระโดยเช็ค &lt;br&gt; &lt;ex&gt; Example : 100.00 &lt;/ex&gt; | [optional] [default to 0]
