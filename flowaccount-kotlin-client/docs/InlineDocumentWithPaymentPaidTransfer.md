...
**documentPaymentStructureType** | **kotlin.String** | สร้างเอกสารแบบ Inline พร้อมชำระเงิน ด้วยการโอนเงิน | 
**paymentMethod** | **kotlin.Long** | ประเภทการชำระเงิน &lt;br&gt; 5 &#x3D; โอนเงิน  | 
...
**bankAccountId** | **kotlin.Long** | เลข id บัญชีธนาคารที่ใช้ชำระเงิน &lt;br&gt;&lt;red&gt;สามารถ GET มาได้จาก My Company &gt; Bank Account &lt;/red&gt;&lt;br&gt; &lt;ex&gt;Example: 12345&lt;/ex&gt; |  [optional]
**paymentCharge** | [**java.math.BigDecimal**](java.math.BigDecimal.md) | ค่าธรรมเนียม ที่ชำระโดยการโอนเงิน &lt;ex&gt; Example : 100.00 &lt;/ex&gt; |  [optional]
