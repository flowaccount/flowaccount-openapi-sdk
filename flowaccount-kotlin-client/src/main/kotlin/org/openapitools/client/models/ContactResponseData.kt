...
/**
 * 
 * @param total จำนวนรายชื่อติดต่อทั้งหมด
 * @param currentPage หน้าที่แสดงรายชื่อผู้ติดต่อ
 * @param list ข้อมูลรายชื่อผู้ติดต่อ
 * @param isDB database
 */

data class ContactResponseData (
    ...
    @Json(name = "list")
    val list: kotlin.Array<Contact>? = null,
    /* database */
    @Json(name = "isDB")
