...
public class PaymentReceivingCreditCard {
  ...
  public boolean equals(Object o) {
    ...
    return (this.paymentStructureType == null ? paymentReceivingCreditCard.paymentStructureType == null : this.paymentStructureType.equals(paymentReceivingCreditCard.paymentStructureType)) &&
        (this.documentId == null ? paymentReceivingCreditCard.documentId == null : this.documentId.equals(paymentReceivingCreditCard.documentId)) &&
        (this.paymentMethod == null ? paymentReceivingCreditCard.paymentMethod == null : this.paymentMethod.equals(paymentReceivingCreditCard.paymentMethod)) &&
        (this.paymentDate == null ? paymentReceivingCreditCard.paymentDate == null : this.paymentDate.equals(paymentReceivingCreditCard.paymentDate)) &&
        (this.collected == null ? paymentReceivingCreditCard.collected == null : this.collected.equals(paymentReceivingCreditCard.collected)) &&
        (this.paymentDeductionType == null ? paymentReceivingCreditCard.paymentDeductionType == null : this.paymentDeductionType.equals(paymentReceivingCreditCard.paymentDeductionType)) &&
        (this.paymentDeductionAmount == null ? paymentReceivingCreditCard.paymentDeductionAmount == null : this.paymentDeductionAmount.equals(paymentReceivingCreditCard.paymentDeductionAmount)) &&
        (this.withheldPercentage == null ? paymentReceivingCreditCard.withheldPercentage == null : this.withheldPercentage.equals(paymentReceivingCreditCard.withheldPercentage)) &&
        (this.withheldAmount == null ? paymentReceivingCreditCard.withheldAmount == null : this.withheldAmount.equals(paymentReceivingCreditCard.withheldAmount)) &&
        (this.creditCardBankAccountId == null ? paymentReceivingCreditCard.creditCardBankAccountId == null : this.creditCardBankAccountId.equals(paymentReceivingCreditCard.creditCardBankAccountId)) &&
        (this.paymentRemarks == null ? paymentReceivingCreditCard.paymentRemarks == null : this.paymentRemarks.equals(paymentReceivingCreditCard.paymentRemarks)) &&
        (this.remainingCollectedType == null ? paymentReceivingCreditCard.remainingCollectedType == null : this.remainingCollectedType.equals(paymentReceivingCreditCard.remainingCollectedType)) &&
        (this.remainingCollected == null ? paymentReceivingCreditCard.remainingCollected == null : this.remainingCollected.equals(paymentReceivingCreditCard.remainingCollected));
  }
