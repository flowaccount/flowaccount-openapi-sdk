...
public class PaymentReceivingTransfer {
  ...
  public boolean equals(Object o) {
    ...
    return (this.paymentStructureType == null ? paymentReceivingTransfer.paymentStructureType == null : this.paymentStructureType.equals(paymentReceivingTransfer.paymentStructureType)) &&
        (this.documentId == null ? paymentReceivingTransfer.documentId == null : this.documentId.equals(paymentReceivingTransfer.documentId)) &&
        (this.paymentMethod == null ? paymentReceivingTransfer.paymentMethod == null : this.paymentMethod.equals(paymentReceivingTransfer.paymentMethod)) &&
        (this.paymentDate == null ? paymentReceivingTransfer.paymentDate == null : this.paymentDate.equals(paymentReceivingTransfer.paymentDate)) &&
        (this.collected == null ? paymentReceivingTransfer.collected == null : this.collected.equals(paymentReceivingTransfer.collected)) &&
        (this.paymentDeductionType == null ? paymentReceivingTransfer.paymentDeductionType == null : this.paymentDeductionType.equals(paymentReceivingTransfer.paymentDeductionType)) &&
        (this.paymentDeductionAmount == null ? paymentReceivingTransfer.paymentDeductionAmount == null : this.paymentDeductionAmount.equals(paymentReceivingTransfer.paymentDeductionAmount)) &&
        (this.withheldPercentage == null ? paymentReceivingTransfer.withheldPercentage == null : this.withheldPercentage.equals(paymentReceivingTransfer.withheldPercentage)) &&
        (this.withheldAmount == null ? paymentReceivingTransfer.withheldAmount == null : this.withheldAmount.equals(paymentReceivingTransfer.withheldAmount)) &&
        (this.transferBankAccountId == null ? paymentReceivingTransfer.transferBankAccountId == null : this.transferBankAccountId.equals(paymentReceivingTransfer.transferBankAccountId)) &&
        (this.bankAccountId == null ? paymentReceivingTransfer.bankAccountId == null : this.bankAccountId.equals(paymentReceivingTransfer.bankAccountId)) &&
        (this.paymentRemarks == null ? paymentReceivingTransfer.paymentRemarks == null : this.paymentRemarks.equals(paymentReceivingTransfer.paymentRemarks)) &&
        (this.remainingCollectedType == null ? paymentReceivingTransfer.remainingCollectedType == null : this.remainingCollectedType.equals(paymentReceivingTransfer.remainingCollectedType)) &&
        (this.remainingCollected == null ? paymentReceivingTransfer.remainingCollected == null : this.remainingCollected.equals(paymentReceivingTransfer.remainingCollected));
  }
