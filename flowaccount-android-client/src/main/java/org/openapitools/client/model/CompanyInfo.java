...
public class CompanyInfo {
  ...
  public boolean equals(Object o) {
    ...
    return (this.companyType == null ? companyInfo.companyType == null : this.companyType.equals(companyInfo.companyType)) &&
        (this.compnayName == null ? companyInfo.compnayName == null : this.compnayName.equals(companyInfo.compnayName)) &&
        (this.companyNameEn == null ? companyInfo.companyNameEn == null : this.companyNameEn.equals(companyInfo.companyNameEn)) &&
        (this.companyAddress == null ? companyInfo.companyAddress == null : this.companyAddress.equals(companyInfo.companyAddress)) &&
        (this.companyAddressEn == null ? companyInfo.companyAddressEn == null : this.companyAddressEn.equals(companyInfo.companyAddressEn)) &&
        (this.companyZipCode == null ? companyInfo.companyZipCode == null : this.companyZipCode.equals(companyInfo.companyZipCode)) &&
        (this.companyTaxId == null ? companyInfo.companyTaxId == null : this.companyTaxId.equals(companyInfo.companyTaxId)) &&
        (this.companyBranch == null ? companyInfo.companyBranch == null : this.companyBranch.equals(companyInfo.companyBranch)) &&
        (this.companyBranchEn == null ? companyInfo.companyBranchEn == null : this.companyBranchEn.equals(companyInfo.companyBranchEn)) &&
        (this.companyBranchCode == null ? companyInfo.companyBranchCode == null : this.companyBranchCode.equals(companyInfo.companyBranchCode)) &&
        (this.companyPhone == null ? companyInfo.companyPhone == null : this.companyPhone.equals(companyInfo.companyPhone)) &&
        (this.companyMobile == null ? companyInfo.companyMobile == null : this.companyMobile.equals(companyInfo.companyMobile)) &&
        (this.companyFax == null ? companyInfo.companyFax == null : this.companyFax.equals(companyInfo.companyFax)) &&
        (this.companyWebsite == null ? companyInfo.companyWebsite == null : this.companyWebsite.equals(companyInfo.companyWebsite));
  }
