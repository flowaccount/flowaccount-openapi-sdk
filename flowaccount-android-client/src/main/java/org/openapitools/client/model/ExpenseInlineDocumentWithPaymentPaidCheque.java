...
public class ExpenseInlineDocumentWithPaymentPaidCheque {
  ...
  public boolean equals(Object o) {
    ...
    return (this.contactCode == null ? expenseInlineDocumentWithPaymentPaidCheque.contactCode == null : this.contactCode.equals(expenseInlineDocumentWithPaymentPaidCheque.contactCode)) &&
        (this.contactName == null ? expenseInlineDocumentWithPaymentPaidCheque.contactName == null : this.contactName.equals(expenseInlineDocumentWithPaymentPaidCheque.contactName)) &&
        (this.contactAddress == null ? expenseInlineDocumentWithPaymentPaidCheque.contactAddress == null : this.contactAddress.equals(expenseInlineDocumentWithPaymentPaidCheque.contactAddress)) &&
        (this.contactTaxId == null ? expenseInlineDocumentWithPaymentPaidCheque.contactTaxId == null : this.contactTaxId.equals(expenseInlineDocumentWithPaymentPaidCheque.contactTaxId)) &&
        (this.contactBranch == null ? expenseInlineDocumentWithPaymentPaidCheque.contactBranch == null : this.contactBranch.equals(expenseInlineDocumentWithPaymentPaidCheque.contactBranch)) &&
        (this.contactPerson == null ? expenseInlineDocumentWithPaymentPaidCheque.contactPerson == null : this.contactPerson.equals(expenseInlineDocumentWithPaymentPaidCheque.contactPerson)) &&
        (this.contactEmail == null ? expenseInlineDocumentWithPaymentPaidCheque.contactEmail == null : this.contactEmail.equals(expenseInlineDocumentWithPaymentPaidCheque.contactEmail)) &&
        (this.contactNumber == null ? expenseInlineDocumentWithPaymentPaidCheque.contactNumber == null : this.contactNumber.equals(expenseInlineDocumentWithPaymentPaidCheque.contactNumber)) &&
        (this.contactZipCode == null ? expenseInlineDocumentWithPaymentPaidCheque.contactZipCode == null : this.contactZipCode.equals(expenseInlineDocumentWithPaymentPaidCheque.contactZipCode)) &&
        (this.contactGroup == null ? expenseInlineDocumentWithPaymentPaidCheque.contactGroup == null : this.contactGroup.equals(expenseInlineDocumentWithPaymentPaidCheque.contactGroup)) &&
        (this.publishedOn == null ? expenseInlineDocumentWithPaymentPaidCheque.publishedOn == null : this.publishedOn.equals(expenseInlineDocumentWithPaymentPaidCheque.publishedOn)) &&
        (this.creditType == null ? expenseInlineDocumentWithPaymentPaidCheque.creditType == null : this.creditType.equals(expenseInlineDocumentWithPaymentPaidCheque.creditType)) &&
        (this.creditDays == null ? expenseInlineDocumentWithPaymentPaidCheque.creditDays == null : this.creditDays.equals(expenseInlineDocumentWithPaymentPaidCheque.creditDays)) &&
        (this.dueDate == null ? expenseInlineDocumentWithPaymentPaidCheque.dueDate == null : this.dueDate.equals(expenseInlineDocumentWithPaymentPaidCheque.dueDate)) &&
        (this.salesName == null ? expenseInlineDocumentWithPaymentPaidCheque.salesName == null : this.salesName.equals(expenseInlineDocumentWithPaymentPaidCheque.salesName)) &&
        (this.projectName == null ? expenseInlineDocumentWithPaymentPaidCheque.projectName == null : this.projectName.equals(expenseInlineDocumentWithPaymentPaidCheque.projectName)) &&
        (this.reference == null ? expenseInlineDocumentWithPaymentPaidCheque.reference == null : this.reference.equals(expenseInlineDocumentWithPaymentPaidCheque.reference)) &&
        (this.isVatInclusive == null ? expenseInlineDocumentWithPaymentPaidCheque.isVatInclusive == null : this.isVatInclusive.equals(expenseInlineDocumentWithPaymentPaidCheque.isVatInclusive)) &&
        (this.items == null ? expenseInlineDocumentWithPaymentPaidCheque.items == null : this.items.equals(expenseInlineDocumentWithPaymentPaidCheque.items)) &&
        (this.subTotal == null ? expenseInlineDocumentWithPaymentPaidCheque.subTotal == null : this.subTotal.equals(expenseInlineDocumentWithPaymentPaidCheque.subTotal)) &&
        (this.discountPercentage == null ? expenseInlineDocumentWithPaymentPaidCheque.discountPercentage == null : this.discountPercentage.equals(expenseInlineDocumentWithPaymentPaidCheque.discountPercentage)) &&
        (this.discountAmount == null ? expenseInlineDocumentWithPaymentPaidCheque.discountAmount == null : this.discountAmount.equals(expenseInlineDocumentWithPaymentPaidCheque.discountAmount)) &&
        (this.totalAfterDiscount == null ? expenseInlineDocumentWithPaymentPaidCheque.totalAfterDiscount == null : this.totalAfterDiscount.equals(expenseInlineDocumentWithPaymentPaidCheque.totalAfterDiscount)) &&
        (this.isVat == null ? expenseInlineDocumentWithPaymentPaidCheque.isVat == null : this.isVat.equals(expenseInlineDocumentWithPaymentPaidCheque.isVat)) &&
        (this.vatAmount == null ? expenseInlineDocumentWithPaymentPaidCheque.vatAmount == null : this.vatAmount.equals(expenseInlineDocumentWithPaymentPaidCheque.vatAmount)) &&
        (this.grandTotal == null ? expenseInlineDocumentWithPaymentPaidCheque.grandTotal == null : this.grandTotal.equals(expenseInlineDocumentWithPaymentPaidCheque.grandTotal)) &&
        (this.discountType == null ? expenseInlineDocumentWithPaymentPaidCheque.discountType == null : this.discountType.equals(expenseInlineDocumentWithPaymentPaidCheque.discountType)) &&
        (this.useInlineDiscount == null ? expenseInlineDocumentWithPaymentPaidCheque.useInlineDiscount == null : this.useInlineDiscount.equals(expenseInlineDocumentWithPaymentPaidCheque.useInlineDiscount)) &&
        (this.useInlineVat == null ? expenseInlineDocumentWithPaymentPaidCheque.useInlineVat == null : this.useInlineVat.equals(expenseInlineDocumentWithPaymentPaidCheque.useInlineVat)) &&
        (this.exemptAmount == null ? expenseInlineDocumentWithPaymentPaidCheque.exemptAmount == null : this.exemptAmount.equals(expenseInlineDocumentWithPaymentPaidCheque.exemptAmount)) &&
        (this.remarks == null ? expenseInlineDocumentWithPaymentPaidCheque.remarks == null : this.remarks.equals(expenseInlineDocumentWithPaymentPaidCheque.remarks)) &&
        (this.internalNotes == null ? expenseInlineDocumentWithPaymentPaidCheque.internalNotes == null : this.internalNotes.equals(expenseInlineDocumentWithPaymentPaidCheque.internalNotes)) &&
        (this.showSignatureOrStamp == null ? expenseInlineDocumentWithPaymentPaidCheque.showSignatureOrStamp == null : this.showSignatureOrStamp.equals(expenseInlineDocumentWithPaymentPaidCheque.showSignatureOrStamp)) &&
        (this.expensePaymentStructureType == null ? expenseInlineDocumentWithPaymentPaidCheque.expensePaymentStructureType == null : this.expensePaymentStructureType.equals(expenseInlineDocumentWithPaymentPaidCheque.expensePaymentStructureType)) &&
        (this.paymentMethod == null ? expenseInlineDocumentWithPaymentPaidCheque.paymentMethod == null : this.paymentMethod.equals(expenseInlineDocumentWithPaymentPaidCheque.paymentMethod)) &&
        (this.paymentDate == null ? expenseInlineDocumentWithPaymentPaidCheque.paymentDate == null : this.paymentDate.equals(expenseInlineDocumentWithPaymentPaidCheque.paymentDate)) &&
        (this.collected == null ? expenseInlineDocumentWithPaymentPaidCheque.collected == null : this.collected.equals(expenseInlineDocumentWithPaymentPaidCheque.collected)) &&
        (this.withheldPercentage == null ? expenseInlineDocumentWithPaymentPaidCheque.withheldPercentage == null : this.withheldPercentage.equals(expenseInlineDocumentWithPaymentPaidCheque.withheldPercentage)) &&
        (this.withheldAmount == null ? expenseInlineDocumentWithPaymentPaidCheque.withheldAmount == null : this.withheldAmount.equals(expenseInlineDocumentWithPaymentPaidCheque.withheldAmount)) &&
        (this.chequeDate == null ? expenseInlineDocumentWithPaymentPaidCheque.chequeDate == null : this.chequeDate.equals(expenseInlineDocumentWithPaymentPaidCheque.chequeDate)) &&
        (this.chequeNumber == null ? expenseInlineDocumentWithPaymentPaidCheque.chequeNumber == null : this.chequeNumber.equals(expenseInlineDocumentWithPaymentPaidCheque.chequeNumber)) &&
        (this.chequeBankAccountId == null ? expenseInlineDocumentWithPaymentPaidCheque.chequeBankAccountId == null : this.chequeBankAccountId.equals(expenseInlineDocumentWithPaymentPaidCheque.chequeBankAccountId)) &&
        (this.bankAccountId == null ? expenseInlineDocumentWithPaymentPaidCheque.bankAccountId == null : this.bankAccountId.equals(expenseInlineDocumentWithPaymentPaidCheque.bankAccountId)) &&
        (this.paymentCharge == null ? expenseInlineDocumentWithPaymentPaidCheque.paymentCharge == null : this.paymentCharge.equals(expenseInlineDocumentWithPaymentPaidCheque.paymentCharge)) &&
        (this.paymentRemarks == null ? expenseInlineDocumentWithPaymentPaidCheque.paymentRemarks == null : this.paymentRemarks.equals(expenseInlineDocumentWithPaymentPaidCheque.paymentRemarks)) &&
        (this.remainingCollectedType == null ? expenseInlineDocumentWithPaymentPaidCheque.remainingCollectedType == null : this.remainingCollectedType.equals(expenseInlineDocumentWithPaymentPaidCheque.remainingCollectedType)) &&
        (this.remainingCollected == null ? expenseInlineDocumentWithPaymentPaidCheque.remainingCollected == null : this.remainingCollected.equals(expenseInlineDocumentWithPaymentPaidCheque.remainingCollected));
  }
