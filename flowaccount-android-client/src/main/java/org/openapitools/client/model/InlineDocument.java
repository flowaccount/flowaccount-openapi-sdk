...
public class InlineDocument extends Document {
  ...
  public boolean equals(Object o) {
    ...
    return (this.recordId == null ? inlineDocument.recordId == null : this.recordId.equals(inlineDocument.recordId)) &&
        (this.contactCode == null ? inlineDocument.contactCode == null : this.contactCode.equals(inlineDocument.contactCode)) &&
        (this.contactName == null ? inlineDocument.contactName == null : this.contactName.equals(inlineDocument.contactName)) &&
        (this.contactAddress == null ? inlineDocument.contactAddress == null : this.contactAddress.equals(inlineDocument.contactAddress)) &&
        (this.contactTaxId == null ? inlineDocument.contactTaxId == null : this.contactTaxId.equals(inlineDocument.contactTaxId)) &&
        (this.contactBranch == null ? inlineDocument.contactBranch == null : this.contactBranch.equals(inlineDocument.contactBranch)) &&
        (this.contactPerson == null ? inlineDocument.contactPerson == null : this.contactPerson.equals(inlineDocument.contactPerson)) &&
        (this.contactEmail == null ? inlineDocument.contactEmail == null : this.contactEmail.equals(inlineDocument.contactEmail)) &&
        (this.contactNumber == null ? inlineDocument.contactNumber == null : this.contactNumber.equals(inlineDocument.contactNumber)) &&
        (this.contactZipCode == null ? inlineDocument.contactZipCode == null : this.contactZipCode.equals(inlineDocument.contactZipCode)) &&
        (this.contactGroup == null ? inlineDocument.contactGroup == null : this.contactGroup.equals(inlineDocument.contactGroup)) &&
        (this.publishedOn == null ? inlineDocument.publishedOn == null : this.publishedOn.equals(inlineDocument.publishedOn)) &&
        (this.creditType == null ? inlineDocument.creditType == null : this.creditType.equals(inlineDocument.creditType)) &&
        (this.creditDays == null ? inlineDocument.creditDays == null : this.creditDays.equals(inlineDocument.creditDays)) &&
        (this.dueDate == null ? inlineDocument.dueDate == null : this.dueDate.equals(inlineDocument.dueDate)) &&
        (this.salesName == null ? inlineDocument.salesName == null : this.salesName.equals(inlineDocument.salesName)) &&
        (this.projectName == null ? inlineDocument.projectName == null : this.projectName.equals(inlineDocument.projectName)) &&
        (this.reference == null ? inlineDocument.reference == null : this.reference.equals(inlineDocument.reference)) &&
        (this.isVatInclusive == null ? inlineDocument.isVatInclusive == null : this.isVatInclusive.equals(inlineDocument.isVatInclusive)) &&
        (this.useReceiptDeduction == null ? inlineDocument.useReceiptDeduction == null : this.useReceiptDeduction.equals(inlineDocument.useReceiptDeduction)) &&
        (this.subTotal == null ? inlineDocument.subTotal == null : this.subTotal.equals(inlineDocument.subTotal)) &&
        (this.discountPercentage == null ? inlineDocument.discountPercentage == null : this.discountPercentage.equals(inlineDocument.discountPercentage)) &&
        (this.discountAmount == null ? inlineDocument.discountAmount == null : this.discountAmount.equals(inlineDocument.discountAmount)) &&
        (this.totalAfterDiscount == null ? inlineDocument.totalAfterDiscount == null : this.totalAfterDiscount.equals(inlineDocument.totalAfterDiscount)) &&
        (this.isVat == null ? inlineDocument.isVat == null : this.isVat.equals(inlineDocument.isVat)) &&
        (this.vatAmount == null ? inlineDocument.vatAmount == null : this.vatAmount.equals(inlineDocument.vatAmount)) &&
        (this.grandTotal == null ? inlineDocument.grandTotal == null : this.grandTotal.equals(inlineDocument.grandTotal)) &&
        (this.documentShowWithholdingTax == null ? inlineDocument.documentShowWithholdingTax == null : this.documentShowWithholdingTax.equals(inlineDocument.documentShowWithholdingTax)) &&
        (this.documentWithholdingTaxPercentage == null ? inlineDocument.documentWithholdingTaxPercentage == null : this.documentWithholdingTaxPercentage.equals(inlineDocument.documentWithholdingTaxPercentage)) &&
        (this.documentWithholdingTaxAmount == null ? inlineDocument.documentWithholdingTaxAmount == null : this.documentWithholdingTaxAmount.equals(inlineDocument.documentWithholdingTaxAmount)) &&
        (this.documentDeductionType == null ? inlineDocument.documentDeductionType == null : this.documentDeductionType.equals(inlineDocument.documentDeductionType)) &&
        (this.documentDeductionAmount == null ? inlineDocument.documentDeductionAmount == null : this.documentDeductionAmount.equals(inlineDocument.documentDeductionAmount)) &&
        (this.remarks == null ? inlineDocument.remarks == null : this.remarks.equals(inlineDocument.remarks)) &&
        (this.internalNotes == null ? inlineDocument.internalNotes == null : this.internalNotes.equals(inlineDocument.internalNotes)) &&
        (this.showSignatureOrStamp == null ? inlineDocument.showSignatureOrStamp == null : this.showSignatureOrStamp.equals(inlineDocument.showSignatureOrStamp)) &&
        (this.documentStructureType == null ? inlineDocument.documentStructureType == null : this.documentStructureType.equals(inlineDocument.documentStructureType)) &&
        (this.discountType == null ? inlineDocument.discountType == null : this.discountType.equals(inlineDocument.discountType)) &&
        (this.useInlineDiscount == null ? inlineDocument.useInlineDiscount == null : this.useInlineDiscount.equals(inlineDocument.useInlineDiscount)) &&
        (this.useInlineVat == null ? inlineDocument.useInlineVat == null : this.useInlineVat.equals(inlineDocument.useInlineVat)) &&
        (this.exemptAmount == null ? inlineDocument.exemptAmount == null : this.exemptAmount.equals(inlineDocument.exemptAmount)) &&
        (this.vatableAmount == null ? inlineDocument.vatableAmount == null : this.vatableAmount.equals(inlineDocument.vatableAmount)) &&
        (this.items == null ? inlineDocument.items == null : this.items.equals(inlineDocument.items)) &&
        (this.documentReference == null ? inlineDocument.documentReference == null : this.documentReference.equals(inlineDocument.documentReference));
  }
