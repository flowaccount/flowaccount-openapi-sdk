...
public class PaymentPaidCheque {
  ...
  public boolean equals(Object o) {
    ...
    return (this.paymentStructureType == null ? paymentPaidCheque.paymentStructureType == null : this.paymentStructureType.equals(paymentPaidCheque.paymentStructureType)) &&
        (this.documentId == null ? paymentPaidCheque.documentId == null : this.documentId.equals(paymentPaidCheque.documentId)) &&
        (this.paymentMethod == null ? paymentPaidCheque.paymentMethod == null : this.paymentMethod.equals(paymentPaidCheque.paymentMethod)) &&
        (this.paymentDate == null ? paymentPaidCheque.paymentDate == null : this.paymentDate.equals(paymentPaidCheque.paymentDate)) &&
        (this.collected == null ? paymentPaidCheque.collected == null : this.collected.equals(paymentPaidCheque.collected)) &&
        (this.withheldPercentage == null ? paymentPaidCheque.withheldPercentage == null : this.withheldPercentage.equals(paymentPaidCheque.withheldPercentage)) &&
        (this.withheldAmount == null ? paymentPaidCheque.withheldAmount == null : this.withheldAmount.equals(paymentPaidCheque.withheldAmount)) &&
        (this.chequeDate == null ? paymentPaidCheque.chequeDate == null : this.chequeDate.equals(paymentPaidCheque.chequeDate)) &&
        (this.chequeNumber == null ? paymentPaidCheque.chequeNumber == null : this.chequeNumber.equals(paymentPaidCheque.chequeNumber)) &&
        (this.chequeBankAccountId == null ? paymentPaidCheque.chequeBankAccountId == null : this.chequeBankAccountId.equals(paymentPaidCheque.chequeBankAccountId)) &&
        (this.bankAccountId == null ? paymentPaidCheque.bankAccountId == null : this.bankAccountId.equals(paymentPaidCheque.bankAccountId)) &&
        (this.paymentCharge == null ? paymentPaidCheque.paymentCharge == null : this.paymentCharge.equals(paymentPaidCheque.paymentCharge)) &&
        (this.paymentRemarks == null ? paymentPaidCheque.paymentRemarks == null : this.paymentRemarks.equals(paymentPaidCheque.paymentRemarks)) &&
        (this.remainingCollectedType == null ? paymentPaidCheque.remainingCollectedType == null : this.remainingCollectedType.equals(paymentPaidCheque.remainingCollectedType)) &&
        (this.remainingCollected == null ? paymentPaidCheque.remainingCollected == null : this.remainingCollected.equals(paymentPaidCheque.remainingCollected));
  }
