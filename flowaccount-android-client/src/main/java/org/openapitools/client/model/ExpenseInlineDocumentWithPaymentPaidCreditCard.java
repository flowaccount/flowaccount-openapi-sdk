...
public class ExpenseInlineDocumentWithPaymentPaidCreditCard {
  ...
  public boolean equals(Object o) {
    ...
    return (this.contactCode == null ? expenseInlineDocumentWithPaymentPaidCreditCard.contactCode == null : this.contactCode.equals(expenseInlineDocumentWithPaymentPaidCreditCard.contactCode)) &&
        (this.contactName == null ? expenseInlineDocumentWithPaymentPaidCreditCard.contactName == null : this.contactName.equals(expenseInlineDocumentWithPaymentPaidCreditCard.contactName)) &&
        (this.contactAddress == null ? expenseInlineDocumentWithPaymentPaidCreditCard.contactAddress == null : this.contactAddress.equals(expenseInlineDocumentWithPaymentPaidCreditCard.contactAddress)) &&
        (this.contactTaxId == null ? expenseInlineDocumentWithPaymentPaidCreditCard.contactTaxId == null : this.contactTaxId.equals(expenseInlineDocumentWithPaymentPaidCreditCard.contactTaxId)) &&
        (this.contactBranch == null ? expenseInlineDocumentWithPaymentPaidCreditCard.contactBranch == null : this.contactBranch.equals(expenseInlineDocumentWithPaymentPaidCreditCard.contactBranch)) &&
        (this.contactPerson == null ? expenseInlineDocumentWithPaymentPaidCreditCard.contactPerson == null : this.contactPerson.equals(expenseInlineDocumentWithPaymentPaidCreditCard.contactPerson)) &&
        (this.contactEmail == null ? expenseInlineDocumentWithPaymentPaidCreditCard.contactEmail == null : this.contactEmail.equals(expenseInlineDocumentWithPaymentPaidCreditCard.contactEmail)) &&
        (this.contactNumber == null ? expenseInlineDocumentWithPaymentPaidCreditCard.contactNumber == null : this.contactNumber.equals(expenseInlineDocumentWithPaymentPaidCreditCard.contactNumber)) &&
        (this.contactZipCode == null ? expenseInlineDocumentWithPaymentPaidCreditCard.contactZipCode == null : this.contactZipCode.equals(expenseInlineDocumentWithPaymentPaidCreditCard.contactZipCode)) &&
        (this.contactGroup == null ? expenseInlineDocumentWithPaymentPaidCreditCard.contactGroup == null : this.contactGroup.equals(expenseInlineDocumentWithPaymentPaidCreditCard.contactGroup)) &&
        (this.publishedOn == null ? expenseInlineDocumentWithPaymentPaidCreditCard.publishedOn == null : this.publishedOn.equals(expenseInlineDocumentWithPaymentPaidCreditCard.publishedOn)) &&
        (this.creditType == null ? expenseInlineDocumentWithPaymentPaidCreditCard.creditType == null : this.creditType.equals(expenseInlineDocumentWithPaymentPaidCreditCard.creditType)) &&
        (this.creditDays == null ? expenseInlineDocumentWithPaymentPaidCreditCard.creditDays == null : this.creditDays.equals(expenseInlineDocumentWithPaymentPaidCreditCard.creditDays)) &&
        (this.dueDate == null ? expenseInlineDocumentWithPaymentPaidCreditCard.dueDate == null : this.dueDate.equals(expenseInlineDocumentWithPaymentPaidCreditCard.dueDate)) &&
        (this.salesName == null ? expenseInlineDocumentWithPaymentPaidCreditCard.salesName == null : this.salesName.equals(expenseInlineDocumentWithPaymentPaidCreditCard.salesName)) &&
        (this.projectName == null ? expenseInlineDocumentWithPaymentPaidCreditCard.projectName == null : this.projectName.equals(expenseInlineDocumentWithPaymentPaidCreditCard.projectName)) &&
        (this.reference == null ? expenseInlineDocumentWithPaymentPaidCreditCard.reference == null : this.reference.equals(expenseInlineDocumentWithPaymentPaidCreditCard.reference)) &&
        (this.isVatInclusive == null ? expenseInlineDocumentWithPaymentPaidCreditCard.isVatInclusive == null : this.isVatInclusive.equals(expenseInlineDocumentWithPaymentPaidCreditCard.isVatInclusive)) &&
        (this.items == null ? expenseInlineDocumentWithPaymentPaidCreditCard.items == null : this.items.equals(expenseInlineDocumentWithPaymentPaidCreditCard.items)) &&
        (this.subTotal == null ? expenseInlineDocumentWithPaymentPaidCreditCard.subTotal == null : this.subTotal.equals(expenseInlineDocumentWithPaymentPaidCreditCard.subTotal)) &&
        (this.discountPercentage == null ? expenseInlineDocumentWithPaymentPaidCreditCard.discountPercentage == null : this.discountPercentage.equals(expenseInlineDocumentWithPaymentPaidCreditCard.discountPercentage)) &&
        (this.discountAmount == null ? expenseInlineDocumentWithPaymentPaidCreditCard.discountAmount == null : this.discountAmount.equals(expenseInlineDocumentWithPaymentPaidCreditCard.discountAmount)) &&
        (this.totalAfterDiscount == null ? expenseInlineDocumentWithPaymentPaidCreditCard.totalAfterDiscount == null : this.totalAfterDiscount.equals(expenseInlineDocumentWithPaymentPaidCreditCard.totalAfterDiscount)) &&
        (this.isVat == null ? expenseInlineDocumentWithPaymentPaidCreditCard.isVat == null : this.isVat.equals(expenseInlineDocumentWithPaymentPaidCreditCard.isVat)) &&
        (this.vatAmount == null ? expenseInlineDocumentWithPaymentPaidCreditCard.vatAmount == null : this.vatAmount.equals(expenseInlineDocumentWithPaymentPaidCreditCard.vatAmount)) &&
        (this.grandTotal == null ? expenseInlineDocumentWithPaymentPaidCreditCard.grandTotal == null : this.grandTotal.equals(expenseInlineDocumentWithPaymentPaidCreditCard.grandTotal)) &&
        (this.discountType == null ? expenseInlineDocumentWithPaymentPaidCreditCard.discountType == null : this.discountType.equals(expenseInlineDocumentWithPaymentPaidCreditCard.discountType)) &&
        (this.useInlineDiscount == null ? expenseInlineDocumentWithPaymentPaidCreditCard.useInlineDiscount == null : this.useInlineDiscount.equals(expenseInlineDocumentWithPaymentPaidCreditCard.useInlineDiscount)) &&
        (this.useInlineVat == null ? expenseInlineDocumentWithPaymentPaidCreditCard.useInlineVat == null : this.useInlineVat.equals(expenseInlineDocumentWithPaymentPaidCreditCard.useInlineVat)) &&
        (this.exemptAmount == null ? expenseInlineDocumentWithPaymentPaidCreditCard.exemptAmount == null : this.exemptAmount.equals(expenseInlineDocumentWithPaymentPaidCreditCard.exemptAmount)) &&
        (this.remarks == null ? expenseInlineDocumentWithPaymentPaidCreditCard.remarks == null : this.remarks.equals(expenseInlineDocumentWithPaymentPaidCreditCard.remarks)) &&
        (this.internalNotes == null ? expenseInlineDocumentWithPaymentPaidCreditCard.internalNotes == null : this.internalNotes.equals(expenseInlineDocumentWithPaymentPaidCreditCard.internalNotes)) &&
        (this.showSignatureOrStamp == null ? expenseInlineDocumentWithPaymentPaidCreditCard.showSignatureOrStamp == null : this.showSignatureOrStamp.equals(expenseInlineDocumentWithPaymentPaidCreditCard.showSignatureOrStamp)) &&
        (this.expensePaymentStructureType == null ? expenseInlineDocumentWithPaymentPaidCreditCard.expensePaymentStructureType == null : this.expensePaymentStructureType.equals(expenseInlineDocumentWithPaymentPaidCreditCard.expensePaymentStructureType)) &&
        (this.paymentMethod == null ? expenseInlineDocumentWithPaymentPaidCreditCard.paymentMethod == null : this.paymentMethod.equals(expenseInlineDocumentWithPaymentPaidCreditCard.paymentMethod)) &&
        (this.paymentDate == null ? expenseInlineDocumentWithPaymentPaidCreditCard.paymentDate == null : this.paymentDate.equals(expenseInlineDocumentWithPaymentPaidCreditCard.paymentDate)) &&
        (this.collected == null ? expenseInlineDocumentWithPaymentPaidCreditCard.collected == null : this.collected.equals(expenseInlineDocumentWithPaymentPaidCreditCard.collected)) &&
        (this.withheldPercentage == null ? expenseInlineDocumentWithPaymentPaidCreditCard.withheldPercentage == null : this.withheldPercentage.equals(expenseInlineDocumentWithPaymentPaidCreditCard.withheldPercentage)) &&
        (this.withheldAmount == null ? expenseInlineDocumentWithPaymentPaidCreditCard.withheldAmount == null : this.withheldAmount.equals(expenseInlineDocumentWithPaymentPaidCreditCard.withheldAmount)) &&
        (this.creditCardBankAccountId == null ? expenseInlineDocumentWithPaymentPaidCreditCard.creditCardBankAccountId == null : this.creditCardBankAccountId.equals(expenseInlineDocumentWithPaymentPaidCreditCard.creditCardBankAccountId)) &&
        (this.paymentRemarks == null ? expenseInlineDocumentWithPaymentPaidCreditCard.paymentRemarks == null : this.paymentRemarks.equals(expenseInlineDocumentWithPaymentPaidCreditCard.paymentRemarks)) &&
        (this.remainingCollectedType == null ? expenseInlineDocumentWithPaymentPaidCreditCard.remainingCollectedType == null : this.remainingCollectedType.equals(expenseInlineDocumentWithPaymentPaidCreditCard.remainingCollectedType)) &&
        (this.remainingCollected == null ? expenseInlineDocumentWithPaymentPaidCreditCard.remainingCollected == null : this.remainingCollected.equals(expenseInlineDocumentWithPaymentPaidCreditCard.remainingCollected));
  }
