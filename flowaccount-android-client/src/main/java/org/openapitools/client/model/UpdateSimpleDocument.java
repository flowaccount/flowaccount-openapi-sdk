...
public class UpdateSimpleDocument extends UpdateDocument {
  ...
  public boolean equals(Object o) {
    ...
    UpdateSimpleDocument updateSimpleDocument = (UpdateSimpleDocument) o;
    return (this.recordId == null ? updateSimpleDocument.recordId == null : this.recordId.equals(updateSimpleDocument.recordId)) &&
        (this.companyName == null ? updateSimpleDocument.companyName == null : this.companyName.equals(updateSimpleDocument.companyName)) &&
        (this.companyNameEn == null ? updateSimpleDocument.companyNameEn == null : this.companyNameEn.equals(updateSimpleDocument.companyNameEn)) &&
        (this.companyAddress == null ? updateSimpleDocument.companyAddress == null : this.companyAddress.equals(updateSimpleDocument.companyAddress)) &&
        (this.companyAddressEn == null ? updateSimpleDocument.companyAddressEn == null : this.companyAddressEn.equals(updateSimpleDocument.companyAddressEn)) &&
        (this.companyTaxId == null ? updateSimpleDocument.companyTaxId == null : this.companyTaxId.equals(updateSimpleDocument.companyTaxId)) &&
        (this.companyBranch == null ? updateSimpleDocument.companyBranch == null : this.companyBranch.equals(updateSimpleDocument.companyBranch)) &&
        (this.companyBranchEn == null ? updateSimpleDocument.companyBranchEn == null : this.companyBranchEn.equals(updateSimpleDocument.companyBranchEn)) &&
        (this.companyPhone == null ? updateSimpleDocument.companyPhone == null : this.companyPhone.equals(updateSimpleDocument.companyPhone)) &&
        (this.companyMobile == null ? updateSimpleDocument.companyMobile == null : this.companyMobile.equals(updateSimpleDocument.companyMobile)) &&
        (this.companyFax == null ? updateSimpleDocument.companyFax == null : this.companyFax.equals(updateSimpleDocument.companyFax)) &&
        (this.companyWebsite == null ? updateSimpleDocument.companyWebsite == null : this.companyWebsite.equals(updateSimpleDocument.companyWebsite)) &&
        (this.contactCode == null ? updateSimpleDocument.contactCode == null : this.contactCode.equals(updateSimpleDocument.contactCode)) &&
        (this.contactName == null ? updateSimpleDocument.contactName == null : this.contactName.equals(updateSimpleDocument.contactName)) &&
        (this.contactAddress == null ? updateSimpleDocument.contactAddress == null : this.contactAddress.equals(updateSimpleDocument.contactAddress)) &&
        (this.contactTaxId == null ? updateSimpleDocument.contactTaxId == null : this.contactTaxId.equals(updateSimpleDocument.contactTaxId)) &&
        (this.contactBranch == null ? updateSimpleDocument.contactBranch == null : this.contactBranch.equals(updateSimpleDocument.contactBranch)) &&
        (this.contactPerson == null ? updateSimpleDocument.contactPerson == null : this.contactPerson.equals(updateSimpleDocument.contactPerson)) &&
        (this.contactEmail == null ? updateSimpleDocument.contactEmail == null : this.contactEmail.equals(updateSimpleDocument.contactEmail)) &&
        (this.contactNumber == null ? updateSimpleDocument.contactNumber == null : this.contactNumber.equals(updateSimpleDocument.contactNumber)) &&
        (this.contactZipCode == null ? updateSimpleDocument.contactZipCode == null : this.contactZipCode.equals(updateSimpleDocument.contactZipCode)) &&
        (this.contactGroup == null ? updateSimpleDocument.contactGroup == null : this.contactGroup.equals(updateSimpleDocument.contactGroup)) &&
        (this.publishedOn == null ? updateSimpleDocument.publishedOn == null : this.publishedOn.equals(updateSimpleDocument.publishedOn)) &&
        (this.creditType == null ? updateSimpleDocument.creditType == null : this.creditType.equals(updateSimpleDocument.creditType)) &&
        (this.creditDays == null ? updateSimpleDocument.creditDays == null : this.creditDays.equals(updateSimpleDocument.creditDays)) &&
        (this.dueDate == null ? updateSimpleDocument.dueDate == null : this.dueDate.equals(updateSimpleDocument.dueDate)) &&
        (this.salesName == null ? updateSimpleDocument.salesName == null : this.salesName.equals(updateSimpleDocument.salesName)) &&
        (this.projectName == null ? updateSimpleDocument.projectName == null : this.projectName.equals(updateSimpleDocument.projectName)) &&
        (this.reference == null ? updateSimpleDocument.reference == null : this.reference.equals(updateSimpleDocument.reference)) &&
        (this.isVatInclusive == null ? updateSimpleDocument.isVatInclusive == null : this.isVatInclusive.equals(updateSimpleDocument.isVatInclusive)) &&
        (this.useReceiptDeduction == null ? updateSimpleDocument.useReceiptDeduction == null : this.useReceiptDeduction.equals(updateSimpleDocument.useReceiptDeduction)) &&
        (this.subTotal == null ? updateSimpleDocument.subTotal == null : this.subTotal.equals(updateSimpleDocument.subTotal)) &&
        (this.discountPercentage == null ? updateSimpleDocument.discountPercentage == null : this.discountPercentage.equals(updateSimpleDocument.discountPercentage)) &&
        (this.discountAmount == null ? updateSimpleDocument.discountAmount == null : this.discountAmount.equals(updateSimpleDocument.discountAmount)) &&
        (this.totalAfterDiscount == null ? updateSimpleDocument.totalAfterDiscount == null : this.totalAfterDiscount.equals(updateSimpleDocument.totalAfterDiscount)) &&
        (this.isVat == null ? updateSimpleDocument.isVat == null : this.isVat.equals(updateSimpleDocument.isVat)) &&
        (this.vatAmount == null ? updateSimpleDocument.vatAmount == null : this.vatAmount.equals(updateSimpleDocument.vatAmount)) &&
        (this.grandTotal == null ? updateSimpleDocument.grandTotal == null : this.grandTotal.equals(updateSimpleDocument.grandTotal)) &&
        (this.documentShowWithholdingTax == null ? updateSimpleDocument.documentShowWithholdingTax == null : this.documentShowWithholdingTax.equals(updateSimpleDocument.documentShowWithholdingTax)) &&
        (this.documentWithholdingTaxPercentage == null ? updateSimpleDocument.documentWithholdingTaxPercentage == null : this.documentWithholdingTaxPercentage.equals(updateSimpleDocument.documentWithholdingTaxPercentage)) &&
        (this.documentWithholdingTaxAmount == null ? updateSimpleDocument.documentWithholdingTaxAmount == null : this.documentWithholdingTaxAmount.equals(updateSimpleDocument.documentWithholdingTaxAmount)) &&
        (this.documentDeductionType == null ? updateSimpleDocument.documentDeductionType == null : this.documentDeductionType.equals(updateSimpleDocument.documentDeductionType)) &&
        (this.documentDeductionAmount == null ? updateSimpleDocument.documentDeductionAmount == null : this.documentDeductionAmount.equals(updateSimpleDocument.documentDeductionAmount)) &&
        (this.remarks == null ? updateSimpleDocument.remarks == null : this.remarks.equals(updateSimpleDocument.remarks)) &&
        (this.internalNotes == null ? updateSimpleDocument.internalNotes == null : this.internalNotes.equals(updateSimpleDocument.internalNotes)) &&
        (this.showSignatureOrStamp == null ? updateSimpleDocument.showSignatureOrStamp == null : this.showSignatureOrStamp.equals(updateSimpleDocument.showSignatureOrStamp)) &&
        (this.documentStructureType == null ? updateSimpleDocument.documentStructureType == null : this.documentStructureType.equals(updateSimpleDocument.documentStructureType)) &&
        (this.items == null ? updateSimpleDocument.items == null : this.items.equals(updateSimpleDocument.items)) &&
        (this.documentReference == null ? updateSimpleDocument.documentReference == null : this.documentReference.equals(updateSimpleDocument.documentReference));
  }
