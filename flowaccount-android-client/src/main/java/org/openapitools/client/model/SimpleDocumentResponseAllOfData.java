...
public class SimpleDocumentResponseAllOfData {
  ...
  public boolean equals(Object o) {
    ...
    return (this.recordId == null ? simpleDocumentResponseAllOfData.recordId == null : this.recordId.equals(simpleDocumentResponseAllOfData.recordId)) &&
        (this.documentId == null ? simpleDocumentResponseAllOfData.documentId == null : this.documentId.equals(simpleDocumentResponseAllOfData.documentId)) &&
        (this.documentSerial == null ? simpleDocumentResponseAllOfData.documentSerial == null : this.documentSerial.equals(simpleDocumentResponseAllOfData.documentSerial)) &&
        (this.contactCode == null ? simpleDocumentResponseAllOfData.contactCode == null : this.contactCode.equals(simpleDocumentResponseAllOfData.contactCode)) &&
        (this.contactName == null ? simpleDocumentResponseAllOfData.contactName == null : this.contactName.equals(simpleDocumentResponseAllOfData.contactName)) &&
        (this.contactAddress == null ? simpleDocumentResponseAllOfData.contactAddress == null : this.contactAddress.equals(simpleDocumentResponseAllOfData.contactAddress)) &&
        (this.contactTaxId == null ? simpleDocumentResponseAllOfData.contactTaxId == null : this.contactTaxId.equals(simpleDocumentResponseAllOfData.contactTaxId)) &&
        (this.contactBranch == null ? simpleDocumentResponseAllOfData.contactBranch == null : this.contactBranch.equals(simpleDocumentResponseAllOfData.contactBranch)) &&
        (this.contactPerson == null ? simpleDocumentResponseAllOfData.contactPerson == null : this.contactPerson.equals(simpleDocumentResponseAllOfData.contactPerson)) &&
        (this.contactEmail == null ? simpleDocumentResponseAllOfData.contactEmail == null : this.contactEmail.equals(simpleDocumentResponseAllOfData.contactEmail)) &&
        (this.contactNumber == null ? simpleDocumentResponseAllOfData.contactNumber == null : this.contactNumber.equals(simpleDocumentResponseAllOfData.contactNumber)) &&
        (this.contactZipCode == null ? simpleDocumentResponseAllOfData.contactZipCode == null : this.contactZipCode.equals(simpleDocumentResponseAllOfData.contactZipCode)) &&
        (this.contactGroup == null ? simpleDocumentResponseAllOfData.contactGroup == null : this.contactGroup.equals(simpleDocumentResponseAllOfData.contactGroup)) &&
        (this.publishedOn == null ? simpleDocumentResponseAllOfData.publishedOn == null : this.publishedOn.equals(simpleDocumentResponseAllOfData.publishedOn)) &&
        (this.creditType == null ? simpleDocumentResponseAllOfData.creditType == null : this.creditType.equals(simpleDocumentResponseAllOfData.creditType)) &&
        (this.creditDays == null ? simpleDocumentResponseAllOfData.creditDays == null : this.creditDays.equals(simpleDocumentResponseAllOfData.creditDays)) &&
        (this.dueDate == null ? simpleDocumentResponseAllOfData.dueDate == null : this.dueDate.equals(simpleDocumentResponseAllOfData.dueDate)) &&
        (this.salesName == null ? simpleDocumentResponseAllOfData.salesName == null : this.salesName.equals(simpleDocumentResponseAllOfData.salesName)) &&
        (this.projectName == null ? simpleDocumentResponseAllOfData.projectName == null : this.projectName.equals(simpleDocumentResponseAllOfData.projectName)) &&
        (this.reference == null ? simpleDocumentResponseAllOfData.reference == null : this.reference.equals(simpleDocumentResponseAllOfData.reference)) &&
        (this.isVatInclusive == null ? simpleDocumentResponseAllOfData.isVatInclusive == null : this.isVatInclusive.equals(simpleDocumentResponseAllOfData.isVatInclusive)) &&
        (this.useReceiptDeduction == null ? simpleDocumentResponseAllOfData.useReceiptDeduction == null : this.useReceiptDeduction.equals(simpleDocumentResponseAllOfData.useReceiptDeduction)) &&
        (this.subTotal == null ? simpleDocumentResponseAllOfData.subTotal == null : this.subTotal.equals(simpleDocumentResponseAllOfData.subTotal)) &&
        (this.discountPercentage == null ? simpleDocumentResponseAllOfData.discountPercentage == null : this.discountPercentage.equals(simpleDocumentResponseAllOfData.discountPercentage)) &&
        (this.discountAmount == null ? simpleDocumentResponseAllOfData.discountAmount == null : this.discountAmount.equals(simpleDocumentResponseAllOfData.discountAmount)) &&
        (this.totalAfterDiscount == null ? simpleDocumentResponseAllOfData.totalAfterDiscount == null : this.totalAfterDiscount.equals(simpleDocumentResponseAllOfData.totalAfterDiscount)) &&
        (this.totalWithoutVat == null ? simpleDocumentResponseAllOfData.totalWithoutVat == null : this.totalWithoutVat.equals(simpleDocumentResponseAllOfData.totalWithoutVat)) &&
        (this.isVat == null ? simpleDocumentResponseAllOfData.isVat == null : this.isVat.equals(simpleDocumentResponseAllOfData.isVat)) &&
        (this.vatAmount == null ? simpleDocumentResponseAllOfData.vatAmount == null : this.vatAmount.equals(simpleDocumentResponseAllOfData.vatAmount)) &&
        (this.grandTotal == null ? simpleDocumentResponseAllOfData.grandTotal == null : this.grandTotal.equals(simpleDocumentResponseAllOfData.grandTotal)) &&
        (this.documentShowWithholdingTax == null ? simpleDocumentResponseAllOfData.documentShowWithholdingTax == null : this.documentShowWithholdingTax.equals(simpleDocumentResponseAllOfData.documentShowWithholdingTax)) &&
        (this.documentWithholdingTaxPercentage == null ? simpleDocumentResponseAllOfData.documentWithholdingTaxPercentage == null : this.documentWithholdingTaxPercentage.equals(simpleDocumentResponseAllOfData.documentWithholdingTaxPercentage)) &&
        (this.documentDeductionType == null ? simpleDocumentResponseAllOfData.documentDeductionType == null : this.documentDeductionType.equals(simpleDocumentResponseAllOfData.documentDeductionType)) &&
        (this.documentDeductionAmount == null ? simpleDocumentResponseAllOfData.documentDeductionAmount == null : this.documentDeductionAmount.equals(simpleDocumentResponseAllOfData.documentDeductionAmount)) &&
        (this.remarks == null ? simpleDocumentResponseAllOfData.remarks == null : this.remarks.equals(simpleDocumentResponseAllOfData.remarks)) &&
        (this.internalNotes == null ? simpleDocumentResponseAllOfData.internalNotes == null : this.internalNotes.equals(simpleDocumentResponseAllOfData.internalNotes)) &&
        (this.showSignatureOrStamp == null ? simpleDocumentResponseAllOfData.showSignatureOrStamp == null : this.showSignatureOrStamp.equals(simpleDocumentResponseAllOfData.showSignatureOrStamp)) &&
        (this.items == null ? simpleDocumentResponseAllOfData.items == null : this.items.equals(simpleDocumentResponseAllOfData.items)) &&
        (this.referencedToMe == null ? simpleDocumentResponseAllOfData.referencedToMe == null : this.referencedToMe.equals(simpleDocumentResponseAllOfData.referencedToMe)) &&
        (this.referencedByMe == null ? simpleDocumentResponseAllOfData.referencedByMe == null : this.referencedByMe.equals(simpleDocumentResponseAllOfData.referencedByMe)) &&
        (this.payments == null ? simpleDocumentResponseAllOfData.payments == null : this.payments.equals(simpleDocumentResponseAllOfData.payments)) &&
        (this.company == null ? simpleDocumentResponseAllOfData.company == null : this.company.equals(simpleDocumentResponseAllOfData.company)) &&
        (this.status == null ? simpleDocumentResponseAllOfData.status == null : this.status.equals(simpleDocumentResponseAllOfData.status)) &&
        (this.statusString == null ? simpleDocumentResponseAllOfData.statusString == null : this.statusString.equals(simpleDocumentResponseAllOfData.statusString)) &&
        (this.documentType == null ? simpleDocumentResponseAllOfData.documentType == null : this.documentType.equals(simpleDocumentResponseAllOfData.documentType)) &&
        (this.allowDelete == null ? simpleDocumentResponseAllOfData.allowDelete == null : this.allowDelete.equals(simpleDocumentResponseAllOfData.allowDelete));
  }
