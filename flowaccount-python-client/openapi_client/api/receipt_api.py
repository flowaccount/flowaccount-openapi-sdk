...
class ReceiptApi(object):
    ...
    def receipts_id_payment_post(self, authorization, id, unknown_base_type, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.receipts_id_payment_post(authorization, id, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.receipts_id_payment_post_with_http_info(authorization, id, unknown_base_type, **kwargs)  # noqa: E501

    def receipts_id_payment_post_with_http_info(self, authorization, id, unknown_base_type, **kwargs):  # noqa: E501
        """Change paid status of receipt document.  # noqa: E501

        เก็บเงิน เอกสารใบเสร็จรับเงิน (เงินสด) เปลี่ยนสถานะเป็น เก็บเงินแล้ว  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.receipts_id_payment_post_with_http_info(authorization, id, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('unknown_base_type' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `unknown_base_type` when calling `receipts_id_payment_post`")  # noqa: E501
    ...
    def receipts_id_status_key_status_id_post(self, authorization, id, status_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.receipts_id_status_key_status_id_post(authorization, id, status_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.receipts_id_status_key_status_id_post_with_http_info(authorization, id, status_id, **kwargs)  # noqa: E501

    def receipts_id_status_key_status_id_post_with_http_info(self, authorization, id, status_id, **kwargs):  # noqa: E501
        """Change status of receipt document.  # noqa: E501

        เปลี่ยนสถานะของเอกสารใบเสร็จรับเงิน สร้างเอกสารใหม่ครั้งแรกจะได้รับสถานะ รอดำเนินการ (awaiting)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.receipts_id_status_key_status_id_post_with_http_info(authorization, id, status_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method receipts_id_status_key_status_id_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'authorization' is set
        if self.api_client.client_side_validation and ('authorization' not in local_var_params or  # noqa: E501
                                                        local_var_params['authorization'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `authorization` when calling `receipts_id_status_key_status_id_post`")  # noqa: E501
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `receipts_id_status_key_status_id_post`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('status_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `status_id` when calling `receipts_id_status_key_status_id_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/receipts/{id}/status-key/{statusId}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def receipts_inline_with_payment_post(self, authorization, unknown_base_type, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.receipts_inline_with_payment_post(authorization, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.receipts_inline_with_payment_post_with_http_info(authorization, unknown_base_type, **kwargs)  # noqa: E501

    def receipts_inline_with_payment_post_with_http_info(self, authorization, unknown_base_type, **kwargs):  # noqa: E501
        """Create receipt document with discount and tax inline with payment.  # noqa: E501

        สร้างเอกสารใบเสร็จรับเงิน แบบส่วนลด หรือ ภาษี แยกตามรายการสินค้าพร้อมเก็บเงิน <br>เมื่อสร้างสำเร็จสถานะเอกสารจะอยู่ในสถานะ เก็บเงินแล้ว (paid)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.receipts_inline_with_payment_post_with_http_info(authorization, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('unknown_base_type' not in local_var_params or  # noqa: E501
                                                        local_var_params['unknown_base_type'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `unknown_base_type` when calling `receipts_inline_with_payment_post`")  # noqa: E501
    ...
    def receipts_with_payment_post(self, authorization, unknown_base_type, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.receipts_with_payment_post(authorization, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.receipts_with_payment_post_with_http_info(authorization, unknown_base_type, **kwargs)  # noqa: E501

    def receipts_with_payment_post_with_http_info(self, authorization, unknown_base_type, **kwargs):  # noqa: E501
        """Create receipt document with payment.  # noqa: E501

        สร้างเอกสารใบเสร็จรับเงิน พร้อมเก็บเงิน เมื่อสร้างสำเร็จสถานะเอกสารจะอยู่ในสถานะ เก็บเงินแล้ว (paid)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.receipts_with_payment_post_with_http_info(authorization, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('unknown_base_type' not in local_var_params or  # noqa: E501
                                                        local_var_params['unknown_base_type'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `unknown_base_type` when calling `receipts_with_payment_post`")  # noqa: E501
