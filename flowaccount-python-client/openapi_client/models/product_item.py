...
class ProductItem(object):
    ...
    def __init__(self, type=1, name=None, description=None, quantity=None, unit_name=None, price_per_unit=None, total=None, sell_chart_of_account_code=None, buy_chart_of_account_code=None, local_vars_configuration=None):  # noqa: E501
