...
class PaymentPaidDocument(object):
    ...
    def __init__(self, payment_structure_type=None, document_id=None, payment_method=1, payment_date=None, collected=0, withheld_percentage=0, withheld_amount=0, transfer_bank_account_id=0, bank_account_id=0, payment_charge=0, payment_remarks=None, remaining_collected_type=0, remaining_collected=0, cheque_date=None, cheque_number=None, cheque_bank_account_id=0, credit_card_bank_account_id=0, local_vars_configuration=None):  # noqa: E501
        """PaymentPaidDocument - a model defined in OpenAPI"""  # noqa: E501
    ...
    def payment_structure_type(self):
        """Gets the payment_structure_type of this PaymentPaidDocument.  # noqa: E501

        ชำระเงิน ด้วยบัตรเครดิต  # noqa: E501

        :return: The payment_structure_type of this PaymentPaidDocument.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_structure_type(self, payment_structure_type):
        """Sets the payment_structure_type of this PaymentPaidDocument.

        ชำระเงิน ด้วยบัตรเครดิต  # noqa: E501

        :param payment_structure_type: The payment_structure_type of this PaymentPaidDocument.  # noqa: E501
        :type: str
        """
    ...
    def document_id(self):
        """Gets the document_id of this PaymentPaidDocument.  # noqa: E501

        id เอกสาร  # noqa: E501

        :return: The document_id of this PaymentPaidDocument.  # noqa: E501
        :rtype: int
        """
    ...
    def document_id(self, document_id):
        """Sets the document_id of this PaymentPaidDocument.

        id เอกสาร  # noqa: E501

        :param document_id: The document_id of this PaymentPaidDocument.  # noqa: E501
        :type: int
        """
    ...
    def payment_method(self):
        """Gets the payment_method of this PaymentPaidDocument.  # noqa: E501

        ประเภทการชำระเงิน <br> 7 = บัตรเครดิต  # noqa: E501

        :return: The payment_method of this PaymentPaidDocument.  # noqa: E501
        :rtype: int
        """
    ...
    def payment_method(self, payment_method):
        """Sets the payment_method of this PaymentPaidDocument.

        ประเภทการชำระเงิน <br> 7 = บัตรเครดิต  # noqa: E501

        :param payment_method: The payment_method of this PaymentPaidDocument.  # noqa: E501
        :type: int
        """
    ...
    def payment_date(self):
        """Gets the payment_date of this PaymentPaidDocument.  # noqa: E501

        วันที่รับชำระเงิน / วันที่ชำระเงิน รูปแบบ yyyy-MM-dd <br> <ex>Example: 2020-01-01</ex>  # noqa: E501

        :return: The payment_date of this PaymentPaidDocument.  # noqa: E501
        :rtype: date
        """
    ...
    def payment_date(self, payment_date):
        """Sets the payment_date of this PaymentPaidDocument.

        วันที่รับชำระเงิน / วันที่ชำระเงิน รูปแบบ yyyy-MM-dd <br> <ex>Example: 2020-01-01</ex>  # noqa: E501

        :param payment_date: The payment_date of this PaymentPaidDocument.  # noqa: E501
        :type: date
        """
    ...
    @property
    def collected(self):
        """Gets the collected of this PaymentPaidDocument.  # noqa: E501

        จำนวนเงินยอดจ่ายสุทธิ <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :return: The collected of this PaymentPaidDocument.  # noqa: E501
        :rtype: float
        """
    ...
    def collected(self, collected):
        """Sets the collected of this PaymentPaidDocument.

        จำนวนเงินยอดจ่ายสุทธิ <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :param collected: The collected of this PaymentPaidDocument.  # noqa: E501
        :type: float
        """
    ...
    def withheld_percentage(self):
        """Gets the withheld_percentage of this PaymentPaidDocument.  # noqa: E501
        ...
        :return: The withheld_percentage of this PaymentPaidDocument.  # noqa: E501
        :rtype: int
        """
    ...
    def withheld_percentage(self, withheld_percentage):
        """Sets the withheld_percentage of this PaymentPaidDocument.

        เปอร์เซ็น หัก ณ ที่จ่าย <br> 0.5 = 0.5% <br> 0.75 = 0.75% <br> 1 = 1% <br> 1.5 = 1.5% <br> 2 = 2% <br> 3 = 3% <br> 5 = 5% <br> 10 = 10% <br> 15 = 15% <br> -1 = จำนวนเงิน <red>(สำหรับเอกสารที่ใช้ภาษีแยกตามรายการสินค้า ต้องใช้เป็นจำนวนเงิน)</red>  # noqa: E501

        :param withheld_percentage: The withheld_percentage of this PaymentPaidDocument.  # noqa: E501
        :type: int
        """
    ...
    def withheld_amount(self):
        """Gets the withheld_amount of this PaymentPaidDocument.  # noqa: E501

        จำนวน ยอดหัก ณ ที่จ่าย <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :return: The withheld_amount of this PaymentPaidDocument.  # noqa: E501
        :rtype: float
        """
    ...
    def withheld_amount(self, withheld_amount):
        """Sets the withheld_amount of this PaymentPaidDocument.

        จำนวน ยอดหัก ณ ที่จ่าย <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :param withheld_amount: The withheld_amount of this PaymentPaidDocument.  # noqa: E501
        :type: float
        """
    ...
    def transfer_bank_account_id(self):
        """Gets the transfer_bank_account_id of this PaymentPaidDocument.  # noqa: E501
        ...
        :return: The transfer_bank_account_id of this PaymentPaidDocument.  # noqa: E501
        :rtype: int
        """
    ...
    def transfer_bank_account_id(self, transfer_bank_account_id):
        """Sets the transfer_bank_account_id of this PaymentPaidDocument.

        ธนาคารที่ใช้รับชำระเงิน ธนาคารที่ชำระเงิน <br> 1 = ธนาคารกรุงเทพ <br> 2 = ธนาคารกสิกรไทย <br> 3 = ธนาคารกรุงไทย <br> 4 = ธนาคารทหารไทย <br> 5 = ธนาคารไทยพาณิชย์ <br> 6 = ธนาคารสแตนดาร์ดชาร์เตอร์ด <br> 7 = ธนาคารซีไอเอ็มบี ไทย <br> 8 = ธนาคารยูโอบี <br> 10 = ธนาคารกรุงศรีอยุธยา <br> 11 = ธนาคารออมสิน <br> 12 = ธนาคารธนชาต <br> 13 = ธนาคารแลนด์ แอนด์ เฮ้าส์ <br> 14 = ธนาคารเกียรตินาคิน <br> 15 = ธนาคารซิตี้แบงก์ <br> 16 = ธนาคารทิสโก้ <br> 53 = ธนาคารเพื่อการเกษตรและสหกรณ์การเกษตร <br> 54 = ธนาคารเพื่อการส่งออกและนำเข้าแห่งประเทศไทย <br> 55 = ธนาคารอาคารสงเคราะห์ <br> 56 = ธนาคารพัฒนาวิสาหกิจขนาดกลางและขนาดย่อมแห่งประเทศไทย <br> 57 = ธนาคารอิสลามแห่งประเทศไทย <br> 58 = ธนาคารแห่งประเทศจีน (ไทย) <br> 59 = ธนาคารไอซีบีซี (ไทย) <br> 60 = ธนาคารเมกะ สากลพาณิชย์ <br> 61 = ธนาคารซูมิโตโม มิตซุย แบงกิ้ง คอร์ปอเรชั่น <br> 62 = ธนาคารมิซูโฮ จำกัด (กรุงเทพฯ) <br> 63 = ธนาคารฮ่องกงและเซี่ยงไฮ้แบงกิ้งคอร์ปอเรชั่น <br> 64 = ธนาคารไทยเครดิต เพื่อรายย่อย   # noqa: E501

        :param transfer_bank_account_id: The transfer_bank_account_id of this PaymentPaidDocument.  # noqa: E501
        :type: int
        """
    ...
    def bank_account_id(self):
        """Gets the bank_account_id of this PaymentPaidDocument.  # noqa: E501

        เลข id บัญชีธนาคารที่ใช้ชำระเงิน <br><red>สามารถ GET มาได้จาก My Company > Bank Account </red><br> <ex>Example: 12345</ex>  # noqa: E501

        :return: The bank_account_id of this PaymentPaidDocument.  # noqa: E501
        :rtype: int
        """
    ...
    def bank_account_id(self, bank_account_id):
        """Sets the bank_account_id of this PaymentPaidDocument.

        เลข id บัญชีธนาคารที่ใช้ชำระเงิน <br><red>สามารถ GET มาได้จาก My Company > Bank Account </red><br> <ex>Example: 12345</ex>  # noqa: E501

        :param bank_account_id: The bank_account_id of this PaymentPaidDocument.  # noqa: E501
        :type: int
        """
    ...
    def payment_charge(self):
        """Gets the payment_charge of this PaymentPaidDocument.  # noqa: E501

        ค่าธรรมเนียม ที่ชำระโดยเช็ค <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :return: The payment_charge of this PaymentPaidDocument.  # noqa: E501
        :rtype: float
        """
    ...
    def payment_charge(self, payment_charge):
        """Sets the payment_charge of this PaymentPaidDocument.

        ค่าธรรมเนียม ที่ชำระโดยเช็ค <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :param payment_charge: The payment_charge of this PaymentPaidDocument.  # noqa: E501
        :type: float
        """
    ...
    def payment_remarks(self):
        """Gets the payment_remarks of this PaymentPaidDocument.  # noqa: E501

        หมายเหตุ การรับชำระเงิน หรือ ชำระเงิน  # noqa: E501

        :return: The payment_remarks of this PaymentPaidDocument.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_remarks(self, payment_remarks):
        """Sets the payment_remarks of this PaymentPaidDocument.

        หมายเหตุ การรับชำระเงิน หรือ ชำระเงิน  # noqa: E501

        :param payment_remarks: The payment_remarks of this PaymentPaidDocument.  # noqa: E501
        :type: str
        """
    ...
    def remaining_collected_type(self):
        """Gets the remaining_collected_type of this PaymentPaidDocument.  # noqa: E501

        สาเหตุเงินขาด เงินเกิน <br> 51 = เงินขาดหรือเงินกิน <br> 55 = ค่าธรรมเนียมธนาคาร   # noqa: E501

        :return: The remaining_collected_type of this PaymentPaidDocument.  # noqa: E501
        :rtype: int
        """
    ...
    def remaining_collected_type(self, remaining_collected_type):
        """Sets the remaining_collected_type of this PaymentPaidDocument.

        สาเหตุเงินขาด เงินเกิน <br> 51 = เงินขาดหรือเงินกิน <br> 55 = ค่าธรรมเนียมธนาคาร   # noqa: E501

        :param remaining_collected_type: The remaining_collected_type of this PaymentPaidDocument.  # noqa: E501
        :type: int
        """
    ...
    def remaining_collected(self):
        """Gets the remaining_collected of this PaymentPaidDocument.  # noqa: E501

        จำนวน ยอดเงินขาด หรือ เงินเกิน <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :return: The remaining_collected of this PaymentPaidDocument.  # noqa: E501
        :rtype: float
        """
    ...
    def remaining_collected(self, remaining_collected):
        """Sets the remaining_collected of this PaymentPaidDocument.

        จำนวน ยอดเงินขาด หรือ เงินเกิน <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :param remaining_collected: The remaining_collected of this PaymentPaidDocument.  # noqa: E501
        :type: float
        """
    ...
    def cheque_date(self):
        """Gets the cheque_date of this PaymentPaidDocument.  # noqa: E501

        วันที่หน้าเช็ค รูปแบบ yyyy-MM-dd <br> <ex>Example: 2020-01-01</ex>  # noqa: E501

        :return: The cheque_date of this PaymentPaidDocument.  # noqa: E501
        :rtype: date
        """
    ...
    def cheque_date(self, cheque_date):
        """Sets the cheque_date of this PaymentPaidDocument.

        วันที่หน้าเช็ค รูปแบบ yyyy-MM-dd <br> <ex>Example: 2020-01-01</ex>  # noqa: E501

        :param cheque_date: The cheque_date of this PaymentPaidDocument.  # noqa: E501
        :type: date
        """
    ...
    def cheque_number(self):
        """Gets the cheque_number of this PaymentPaidDocument.  # noqa: E501

        เลขที่เช็คธนาคาร <br> <ex>Example: 122-122-122</ex>  # noqa: E501

        :return: The cheque_number of this PaymentPaidDocument.  # noqa: E501
        :rtype: str
        """
    ...
    def cheque_number(self, cheque_number):
        """Sets the cheque_number of this PaymentPaidDocument.

        เลขที่เช็คธนาคาร <br> <ex>Example: 122-122-122</ex>  # noqa: E501

        :param cheque_number: The cheque_number of this PaymentPaidDocument.  # noqa: E501
        :type: str
        """
    ...
    def cheque_bank_account_id(self):
        """Gets the cheque_bank_account_id of this PaymentPaidDocument.  # noqa: E501

        ธนาคารที่ระบุหน้าเช็ค <br> 1 = ธนาคารกรุงเทพ <br> 2 = ธนาคารกสิกรไทย <br> 3 = ธนาคารกรุงไทย <br> 4 = ธนาคารทหารไทย <br> 5 = ธนาคารไทยพาณิชย์ <br> 6 = ธนาคารสแตนดาร์ดชาร์เตอร์ด <br> 7 = ธนาคารซีไอเอ็มบี ไทย <br> 8 = ธนาคารยูโอบี <br> 10 = ธนาคารกรุงศรีอยุธยา <br> 11 = ธนาคารออมสิน <br> 12 = ธนาคารธนชาต <br> 13 = ธนาคารแลนด์ แอนด์ เฮ้าส์ <br> 14 = ธนาคารเกียรตินาคิน <br> 15 = ธนาคารซิตี้แบงก์ <br> 16 = ธนาคารทิสโก้ <br> 53 = ธนาคารเพื่อการเกษตรและสหกรณ์การเกษตร <br> 54 = ธนาคารเพื่อการส่งออกและนำเข้าแห่งประเทศไทย <br> 55 = ธนาคารอาคารสงเคราะห์ <br> 56 = ธนาคารพัฒนาวิสาหกิจขนาดกลางและขนาดย่อมแห่งประเทศไทย <br> 57 = ธนาคารอิสลามแห่งประเทศไทย <br> 58 = ธนาคารแห่งประเทศจีน (ไทย) <br> 59 = ธนาคารไอซีบีซี (ไทย) <br> 60 = ธนาคารเมกะ สากลพาณิชย์ <br> 61 = ธนาคารซูมิโตโม มิตซุย แบงกิ้ง คอร์ปอเรชั่น <br> 62 = ธนาคารมิซูโฮ จำกัด (กรุงเทพฯ) <br> 63 = ธนาคารฮ่องกงและเซี่ยงไฮ้แบงกิ้งคอร์ปอเรชั่น <br> 64 = ธนาคารไทยเครดิต เพื่อรายย่อย   # noqa: E501

        :return: The cheque_bank_account_id of this PaymentPaidDocument.  # noqa: E501
        :rtype: int
        """
    ...
    def cheque_bank_account_id(self, cheque_bank_account_id):
        """Sets the cheque_bank_account_id of this PaymentPaidDocument.

        ธนาคารที่ระบุหน้าเช็ค <br> 1 = ธนาคารกรุงเทพ <br> 2 = ธนาคารกสิกรไทย <br> 3 = ธนาคารกรุงไทย <br> 4 = ธนาคารทหารไทย <br> 5 = ธนาคารไทยพาณิชย์ <br> 6 = ธนาคารสแตนดาร์ดชาร์เตอร์ด <br> 7 = ธนาคารซีไอเอ็มบี ไทย <br> 8 = ธนาคารยูโอบี <br> 10 = ธนาคารกรุงศรีอยุธยา <br> 11 = ธนาคารออมสิน <br> 12 = ธนาคารธนชาต <br> 13 = ธนาคารแลนด์ แอนด์ เฮ้าส์ <br> 14 = ธนาคารเกียรตินาคิน <br> 15 = ธนาคารซิตี้แบงก์ <br> 16 = ธนาคารทิสโก้ <br> 53 = ธนาคารเพื่อการเกษตรและสหกรณ์การเกษตร <br> 54 = ธนาคารเพื่อการส่งออกและนำเข้าแห่งประเทศไทย <br> 55 = ธนาคารอาคารสงเคราะห์ <br> 56 = ธนาคารพัฒนาวิสาหกิจขนาดกลางและขนาดย่อมแห่งประเทศไทย <br> 57 = ธนาคารอิสลามแห่งประเทศไทย <br> 58 = ธนาคารแห่งประเทศจีน (ไทย) <br> 59 = ธนาคารไอซีบีซี (ไทย) <br> 60 = ธนาคารเมกะ สากลพาณิชย์ <br> 61 = ธนาคารซูมิโตโม มิตซุย แบงกิ้ง คอร์ปอเรชั่น <br> 62 = ธนาคารมิซูโฮ จำกัด (กรุงเทพฯ) <br> 63 = ธนาคารฮ่องกงและเซี่ยงไฮ้แบงกิ้งคอร์ปอเรชั่น <br> 64 = ธนาคารไทยเครดิต เพื่อรายย่อย   # noqa: E501

        :param cheque_bank_account_id: The cheque_bank_account_id of this PaymentPaidDocument.  # noqa: E501
        :type: int
        """
    ...
    def credit_card_bank_account_id(self):
        """Gets the credit_card_bank_account_id of this PaymentPaidDocument.  # noqa: E501

        ธนาคารที่ชำระด้วยบัตรเครดิต <br> 1 = ธนาคารกรุงเทพ <br> 2 = ธนาคารกสิกรไทย <br> 3 = ธนาคารกรุงไทย <br> 4 = ธนาคารทหารไทย <br> 5 = ธนาคารไทยพาณิชย์ <br> 6 = ธนาคารสแตนดาร์ดชาร์เตอร์ด <br> 7 = ธนาคารซีไอเอ็มบี ไทย <br> 8 = ธนาคารยูโอบี <br> 10 = ธนาคารกรุงศรีอยุธยา <br> 11 = ธนาคารออมสิน <br> 12 = ธนาคารธนชาต <br> 13 = ธนาคารแลนด์ แอนด์ เฮ้าส์ <br> 14 = ธนาคารเกียรตินาคิน <br> 15 = ธนาคารซิตี้แบงก์ <br> 16 = ธนาคารทิสโก้ <br> 53 = ธนาคารเพื่อการเกษตรและสหกรณ์การเกษตร <br> 54 = ธนาคารเพื่อการส่งออกและนำเข้าแห่งประเทศไทย <br> 55 = ธนาคารอาคารสงเคราะห์ <br> 56 = ธนาคารพัฒนาวิสาหกิจขนาดกลางและขนาดย่อมแห่งประเทศไทย <br> 57 = ธนาคารอิสลามแห่งประเทศไทย <br> 58 = ธนาคารแห่งประเทศจีน (ไทย) <br> 59 = ธนาคารไอซีบีซี (ไทย) <br> 60 = ธนาคารเมกะ สากลพาณิชย์ <br> 61 = ธนาคารซูมิโตโม มิตซุย แบงกิ้ง คอร์ปอเรชั่น <br> 62 = ธนาคารมิซูโฮ จำกัด (กรุงเทพฯ) <br> 63 = ธนาคารฮ่องกงและเซี่ยงไฮ้แบงกิ้งคอร์ปอเรชั่น <br> 64 = ธนาคารไทยเครดิต เพื่อรายย่อย   # noqa: E501

        :return: The credit_card_bank_account_id of this PaymentPaidDocument.  # noqa: E501
        :rtype: int
        """
    ...
    def credit_card_bank_account_id(self, credit_card_bank_account_id):
        """Sets the credit_card_bank_account_id of this PaymentPaidDocument.

        ธนาคารที่ชำระด้วยบัตรเครดิต <br> 1 = ธนาคารกรุงเทพ <br> 2 = ธนาคารกสิกรไทย <br> 3 = ธนาคารกรุงไทย <br> 4 = ธนาคารทหารไทย <br> 5 = ธนาคารไทยพาณิชย์ <br> 6 = ธนาคารสแตนดาร์ดชาร์เตอร์ด <br> 7 = ธนาคารซีไอเอ็มบี ไทย <br> 8 = ธนาคารยูโอบี <br> 10 = ธนาคารกรุงศรีอยุธยา <br> 11 = ธนาคารออมสิน <br> 12 = ธนาคารธนชาต <br> 13 = ธนาคารแลนด์ แอนด์ เฮ้าส์ <br> 14 = ธนาคารเกียรตินาคิน <br> 15 = ธนาคารซิตี้แบงก์ <br> 16 = ธนาคารทิสโก้ <br> 53 = ธนาคารเพื่อการเกษตรและสหกรณ์การเกษตร <br> 54 = ธนาคารเพื่อการส่งออกและนำเข้าแห่งประเทศไทย <br> 55 = ธนาคารอาคารสงเคราะห์ <br> 56 = ธนาคารพัฒนาวิสาหกิจขนาดกลางและขนาดย่อมแห่งประเทศไทย <br> 57 = ธนาคารอิสลามแห่งประเทศไทย <br> 58 = ธนาคารแห่งประเทศจีน (ไทย) <br> 59 = ธนาคารไอซีบีซี (ไทย) <br> 60 = ธนาคารเมกะ สากลพาณิชย์ <br> 61 = ธนาคารซูมิโตโม มิตซุย แบงกิ้ง คอร์ปอเรชั่น <br> 62 = ธนาคารมิซูโฮ จำกัด (กรุงเทพฯ) <br> 63 = ธนาคารฮ่องกงและเซี่ยงไฮ้แบงกิ้งคอร์ปอเรชั่น <br> 64 = ธนาคารไทยเครดิต เพื่อรายย่อย   # noqa: E501

        :param credit_card_bank_account_id: The credit_card_bank_account_id of this PaymentPaidDocument.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentPaidDocument):
            return False
