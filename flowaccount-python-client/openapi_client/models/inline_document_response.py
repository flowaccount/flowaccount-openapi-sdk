...
class InlineDocumentResponse(object):
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """InlineDocumentResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this InlineDocumentResponse.  # noqa: E501


        :return: The data of this InlineDocumentResponse.  # noqa: E501
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this InlineDocumentResponse.


        :param data: The data of this InlineDocumentResponse.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineDocumentResponse):
            return False
