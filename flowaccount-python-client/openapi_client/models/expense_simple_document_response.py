...
class ExpenseSimpleDocumentResponse(object):
    ...
    @property
    def data(self):
        """Gets the data of this ExpenseSimpleDocumentResponse.  # noqa: E501
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this ExpenseSimpleDocumentResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExpenseSimpleDocumentResponse):
            return False
