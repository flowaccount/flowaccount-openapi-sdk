...
class PaymentPaidCash(object):
    ...
    def __init__(self, payment_structure_type=None, document_id=None, payment_method=1, payment_date=None, collected=0, withheld_percentage=0, withheld_amount=0, payment_remarks=None, remaining_collected_type=0, remaining_collected=0, local_vars_configuration=None):  # noqa: E501
        """PaymentPaidCash - a model defined in OpenAPI"""  # noqa: E501
    ...
    def payment_structure_type(self):
        """Gets the payment_structure_type of this PaymentPaidCash.  # noqa: E501

        ชำระเงิน ด้วยเงินสด  # noqa: E501

        :return: The payment_structure_type of this PaymentPaidCash.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_structure_type(self, payment_structure_type):
        """Sets the payment_structure_type of this PaymentPaidCash.

        ชำระเงิน ด้วยเงินสด  # noqa: E501

        :param payment_structure_type: The payment_structure_type of this PaymentPaidCash.  # noqa: E501
        :type: str
        """
    ...
    def document_id(self):
        """Gets the document_id of this PaymentPaidCash.  # noqa: E501

        id เอกสาร  # noqa: E501

        :return: The document_id of this PaymentPaidCash.  # noqa: E501
        :rtype: int
        """
    ...
    def document_id(self, document_id):
        """Sets the document_id of this PaymentPaidCash.

        id เอกสาร  # noqa: E501

        :param document_id: The document_id of this PaymentPaidCash.  # noqa: E501
        :type: int
        """
    ...
    def payment_method(self):
        """Gets the payment_method of this PaymentPaidCash.  # noqa: E501

        ประเภทการชำระเงิน <br> 1 = เงินสด  # noqa: E501

        :return: The payment_method of this PaymentPaidCash.  # noqa: E501
        :rtype: int
        """
    ...
    def payment_method(self, payment_method):
        """Sets the payment_method of this PaymentPaidCash.

        ประเภทการชำระเงิน <br> 1 = เงินสด  # noqa: E501

        :param payment_method: The payment_method of this PaymentPaidCash.  # noqa: E501
        :type: int
        """
    ...
    def payment_date(self):
        """Gets the payment_date of this PaymentPaidCash.  # noqa: E501

        วันที่รับชำระเงิน / วันที่ชำระเงิน รูปแบบ yyyy-MM-dd <br> <ex>Example: 2020-01-01</ex>  # noqa: E501

        :return: The payment_date of this PaymentPaidCash.  # noqa: E501
        :rtype: date
        """
    ...
    def payment_date(self, payment_date):
        """Sets the payment_date of this PaymentPaidCash.

        วันที่รับชำระเงิน / วันที่ชำระเงิน รูปแบบ yyyy-MM-dd <br> <ex>Example: 2020-01-01</ex>  # noqa: E501

        :param payment_date: The payment_date of this PaymentPaidCash.  # noqa: E501
        :type: date
        """
    ...
    @property
    def collected(self):
        """Gets the collected of this PaymentPaidCash.  # noqa: E501

        จำนวนเงินยอดจ่ายสุทธิ <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :return: The collected of this PaymentPaidCash.  # noqa: E501
        :rtype: float
        """
    ...
    def collected(self, collected):
        """Sets the collected of this PaymentPaidCash.

        จำนวนเงินยอดจ่ายสุทธิ <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :param collected: The collected of this PaymentPaidCash.  # noqa: E501
        :type: float
        """
    ...
    def withheld_percentage(self):
        """Gets the withheld_percentage of this PaymentPaidCash.  # noqa: E501
        ...
        :return: The withheld_percentage of this PaymentPaidCash.  # noqa: E501
        :rtype: int
        """
    ...
    def withheld_percentage(self, withheld_percentage):
        """Sets the withheld_percentage of this PaymentPaidCash.

        เปอร์เซ็น หัก ณ ที่จ่าย <br> 0.5 = 0.5% <br> 0.75 = 0.75% <br> 1 = 1% <br> 1.5 = 1.5% <br> 2 = 2% <br> 3 = 3% <br> 5 = 5% <br> 10 = 10% <br> 15 = 15% <br> -1 = จำนวนเงิน <red>(สำหรับเอกสารที่ใช้ภาษีแยกตามรายการสินค้า ต้องใช้เป็นจำนวนเงิน)</red>  # noqa: E501

        :param withheld_percentage: The withheld_percentage of this PaymentPaidCash.  # noqa: E501
        :type: int
        """
    ...
    def withheld_amount(self):
        """Gets the withheld_amount of this PaymentPaidCash.  # noqa: E501

        จำนวน ยอดหัก ณ ที่จ่าย <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :return: The withheld_amount of this PaymentPaidCash.  # noqa: E501
        :rtype: float
        """
    ...
    def withheld_amount(self, withheld_amount):
        """Sets the withheld_amount of this PaymentPaidCash.

        จำนวน ยอดหัก ณ ที่จ่าย <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :param withheld_amount: The withheld_amount of this PaymentPaidCash.  # noqa: E501
        :type: float
        """
    ...
    def payment_remarks(self):
        """Gets the payment_remarks of this PaymentPaidCash.  # noqa: E501

        หมายเหตุ การรับชำระเงิน หรือ ชำระเงิน  # noqa: E501

        :return: The payment_remarks of this PaymentPaidCash.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_remarks(self, payment_remarks):
        """Sets the payment_remarks of this PaymentPaidCash.

        หมายเหตุ การรับชำระเงิน หรือ ชำระเงิน  # noqa: E501

        :param payment_remarks: The payment_remarks of this PaymentPaidCash.  # noqa: E501
        :type: str
        """
    ...
    def remaining_collected_type(self):
        """Gets the remaining_collected_type of this PaymentPaidCash.  # noqa: E501

        สาเหตุเงินขาด เงินเกิน <br> 51 = เงินขาดหรือเงินกิน <br> 55 = ค่าธรรมเนียมธนาคาร   # noqa: E501

        :return: The remaining_collected_type of this PaymentPaidCash.  # noqa: E501
        :rtype: int
        """
    ...
    def remaining_collected_type(self, remaining_collected_type):
        """Sets the remaining_collected_type of this PaymentPaidCash.

        สาเหตุเงินขาด เงินเกิน <br> 51 = เงินขาดหรือเงินกิน <br> 55 = ค่าธรรมเนียมธนาคาร   # noqa: E501

        :param remaining_collected_type: The remaining_collected_type of this PaymentPaidCash.  # noqa: E501
        :type: int
        """
    ...
    def remaining_collected(self):
        """Gets the remaining_collected of this PaymentPaidCash.  # noqa: E501

        จำนวน ยอดเงินขาด หรือ เงินเกิน <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :return: The remaining_collected of this PaymentPaidCash.  # noqa: E501
        :rtype: float
        """
    ...
    def remaining_collected(self, remaining_collected):
        """Sets the remaining_collected of this PaymentPaidCash.

        จำนวน ยอดเงินขาด หรือ เงินเกิน <br> <ex> Example : 100.00 </ex>  # noqa: E501

        :param remaining_collected: The remaining_collected of this PaymentPaidCash.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentPaidCash):
            return False
