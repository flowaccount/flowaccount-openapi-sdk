...
class Product(object):
    ...
    def __init__(self, type=1, code=None, name=None, sell_description=None, sell_price=None, sell_vat_type=3, unit_name=None, category_name=None, barcode=None, buy_description=None, buy_price=None, buy_vat_type=3, inventory_published_on='2020-01-01', inventory_quantity=None, inventory_price=None, local_vars_configuration=None):  # noqa: E501
