...
class SimpleDocument(object):
    ...
    def __init__(self, items=None, document_reference=None, local_vars_configuration=None):  # noqa: E501
        """SimpleDocument - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this SimpleDocument.  # noqa: E501

        รายการสินค้าใช้งานสำหรับเอกสาร Simple  # noqa: E501

        :return: The items of this SimpleDocument.  # noqa: E501
    ...
    def items(self, items):
        """Sets the items of this SimpleDocument.

        รายการสินค้าใช้งานสำหรับเอกสาร Simple  # noqa: E501

        :param items: The items of this SimpleDocument.  # noqa: E501
    ...
    def document_reference(self):
        """Gets the document_reference of this SimpleDocument.  # noqa: E501

        สำหรับอัพเกรดเอกสาร โดยอ้างอิงเอกสารต้นทาง (ยกเว้นเอกสารใบเสนอราคา)  # noqa: E501

        :return: The document_reference of this SimpleDocument.  # noqa: E501
    ...
    def document_reference(self, document_reference):
        """Sets the document_reference of this SimpleDocument.

        สำหรับอัพเกรดเอกสาร โดยอ้างอิงเอกสารต้นทาง (ยกเว้นเอกสารใบเสนอราคา)  # noqa: E501

        :param document_reference: The document_reference of this SimpleDocument.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleDocument):
            return False
