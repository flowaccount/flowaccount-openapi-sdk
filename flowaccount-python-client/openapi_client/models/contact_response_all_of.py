...
class ContactResponseAllOf(object):
    ...
    def __init__(self, id=None, local_vars_configuration=None):  # noqa: E501
        """ContactResponseAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this ContactResponseAllOf.  # noqa: E501

        เลข id Contact  # noqa: E501

        :return: The id of this ContactResponseAllOf.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ContactResponseAllOf.

        เลข id Contact  # noqa: E501

        :param id: The id of this ContactResponseAllOf.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContactResponseAllOf):
            return False
