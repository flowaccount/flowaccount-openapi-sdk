# FlowAccountOpenApi.SimpleDocumentWithPaymentPaidCheque
...
**documentPaymentStructureType** | **String** | สร้างเอกสารแบบ Simple พร้อมชำระเงิน ด้วยเช็ค | 
**paymentMethod** | **Number** | ประเภทการชำระเงิน &lt;br&gt; 3 &#x3D; เช็ค | [default to 1]
