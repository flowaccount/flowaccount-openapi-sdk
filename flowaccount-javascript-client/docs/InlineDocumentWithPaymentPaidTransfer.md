# FlowAccountOpenApi.InlineDocumentWithPaymentPaidTransfer
...
**documentPaymentStructureType** | **String** | สร้างเอกสารแบบ Inline พร้อมชำระเงิน ด้วยการโอนเงิน | 
**paymentMethod** | **Number** | ประเภทการชำระเงิน &lt;br&gt; 5 &#x3D; โอนเงิน  | [default to 1]
...
**paymentCharge** | **Number** | ค่าธรรมเนียม ที่ชำระโดยการโอนเงิน &lt;ex&gt; Example : 100.00 &lt;/ex&gt; | [optional] [default to 0]
