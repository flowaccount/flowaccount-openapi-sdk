# FlowAccountOpenApi.InlineDocumentWithPaymentReceivingCheque
...
**documentPaymentStructureType** | **String** | สร้างเอกสารแบบ Inline พร้อมรับชำระเงิน ด้วยเช็ค | 
**paymentMethod** | **Number** | ประเภทการเก็บเงิน &lt;br&gt; 3 &#x3D; เช็ค | [default to 1]
