...
/**
 * The ExpenseSimpleDocumentWithPaymentPaidTransfer model module.
 * @module model/ExpenseSimpleDocumentWithPaymentPaidTransfer
 * @version 2-oas3
 */
class ExpenseSimpleDocumentWithPaymentPaidTransfer {
    /**
     * Constructs a new <code>ExpenseSimpleDocumentWithPaymentPaidTransfer</code>.
     * @alias module:model/ExpenseSimpleDocumentWithPaymentPaidTransfer
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, expensePaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        ExpenseSimpleDocumentWithPaymentPaidTransfer.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, expensePaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>ExpenseSimpleDocumentWithPaymentPaidTransfer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExpenseSimpleDocumentWithPaymentPaidTransfer} obj Optional instance to populate.
     * @return {module:model/ExpenseSimpleDocumentWithPaymentPaidTransfer} The populated <code>ExpenseSimpleDocumentWithPaymentPaidTransfer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExpenseSimpleDocumentWithPaymentPaidTransfer();
...
export default ExpenseSimpleDocumentWithPaymentPaidTransfer;
