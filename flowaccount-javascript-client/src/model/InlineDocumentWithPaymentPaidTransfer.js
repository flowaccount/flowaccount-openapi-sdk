...
/**
 * The InlineDocumentWithPaymentPaidTransfer model module.
 * @module model/InlineDocumentWithPaymentPaidTransfer
 * @version 2-oas3
 */
class InlineDocumentWithPaymentPaidTransfer {
    /**
     * Constructs a new <code>InlineDocumentWithPaymentPaidTransfer</code>.
     * @alias module:model/InlineDocumentWithPaymentPaidTransfer
     ...
     * @param documentPaymentStructureType {String} สร้างเอกสารแบบ Inline พร้อมชำระเงิน ด้วยการโอนเงิน
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        InlineDocumentWithPaymentPaidTransfer.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>InlineDocumentWithPaymentPaidTransfer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineDocumentWithPaymentPaidTransfer} obj Optional instance to populate.
     * @return {module:model/InlineDocumentWithPaymentPaidTransfer} The populated <code>InlineDocumentWithPaymentPaidTransfer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineDocumentWithPaymentPaidTransfer();
...
export default InlineDocumentWithPaymentPaidTransfer;
