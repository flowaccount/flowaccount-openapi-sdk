...
/**
 * The SimpleDocumentWithPaymentReceivingCash model module.
 * @module model/SimpleDocumentWithPaymentReceivingCash
 * @version 2-oas3
 */
class SimpleDocumentWithPaymentReceivingCash {
    /**
     * Constructs a new <code>SimpleDocumentWithPaymentReceivingCash</code>.
     * @alias module:model/SimpleDocumentWithPaymentReceivingCash
     ...
     * @param documentPaymentStructureType {String} สร้างเอกสารแบบ Simple พร้อมรับชำระเงิน ด้วยเงินสด
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        SimpleDocumentWithPaymentReceivingCash.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>SimpleDocumentWithPaymentReceivingCash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimpleDocumentWithPaymentReceivingCash} obj Optional instance to populate.
     * @return {module:model/SimpleDocumentWithPaymentReceivingCash} The populated <code>SimpleDocumentWithPaymentReceivingCash</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleDocumentWithPaymentReceivingCash();
...
export default SimpleDocumentWithPaymentReceivingCash;
