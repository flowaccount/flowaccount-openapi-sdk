...
/**
 * The InlineDocumentWithPaymentReceivingCash model module.
 * @module model/InlineDocumentWithPaymentReceivingCash
 * @version 2-oas3
 */
class InlineDocumentWithPaymentReceivingCash {
    /**
     * Constructs a new <code>InlineDocumentWithPaymentReceivingCash</code>.
     * @alias module:model/InlineDocumentWithPaymentReceivingCash
     ...
     * @param documentPaymentStructureType {String} สร้างเอกสารแบบ Inline พร้อมรับชำระเงิน ด้วยเงินสด
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        InlineDocumentWithPaymentReceivingCash.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>InlineDocumentWithPaymentReceivingCash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineDocumentWithPaymentReceivingCash} obj Optional instance to populate.
     * @return {module:model/InlineDocumentWithPaymentReceivingCash} The populated <code>InlineDocumentWithPaymentReceivingCash</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineDocumentWithPaymentReceivingCash();
...
export default InlineDocumentWithPaymentReceivingCash;
