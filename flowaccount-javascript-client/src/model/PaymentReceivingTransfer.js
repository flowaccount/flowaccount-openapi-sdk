...
/**
 * The PaymentReceivingTransfer model module.
 * @module model/PaymentReceivingTransfer
 * @version 2-oas3
 */
class PaymentReceivingTransfer {
    /**
     * Constructs a new <code>PaymentReceivingTransfer</code>.
     * @alias module:model/PaymentReceivingTransfer
     * @param paymentStructureType {String} รับชำระเงิน ด้วยการโอนเงิน
    ...
    constructor(paymentStructureType, documentId, paymentMethod, paymentDate, collected) { 
        ...
        PaymentReceivingTransfer.initialize(this, paymentStructureType, documentId, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>PaymentReceivingTransfer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentReceivingTransfer} obj Optional instance to populate.
     * @return {module:model/PaymentReceivingTransfer} The populated <code>PaymentReceivingTransfer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentReceivingTransfer();
...
export default PaymentReceivingTransfer;
