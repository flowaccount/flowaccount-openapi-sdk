...
/**
 * The InlineDocumentWithPaymentReceivingTransfer model module.
 * @module model/InlineDocumentWithPaymentReceivingTransfer
 * @version 2-oas3
 */
class InlineDocumentWithPaymentReceivingTransfer {
    /**
     * Constructs a new <code>InlineDocumentWithPaymentReceivingTransfer</code>.
     * @alias module:model/InlineDocumentWithPaymentReceivingTransfer
     ...
     * @param documentPaymentStructureType {String} สร้างเอกสารแบบ Inline พร้อมรับชำระเงิน ด้วยการโอนเงิน
     * @param paymentMethod {Number} ประเภทการเก็บเงิน <br> 5 = โอนเงิน 
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        InlineDocumentWithPaymentReceivingTransfer.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>InlineDocumentWithPaymentReceivingTransfer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineDocumentWithPaymentReceivingTransfer} obj Optional instance to populate.
     * @return {module:model/InlineDocumentWithPaymentReceivingTransfer} The populated <code>InlineDocumentWithPaymentReceivingTransfer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineDocumentWithPaymentReceivingTransfer();
...
export default InlineDocumentWithPaymentReceivingTransfer;
