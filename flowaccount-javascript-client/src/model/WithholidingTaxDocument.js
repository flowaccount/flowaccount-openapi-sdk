...
/**
 * The WithholidingTaxDocument model module.
 * @module model/WithholidingTaxDocument
 * @version 2-oas3
 */
class WithholidingTaxDocument {
    /**
     * Constructs a new <code>WithholidingTaxDocument</code>.
     * @alias module:model/WithholidingTaxDocument
     ...
     */
    constructor(contactName, publishedOn, entity, withholdingTaxItems, total, totalTaxWithheld) { 
        
        WithholidingTaxDocument.initialize(this, contactName, publishedOn, entity, withholdingTaxItems, total, totalTaxWithheld);
    }
     ...
     */
    static initialize(obj, contactName, publishedOn, entity, withholdingTaxItems, total, totalTaxWithheld) { 
    ...
    /**
     * Constructs a <code>WithholidingTaxDocument</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WithholidingTaxDocument} obj Optional instance to populate.
     * @return {module:model/WithholidingTaxDocument} The populated <code>WithholidingTaxDocument</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WithholidingTaxDocument();
 ...
 */
WithholidingTaxDocument.prototype['contactCode'] = undefined;

/**
 * ชื่อ ผู้จำหน่าย หรือ ผู้จำหน่าย/ลูกค้า
 * @member {String} contactName
 */
WithholidingTaxDocument.prototype['contactName'] = undefined;

/**
 * ที่อยู่ ผู้จำหน่าย หรือ ผู้จำหน่าย/ลูกค้า
 * @member {String} contactAddress
 */
WithholidingTaxDocument.prototype['contactAddress'] = undefined;
 ...
 */
WithholidingTaxDocument.prototype['contactTaxId'] = undefined;

/**
 * สำนักงาน/สาขา
 * @member {String} contactBranch
 */
WithholidingTaxDocument.prototype['contactBranch'] = undefined;

/**
 * ชื่อผู้ติดต่อ
 * @member {String} contactPerson
 */
WithholidingTaxDocument.prototype['contactPerson'] = undefined;

/**
 * อีเมลผู้ติดต่อ <br> <ex>Example: contact@email.com</ex>
 * @member {String} contactEmail
 */
WithholidingTaxDocument.prototype['contactEmail'] = undefined;

/**
 * เบอร์มือถือผู้ติดต่อ <br> <ex>Example: 099-999-9999</ex>
 * @member {String} contactNumber
 */
WithholidingTaxDocument.prototype['contactNumber'] = undefined;

/**
 * รหัสไปรษณีย์ติดต่อ
 * @member {String} contactZipCode
 */
WithholidingTaxDocument.prototype['contactZipCode'] = undefined;
 ...
 * @default 1
 */
WithholidingTaxDocument.prototype['contactGroup'] = 1;

/**
 * วันที่เอกสาร รูปแบบ yyyy-MM-dd <br> <ex>Example: 2020-01-01</ex>
 * @member {Date} publishedOn
 */
WithholidingTaxDocument.prototype['publishedOn'] = undefined;
 ...
 * @default 1
 */
WithholidingTaxDocument.prototype['entity'] = 1;

/**
 * ระบุปีของเอกสาร เช่น 2020 (สำหรับแบบฟอร์มเอกสาร ภงด 1ก หรือ ภงด 1ก (พิเศษ) <br>Example: 2020</ex>
 * @member {String} textOther
 */
WithholidingTaxDocument.prototype['textOther'] = undefined;

/**
 * รายการหัก ของเอกสารหัก ณ ที่จ่าย
 * @member {Array.<module:model/WithholidingTaxItem>} withholdingTaxItems
 */
WithholidingTaxDocument.prototype['withholdingTaxItems'] = undefined;

/**
 * จำนวนเงิน (ไม่รวมภาษี)
 * @member {Number} total
 */
WithholidingTaxDocument.prototype['total'] = undefined;

/**
 * ภาษีที่หัก
 * @member {Number} totalTaxWithheld
 */
WithholidingTaxDocument.prototype['totalTaxWithheld'] = undefined;
 ...
 * @default 1
 */
WithholidingTaxDocument.prototype['taxPayment'] = 1;

/**
 * ข้อความ สำหรับผู้จ่ายเงิน อื่นๆ 
 * @member {String} taxPaymentOthers
 */
WithholidingTaxDocument.prototype['taxPaymentOthers'] = undefined;

/**
 * ใบอนุญาตเลขที่
 * @member {String} providentFundNumber
 */
WithholidingTaxDocument.prototype['providentFundNumber'] = undefined;

/**
 * จำนวนเงินที่ต้องจ่ายเข้า กองทุนสำรองเลี้ยงชีพ
 * @member {String} providentFundAmount
 */
WithholidingTaxDocument.prototype['providentFundAmount'] = undefined;

/**
 * จำนวนเงินที่ต้องจ่ายเข้า กองทุนประกันสังคม
 * @member {String} socialSecurityAmount
 */
WithholidingTaxDocument.prototype['socialSecurityAmount'] = undefined;

/**
 * หมายเหตุเอกสาร
 * @member {String} remarks
 */
WithholidingTaxDocument.prototype['remarks'] = undefined;

/**
 * โน๊ตภายในบริษัท
 * @member {String} internalNotes
 */
WithholidingTaxDocument.prototype['internalNotes'] = undefined;
 ...
 * @default true
 */
WithholidingTaxDocument.prototype['showSignatureOrStamp'] = true;
...
export default WithholidingTaxDocument;
