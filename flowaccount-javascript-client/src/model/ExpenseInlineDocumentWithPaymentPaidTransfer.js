...
/**
 * The ExpenseInlineDocumentWithPaymentPaidTransfer model module.
 * @module model/ExpenseInlineDocumentWithPaymentPaidTransfer
 * @version 2-oas3
 */
class ExpenseInlineDocumentWithPaymentPaidTransfer {
    /**
     * Constructs a new <code>ExpenseInlineDocumentWithPaymentPaidTransfer</code>.
     * @alias module:model/ExpenseInlineDocumentWithPaymentPaidTransfer
     ...
     * @param expensePaymentStructureType {String} สร้างเอกสารแบบ Simple พร้อมชำระเงิน ด้วยการโอนเงิน
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, expensePaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        ExpenseInlineDocumentWithPaymentPaidTransfer.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, expensePaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>ExpenseInlineDocumentWithPaymentPaidTransfer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExpenseInlineDocumentWithPaymentPaidTransfer} obj Optional instance to populate.
     * @return {module:model/ExpenseInlineDocumentWithPaymentPaidTransfer} The populated <code>ExpenseInlineDocumentWithPaymentPaidTransfer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExpenseInlineDocumentWithPaymentPaidTransfer();
...
export default ExpenseInlineDocumentWithPaymentPaidTransfer;
