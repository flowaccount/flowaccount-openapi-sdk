...
/**
 * The SimpleDocumentResponseAllOfData model module.
 * @module model/SimpleDocumentResponseAllOfData
 * @version 2-oas3
 */
class SimpleDocumentResponseAllOfData {
    /**
     * Constructs a new <code>SimpleDocumentResponseAllOfData</code>.
     * @alias module:model/SimpleDocumentResponseAllOfData
     */
    constructor() { 
        
        SimpleDocumentResponseAllOfData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SimpleDocumentResponseAllOfData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimpleDocumentResponseAllOfData} obj Optional instance to populate.
     * @return {module:model/SimpleDocumentResponseAllOfData} The populated <code>SimpleDocumentResponseAllOfData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleDocumentResponseAllOfData();
 ...
 * @default 0
 */
SimpleDocumentResponseAllOfData.prototype['recordId'] = 0;
 ...
 * @default 0
 */
SimpleDocumentResponseAllOfData.prototype['documentId'] = 0;

/**
 * เลขที่เอกสาร
 * @member {String} documentSerial
 */
SimpleDocumentResponseAllOfData.prototype['documentSerial'] = undefined;

/**
 * รหัส ลูกค้า/ผู้จำหน่าย
 * @member {String} contactCode
 */
SimpleDocumentResponseAllOfData.prototype['contactCode'] = undefined;

/**
 * ชื่อ ลูกค้า/ผู้จำหน่าย <br> <ex>Example: บริษัท ลูกค้า จำกัด, คุณลูกค้า ซื้อประจำ</ex>
 * @member {String} contactName
 */
SimpleDocumentResponseAllOfData.prototype['contactName'] = undefined;

/**
 * ที่อยู่ ลูกค้า/ผู้จำหน่าย
 * @member {String} contactAddress
 */
SimpleDocumentResponseAllOfData.prototype['contactAddress'] = undefined;
 ...
 */
SimpleDocumentResponseAllOfData.prototype['contactTaxId'] = undefined;

/**
 * สำนักงาน/สาขา
 * @member {String} contactBranch
 */
SimpleDocumentResponseAllOfData.prototype['contactBranch'] = undefined;

/**
 * ชื่อผู้ติดต่อ
 * @member {String} contactPerson
 */
SimpleDocumentResponseAllOfData.prototype['contactPerson'] = undefined;

/**
 * อีเมลผู้ติดต่อ <br> <ex>Example: contact@email.com</ex>
 * @member {String} contactEmail
 */
SimpleDocumentResponseAllOfData.prototype['contactEmail'] = undefined;

/**
 * เบอร์มือถือผู้ติดต่อ <br> <ex>Example: 099-999-9999</ex>
 * @member {String} contactNumber
 */
SimpleDocumentResponseAllOfData.prototype['contactNumber'] = undefined;

/**
 * รหัสไปรษณีย์ติดต่อ
 * @member {String} contactZipCode
 */
SimpleDocumentResponseAllOfData.prototype['contactZipCode'] = undefined;
 ...
 * @default 1
 */
SimpleDocumentResponseAllOfData.prototype['contactGroup'] = 1;

/**
 * วันที่เอกสาร รูปแบบ yyyy-MM-dd <br> <ex>Example: 2020-01-01</ex>
 * @member {Date} publishedOn
 */
SimpleDocumentResponseAllOfData.prototype['publishedOn'] = undefined;
 ...
 * @default 1
 */
SimpleDocumentResponseAllOfData.prototype['creditType'] = 1;
 ...
 * @default 0
 */
SimpleDocumentResponseAllOfData.prototype['creditDays'] = 0;

/**
 * วันครบกำหนดเอกสาร รูปแบบ yyyy-MM-dd <br> <ex>Example: 2020-01-01</ex>
 * @member {Date} dueDate
 */
SimpleDocumentResponseAllOfData.prototype['dueDate'] = undefined;
 ...
 */
SimpleDocumentResponseAllOfData.prototype['salesName'] = 'อีเมล หรือ ชื่อผู้สร้างเอกสาร';

/**
 * ชื่อโปรเจค
 * @member {String} projectName
 */
SimpleDocumentResponseAllOfData.prototype['projectName'] = undefined;

/**
 * เลขที่อ้างอิง หรือ เลขที่เอกสารที่เกี่ยวข้อง <br> <ex>Example: INV2020010001</ex>
 * @member {String} reference
 */
SimpleDocumentResponseAllOfData.prototype['reference'] = undefined;
 ...
 * @default false
 */
SimpleDocumentResponseAllOfData.prototype['isVatInclusive'] = false;
 ...
 * @default false
 */
SimpleDocumentResponseAllOfData.prototype['useReceiptDeduction'] = false;
 ...
 * @default 0
 */
SimpleDocumentResponseAllOfData.prototype['subTotal'] = 0;
 ...
 * @default 0
 */
SimpleDocumentResponseAllOfData.prototype['discountPercentage'] = 0;
 ...
 * @default 0
 */
SimpleDocumentResponseAllOfData.prototype['discountAmount'] = 0;

/**
 * มูลค่าหลังหักส่วนลด
 * @member {Number} totalAfterDiscount
 */
SimpleDocumentResponseAllOfData.prototype['totalAfterDiscount'] = undefined;

/**
 * มูลค่าไม่รวมภาษีมูลค่าเพิ่ม
 * @member {Number} totalWithoutVat
 */
SimpleDocumentResponseAllOfData.prototype['totalWithoutVat'] = undefined;
 ...
 * @default false
 */
SimpleDocumentResponseAllOfData.prototype['isVat'] = false;

/**
 * ภาษีมูลค่าเพิ่ม
 * @member {Number} vatAmount
 */
SimpleDocumentResponseAllOfData.prototype['vatAmount'] = undefined;

/**
 * จำนวนเงินรวมทั้งสิ้น (รวมภาษีมูลค่าเพิ่ม 7% แล้ว)
 * @member {Number} grandTotal
 */
SimpleDocumentResponseAllOfData.prototype['grandTotal'] = undefined;
 ...
 * @default false
 */
SimpleDocumentResponseAllOfData.prototype['documentShowWithholdingTax'] = false;
 ...
 * @default 0
 */
SimpleDocumentResponseAllOfData.prototype['documentWithholdingTaxPercentage'] = 0;
 ...
 * @default 0
 */
SimpleDocumentResponseAllOfData.prototype['documentDeductionType'] = 0;
 ...
 * @default 0
 */
SimpleDocumentResponseAllOfData.prototype['documentDeductionAmount'] = 0;

/**
 * หมายเหตุเอกสาร
 * @member {String} remarks
 */
SimpleDocumentResponseAllOfData.prototype['remarks'] = undefined;

/**
 * โน๊ตภายในบริษัท
 * @member {String} internalNotes
 */
SimpleDocumentResponseAllOfData.prototype['internalNotes'] = undefined;
 ...
 * @default true
 */
SimpleDocumentResponseAllOfData.prototype['showSignatureOrStamp'] = true;

/**
 * รายการสินค้าใช้งานสำหรับเอกสาร Simple Document
 * @member {Array.<module:model/SimpleProductItem>} items
 */
SimpleDocumentResponseAllOfData.prototype['items'] = undefined;

/**
 * ข้อมูลเอกสารปลายทางที่อ้างอิง ถึง เอกสารฉบับนี้
 * @member {Array.<module:model/ReferencedToMe>} referencedToMe
 */
SimpleDocumentResponseAllOfData.prototype['referencedToMe'] = undefined;

/**
 * เอกสารต้นทางที่อ้างอิง ถึง เอกสารฉบับนี้
 * @member {Array.<module:model/ReferencedByMe>} referencedByMe
 */
SimpleDocumentResponseAllOfData.prototype['referencedByMe'] = undefined;

/**
 * @member {module:model/SimpleDocumentResponseAllOfDataPayments} payments
 */
SimpleDocumentResponseAllOfData.prototype['payments'] = undefined;

/**
 * @member {module:model/SimpleDocumentResponseAllOfDataCompany} company
 */
SimpleDocumentResponseAllOfData.prototype['company'] = undefined;

/**
 * เลขสถานะเอกสารฉบับนี้
 * @member {Number} status
 */
SimpleDocumentResponseAllOfData.prototype['status'] = undefined;

/**
 * ชื่อสถานะเอกสารฉบับนี้
 * @member {Number} statusString
 */
SimpleDocumentResponseAllOfData.prototype['statusString'] = undefined;

/**
 * เลขประเภทเอกสารฉบับนี้
 * @member {Number} documentType
 */
SimpleDocumentResponseAllOfData.prototype['documentType'] = undefined;

/**
 * สามารถลบเอกสาร :<br> true = ลบได้ <br> false = ลบไม่ได้
 * @member {Boolean} allowDelete
 */
SimpleDocumentResponseAllOfData.prototype['allowDelete'] = undefined;
...
export default SimpleDocumentResponseAllOfData;
