...
/**
 * The SimpleDocumentWithPaymentPaidCash model module.
 * @module model/SimpleDocumentWithPaymentPaidCash
 * @version 2-oas3
 */
class SimpleDocumentWithPaymentPaidCash {
    /**
     * Constructs a new <code>SimpleDocumentWithPaymentPaidCash</code>.
     * @alias module:model/SimpleDocumentWithPaymentPaidCash
     ...
     * @param documentPaymentStructureType {String} สร้างเอกสารแบบ Simple พร้อมชำระเงิน ด้วยเงินสด
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        SimpleDocumentWithPaymentPaidCash.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>SimpleDocumentWithPaymentPaidCash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimpleDocumentWithPaymentPaidCash} obj Optional instance to populate.
     * @return {module:model/SimpleDocumentWithPaymentPaidCash} The populated <code>SimpleDocumentWithPaymentPaidCash</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleDocumentWithPaymentPaidCash();
...
export default SimpleDocumentWithPaymentPaidCash;
