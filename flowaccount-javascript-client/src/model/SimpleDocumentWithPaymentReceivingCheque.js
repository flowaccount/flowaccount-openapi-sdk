...
/**
 * The SimpleDocumentWithPaymentReceivingCheque model module.
 * @module model/SimpleDocumentWithPaymentReceivingCheque
 * @version 2-oas3
 */
class SimpleDocumentWithPaymentReceivingCheque {
    /**
     * Constructs a new <code>SimpleDocumentWithPaymentReceivingCheque</code>.
     * @alias module:model/SimpleDocumentWithPaymentReceivingCheque
     ...
     * @param documentPaymentStructureType {String} สร้างเอกสารแบบ Simple พร้อมรับชำระเงิน ด้วยเช็ค
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        SimpleDocumentWithPaymentReceivingCheque.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>SimpleDocumentWithPaymentReceivingCheque</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimpleDocumentWithPaymentReceivingCheque} obj Optional instance to populate.
     * @return {module:model/SimpleDocumentWithPaymentReceivingCheque} The populated <code>SimpleDocumentWithPaymentReceivingCheque</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleDocumentWithPaymentReceivingCheque();
...
export default SimpleDocumentWithPaymentReceivingCheque;
