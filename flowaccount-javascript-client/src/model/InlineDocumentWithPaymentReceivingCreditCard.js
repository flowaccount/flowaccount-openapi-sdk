...
/**
 * The InlineDocumentWithPaymentReceivingCreditCard model module.
 * @module model/InlineDocumentWithPaymentReceivingCreditCard
 * @version 2-oas3
 */
class InlineDocumentWithPaymentReceivingCreditCard {
    /**
     * Constructs a new <code>InlineDocumentWithPaymentReceivingCreditCard</code>.
     * @alias module:model/InlineDocumentWithPaymentReceivingCreditCard
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        InlineDocumentWithPaymentReceivingCreditCard.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>InlineDocumentWithPaymentReceivingCreditCard</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineDocumentWithPaymentReceivingCreditCard} obj Optional instance to populate.
     * @return {module:model/InlineDocumentWithPaymentReceivingCreditCard} The populated <code>InlineDocumentWithPaymentReceivingCreditCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineDocumentWithPaymentReceivingCreditCard();
...
export default InlineDocumentWithPaymentReceivingCreditCard;
