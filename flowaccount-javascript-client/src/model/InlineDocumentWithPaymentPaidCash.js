...
/**
 * The InlineDocumentWithPaymentPaidCash model module.
 * @module model/InlineDocumentWithPaymentPaidCash
 * @version 2-oas3
 */
class InlineDocumentWithPaymentPaidCash {
    /**
     * Constructs a new <code>InlineDocumentWithPaymentPaidCash</code>.
     * @alias module:model/InlineDocumentWithPaymentPaidCash
     ...
     * @param documentPaymentStructureType {String} สร้างเอกสารแบบ Inline พร้อมชำระเงิน ด้วยเงินสด
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        InlineDocumentWithPaymentPaidCash.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>InlineDocumentWithPaymentPaidCash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineDocumentWithPaymentPaidCash} obj Optional instance to populate.
     * @return {module:model/InlineDocumentWithPaymentPaidCash} The populated <code>InlineDocumentWithPaymentPaidCash</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineDocumentWithPaymentPaidCash();
...
export default InlineDocumentWithPaymentPaidCash;
