...
/**
 * The InlineDocumentWithPaymentPaidCreditCard model module.
 * @module model/InlineDocumentWithPaymentPaidCreditCard
 * @version 2-oas3
 */
class InlineDocumentWithPaymentPaidCreditCard {
    /**
     * Constructs a new <code>InlineDocumentWithPaymentPaidCreditCard</code>.
     * @alias module:model/InlineDocumentWithPaymentPaidCreditCard
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        InlineDocumentWithPaymentPaidCreditCard.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>InlineDocumentWithPaymentPaidCreditCard</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineDocumentWithPaymentPaidCreditCard} obj Optional instance to populate.
     * @return {module:model/InlineDocumentWithPaymentPaidCreditCard} The populated <code>InlineDocumentWithPaymentPaidCreditCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineDocumentWithPaymentPaidCreditCard();
...
export default InlineDocumentWithPaymentPaidCreditCard;
