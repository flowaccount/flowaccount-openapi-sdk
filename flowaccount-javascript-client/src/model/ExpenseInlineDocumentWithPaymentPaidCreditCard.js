...
/**
 * The ExpenseInlineDocumentWithPaymentPaidCreditCard model module.
 * @module model/ExpenseInlineDocumentWithPaymentPaidCreditCard
 * @version 2-oas3
 */
class ExpenseInlineDocumentWithPaymentPaidCreditCard {
    /**
     * Constructs a new <code>ExpenseInlineDocumentWithPaymentPaidCreditCard</code>.
     * @alias module:model/ExpenseInlineDocumentWithPaymentPaidCreditCard
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, expensePaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        ExpenseInlineDocumentWithPaymentPaidCreditCard.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, expensePaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>ExpenseInlineDocumentWithPaymentPaidCreditCard</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExpenseInlineDocumentWithPaymentPaidCreditCard} obj Optional instance to populate.
     * @return {module:model/ExpenseInlineDocumentWithPaymentPaidCreditCard} The populated <code>ExpenseInlineDocumentWithPaymentPaidCreditCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExpenseInlineDocumentWithPaymentPaidCreditCard();
...
export default ExpenseInlineDocumentWithPaymentPaidCreditCard;
