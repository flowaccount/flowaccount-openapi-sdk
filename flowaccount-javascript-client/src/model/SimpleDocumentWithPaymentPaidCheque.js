...
/**
 * The SimpleDocumentWithPaymentPaidCheque model module.
 * @module model/SimpleDocumentWithPaymentPaidCheque
 * @version 2-oas3
 */
class SimpleDocumentWithPaymentPaidCheque {
    /**
     * Constructs a new <code>SimpleDocumentWithPaymentPaidCheque</code>.
     * @alias module:model/SimpleDocumentWithPaymentPaidCheque
     ...
     * @param documentPaymentStructureType {String} สร้างเอกสารแบบ Simple พร้อมชำระเงิน ด้วยเช็ค
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        SimpleDocumentWithPaymentPaidCheque.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>SimpleDocumentWithPaymentPaidCheque</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimpleDocumentWithPaymentPaidCheque} obj Optional instance to populate.
     * @return {module:model/SimpleDocumentWithPaymentPaidCheque} The populated <code>SimpleDocumentWithPaymentPaidCheque</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleDocumentWithPaymentPaidCheque();
...
export default SimpleDocumentWithPaymentPaidCheque;
