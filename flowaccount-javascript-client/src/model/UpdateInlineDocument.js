...
/**
 * The UpdateInlineDocument model module.
 * @module model/UpdateInlineDocument
 * @version 2-oas3
 */
class UpdateInlineDocument {
    /**
     * Constructs a new <code>UpdateInlineDocument</code>.
     * @alias module:model/UpdateInlineDocument
    ...
    constructor(companyName, companyBranch, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentStructureType) { 
        UpdateDocument.initialize(this, companyName, companyBranch, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentStructureType);InlineDocumentAllOf.initialize(this);
        UpdateInlineDocument.initialize(this, companyName, companyBranch, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentStructureType);
    }
    ...
    /**
     * Constructs a <code>UpdateInlineDocument</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateInlineDocument} obj Optional instance to populate.
     * @return {module:model/UpdateInlineDocument} The populated <code>UpdateInlineDocument</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateInlineDocument();
 ...
 * @default 1
 */
UpdateInlineDocument.prototype['discountType'] = 1;
 ...
 * @default true
 */
UpdateInlineDocument.prototype['useInlineDiscount'] = true;

/**
 * inline vat ใช้งานส่วนลดและภาษี แยกตามรายการสินค้า
 * @member {Boolean} useInlineVat
 */
UpdateInlineDocument.prototype['useInlineVat'] = undefined;
 ...
 * @default 0
 */
UpdateInlineDocument.prototype['exemptAmount'] = 0;
 ...
 * @default 0
 */
UpdateInlineDocument.prototype['vatableAmount'] = 0;

/**
 * รายการสินค้าใช้งานสำหรับเอกสาร Inline
 * @member {Array.<module:model/InlineProductItem>} items
 */
UpdateInlineDocument.prototype['items'] = undefined;
 ...
 */
UpdateInlineDocument.prototype['documentReference'] = undefined;
...
export default UpdateInlineDocument;
