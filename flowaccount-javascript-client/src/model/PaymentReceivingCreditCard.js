...
/**
 * The PaymentReceivingCreditCard model module.
 * @module model/PaymentReceivingCreditCard
 * @version 2-oas3
 */
class PaymentReceivingCreditCard {
    /**
     * Constructs a new <code>PaymentReceivingCreditCard</code>.
     * @alias module:model/PaymentReceivingCreditCard
    ...
    constructor(paymentStructureType, documentId, paymentMethod, paymentDate, collected) { 
        ...
        PaymentReceivingCreditCard.initialize(this, paymentStructureType, documentId, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>PaymentReceivingCreditCard</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentReceivingCreditCard} obj Optional instance to populate.
     * @return {module:model/PaymentReceivingCreditCard} The populated <code>PaymentReceivingCreditCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentReceivingCreditCard();
...
export default PaymentReceivingCreditCard;
