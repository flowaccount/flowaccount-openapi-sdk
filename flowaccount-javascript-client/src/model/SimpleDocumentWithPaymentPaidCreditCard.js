...
/**
 * The SimpleDocumentWithPaymentPaidCreditCard model module.
 * @module model/SimpleDocumentWithPaymentPaidCreditCard
 * @version 2-oas3
 */
class SimpleDocumentWithPaymentPaidCreditCard {
    /**
     * Constructs a new <code>SimpleDocumentWithPaymentPaidCreditCard</code>.
     * @alias module:model/SimpleDocumentWithPaymentPaidCreditCard
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        SimpleDocumentWithPaymentPaidCreditCard.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>SimpleDocumentWithPaymentPaidCreditCard</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimpleDocumentWithPaymentPaidCreditCard} obj Optional instance to populate.
     * @return {module:model/SimpleDocumentWithPaymentPaidCreditCard} The populated <code>SimpleDocumentWithPaymentPaidCreditCard</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleDocumentWithPaymentPaidCreditCard();
...
export default SimpleDocumentWithPaymentPaidCreditCard;
