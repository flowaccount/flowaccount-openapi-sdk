...
/**
 * The ExpenseInlineDocumentResponseAllOfData model module.
 * @module model/ExpenseInlineDocumentResponseAllOfData
 * @version 2-oas3
 */
class ExpenseInlineDocumentResponseAllOfData {
    /**
     * Constructs a new <code>ExpenseInlineDocumentResponseAllOfData</code>.
     * @alias module:model/ExpenseInlineDocumentResponseAllOfData
     */
    constructor() { 
        
        ExpenseInlineDocumentResponseAllOfData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExpenseInlineDocumentResponseAllOfData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExpenseInlineDocumentResponseAllOfData} obj Optional instance to populate.
     * @return {module:model/ExpenseInlineDocumentResponseAllOfData} The populated <code>ExpenseInlineDocumentResponseAllOfData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExpenseInlineDocumentResponseAllOfData();
 ...
 * @default 0
 */
ExpenseInlineDocumentResponseAllOfData.prototype['recordId'] = 0;
 ...
 * @default 0
 */
ExpenseInlineDocumentResponseAllOfData.prototype['documentId'] = 0;

/**
 * เลขที่เอกสาร
 * @member {String} documentSerial
 */
ExpenseInlineDocumentResponseAllOfData.prototype['documentSerial'] = undefined;

/**
 * รหัส ผู้จำหน่าย หรือ ผู้จำหน่าย/ลูกค้า
 * @member {String} contactCode
 */
ExpenseInlineDocumentResponseAllOfData.prototype['contactCode'] = undefined;

/**
 * ชื่อ ผู้จำหน่าย หรือ ผู้จำหน่าย/ลูกค้า
 * @member {String} contactName
 */
ExpenseInlineDocumentResponseAllOfData.prototype['contactName'] = undefined;

/**
 * ที่อยู่ ผู้จำหน่าย หรือ ผู้จำหน่าย/ลูกค้า
 * @member {String} contactAddress
 */
ExpenseInlineDocumentResponseAllOfData.prototype['contactAddress'] = undefined;
 ...
 */
ExpenseInlineDocumentResponseAllOfData.prototype['contactTaxId'] = undefined;

/**
 * สำนักงาน/สาขา
 * @member {String} contactBranch
 */
ExpenseInlineDocumentResponseAllOfData.prototype['contactBranch'] = undefined;

/**
 * ชื่อผู้ติดต่อ
 * @member {String} contactPerson
 */
ExpenseInlineDocumentResponseAllOfData.prototype['contactPerson'] = undefined;

/**
 * อีเมลผู้ติดต่อ <br> <ex>Example: supplier@email.com</ex>
 * @member {String} contactEmail
 */
ExpenseInlineDocumentResponseAllOfData.prototype['contactEmail'] = undefined;

/**
 * เบอร์มือถือผู้ติดต่อ <br> <ex>Example: 099-999-9999</ex>
 * @member {String} contactNumber
 */
ExpenseInlineDocumentResponseAllOfData.prototype['contactNumber'] = undefined;

/**
 * รหัสไปรษณีย์ติดต่อ
 * @member {String} contactZipCode
 */
ExpenseInlineDocumentResponseAllOfData.prototype['contactZipCode'] = undefined;
 ...
 * @default 1
 */
ExpenseInlineDocumentResponseAllOfData.prototype['contactGroup'] = 1;

/**
 * วันที่เอกสาร รูปแบบ yyyy-MM-dd <br> <ex>Example: 2020-01-01</ex>
 * @member {Date} publishedOn
 */
ExpenseInlineDocumentResponseAllOfData.prototype['publishedOn'] = undefined;
 ...
 * @default 1
 */
ExpenseInlineDocumentResponseAllOfData.prototype['creditType'] = 1;
 ...
 * @default 0
 */
ExpenseInlineDocumentResponseAllOfData.prototype['creditDays'] = 0;

/**
 * วันครบกำหนดเอกสาร รูปแบบ yyyy-MM-dd <br> <ex>Example: 2020-01-01</ex>
 * @member {Date} dueDate
 */
ExpenseInlineDocumentResponseAllOfData.prototype['dueDate'] = undefined;
 ...
 */
ExpenseInlineDocumentResponseAllOfData.prototype['salesName'] = 'อีเมล หรือ ชื่อผู้สร้างเอกสาร';

/**
 * ชื่อโปรเจค
 * @member {String} projectName
 */
ExpenseInlineDocumentResponseAllOfData.prototype['projectName'] = undefined;

/**
 * เลขที่อ้างอิง หรือ เลขที่เอกสารที่เกี่ยวข้อง <br> <ex>Example: INV2020010001</ex>
 * @member {String} reference
 */
ExpenseInlineDocumentResponseAllOfData.prototype['reference'] = undefined;
 ...
 * @default false
 */
ExpenseInlineDocumentResponseAllOfData.prototype['isVatInclusive'] = false;

/**
 * รายการสินค้าใช้งานสำหรับเอกสาร Inline Expense
 * @member {Array.<module:model/ExpenseInlineProductItem>} items
 */
ExpenseInlineDocumentResponseAllOfData.prototype['items'] = undefined;
 ...
 * @default 0
 */
ExpenseInlineDocumentResponseAllOfData.prototype['subTotal'] = 0;
 ...
 * @default 0
 */
ExpenseInlineDocumentResponseAllOfData.prototype['discountPercentage'] = 0;
 ...
 * @default 0
 */
ExpenseInlineDocumentResponseAllOfData.prototype['discountAmount'] = 0;

/**
 * มูลค่าหลังหักส่วนลด
 * @member {Number} totalAfterDiscount
 */
ExpenseInlineDocumentResponseAllOfData.prototype['totalAfterDiscount'] = undefined;
 ...
 * @default false
 */
ExpenseInlineDocumentResponseAllOfData.prototype['isVat'] = false;

/**
 * ภาษีมูลค่าเพิ่ม
 * @member {Number} vatAmount
 */
ExpenseInlineDocumentResponseAllOfData.prototype['vatAmount'] = undefined;

/**
 * จำนวนเงินรวมทั้งสิ้น (รวมภาษีมูลค่าเพิ่ม 7% แล้ว)
 * @member {Number} grandTotal
 */
ExpenseInlineDocumentResponseAllOfData.prototype['grandTotal'] = undefined;

/**
 * หมายเหตุเอกสาร
 * @member {String} remarks
 */
ExpenseInlineDocumentResponseAllOfData.prototype['remarks'] = undefined;

/**
 * โน๊ตภายในบริษัท
 * @member {String} internalNotes
 */
ExpenseInlineDocumentResponseAllOfData.prototype['internalNotes'] = undefined;
 ...
 * @default true
 */
ExpenseInlineDocumentResponseAllOfData.prototype['showSignatureOrStamp'] = true;
 ...
 * @default 1
 */
ExpenseInlineDocumentResponseAllOfData.prototype['discountType'] = 1;
 ...
 * @default true
 */
ExpenseInlineDocumentResponseAllOfData.prototype['useInlineDiscount'] = true;

/**
 * inline vat ใช้งานส่วนลดและภาษี แยกตามรายการสินค้า
 * @member {Boolean} useInlineVat
 */
ExpenseInlineDocumentResponseAllOfData.prototype['useInlineVat'] = undefined;
 ...
 * @default 0
 */
ExpenseInlineDocumentResponseAllOfData.prototype['exemptAmount'] = 0;
 ...
 * @default 0
 */
ExpenseInlineDocumentResponseAllOfData.prototype['vatableAmount'] = 0;

/**
 * @member {module:model/SimpleDocumentResponseAllOfDataPayments} payments
 */
ExpenseInlineDocumentResponseAllOfData.prototype['payments'] = undefined;

/**
 * @member {module:model/SimpleDocumentResponseAllOfDataCompany} company
 */
ExpenseInlineDocumentResponseAllOfData.prototype['company'] = undefined;

/**
 * เลขสถานะเอกสารฉบับนี้
 * @member {Number} status
 */
ExpenseInlineDocumentResponseAllOfData.prototype['status'] = undefined;

/**
 * ชื่อสถานะเอกสารฉบับนี้
 * @member {Number} statusString
 */
ExpenseInlineDocumentResponseAllOfData.prototype['statusString'] = undefined;

/**
 * เลขประเภทเอกสารฉบับนี้
 * @member {Number} documentType
 */
ExpenseInlineDocumentResponseAllOfData.prototype['documentType'] = undefined;

/**
 * สามารถลบเอกสาร :<br> true = ลบได้ <br> false = ลบไม่ได้
 * @member {Boolean} allowDelete
 */
ExpenseInlineDocumentResponseAllOfData.prototype['allowDelete'] = undefined;
...
export default ExpenseInlineDocumentResponseAllOfData;
