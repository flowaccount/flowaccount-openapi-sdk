...
/**
 * The PaymentPaidTransfer model module.
 * @module model/PaymentPaidTransfer
 * @version 2-oas3
 */
class PaymentPaidTransfer {
    /**
     * Constructs a new <code>PaymentPaidTransfer</code>.
     * @alias module:model/PaymentPaidTransfer
     * @param paymentStructureType {String} ชำระเงิน ด้วยการโอนเงิน
    ...
    constructor(paymentStructureType, documentId, paymentMethod, paymentDate, collected) { 
        ...
        PaymentPaidTransfer.initialize(this, paymentStructureType, documentId, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>PaymentPaidTransfer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentPaidTransfer} obj Optional instance to populate.
     * @return {module:model/PaymentPaidTransfer} The populated <code>PaymentPaidTransfer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentPaidTransfer();
...
export default PaymentPaidTransfer;
