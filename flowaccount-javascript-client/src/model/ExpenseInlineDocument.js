...
/**
 * The ExpenseInlineDocument model module.
 * @module model/ExpenseInlineDocument
 * @version 2-oas3
 */
class ExpenseInlineDocument {
    /**
     * Constructs a new <code>ExpenseInlineDocument</code>.
     * @alias module:model/ExpenseInlineDocument
    ...
    constructor(contactName, publishedOn, subTotal, totalAfterDiscount, grandTotal) { 
        ExpenseDocument.initialize(this, contactName, publishedOn, subTotal, totalAfterDiscount, grandTotal);ExpenseInlineDocumentAllOf.initialize(this);
        ExpenseInlineDocument.initialize(this, contactName, publishedOn, subTotal, totalAfterDiscount, grandTotal);
    }
    ...
    /**
     * Constructs a <code>ExpenseInlineDocument</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExpenseInlineDocument} obj Optional instance to populate.
     * @return {module:model/ExpenseInlineDocument} The populated <code>ExpenseInlineDocument</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExpenseInlineDocument();
 ...
 */
ExpenseInlineDocument.prototype['items'] = undefined;
 ...
 * @default 1
 */
ExpenseInlineDocument.prototype['discountType'] = 1;
 ...
 * @default true
 */
ExpenseInlineDocument.prototype['useInlineDiscount'] = true;

/**
 * inline vat ใช้งานส่วนลดและภาษี แยกตามรายการสินค้า
 * @member {Boolean} useInlineVat
 */
ExpenseInlineDocument.prototype['useInlineVat'] = undefined;
 ...
 * @default 0
 */
ExpenseInlineDocument.prototype['exemptAmount'] = 0;
 ...
 * @default 0
 */
ExpenseInlineDocument.prototype['vatableAmount'] = 0;
...
export default ExpenseInlineDocument;
