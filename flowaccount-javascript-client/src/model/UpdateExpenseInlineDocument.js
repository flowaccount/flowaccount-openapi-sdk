...
/**
 * The UpdateExpenseInlineDocument model module.
 * @module model/UpdateExpenseInlineDocument
 * @version 2-oas3
 */
class UpdateExpenseInlineDocument {
    /**
     * Constructs a new <code>UpdateExpenseInlineDocument</code>.
     * @alias module:model/UpdateExpenseInlineDocument
     * @extends module:model/UpdateExpenseDocument
     * @implements module:model/UpdateExpenseDocument
     * @implements module:model/ExpenseInlineDocumentAllOf
    ...
    constructor(companyName, companyAddress, companyBranch, contactName, publishedOn, subTotal, totalAfterDiscount, grandTotal) { 
        UpdateExpenseDocument.initialize(this, companyName, companyAddress, companyBranch, contactName, publishedOn, subTotal, totalAfterDiscount, grandTotal);ExpenseInlineDocumentAllOf.initialize(this);
        UpdateExpenseInlineDocument.initialize(this, companyName, companyAddress, companyBranch, contactName, publishedOn, subTotal, totalAfterDiscount, grandTotal);
    }
    ...
    /**
     * Constructs a <code>UpdateExpenseInlineDocument</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdateExpenseInlineDocument} obj Optional instance to populate.
     * @return {module:model/UpdateExpenseInlineDocument} The populated <code>UpdateExpenseInlineDocument</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateExpenseInlineDocument();
            UpdateExpenseDocument.constructFromObject(data, obj);
            UpdateExpenseDocument.constructFromObject(data, obj);
            ExpenseInlineDocumentAllOf.constructFromObject(data, obj);
 ...
 */
UpdateExpenseInlineDocument.prototype['items'] = undefined;
 ...
 * @default 1
 */
UpdateExpenseInlineDocument.prototype['discountType'] = 1;
 ...
 * @default true
 */
UpdateExpenseInlineDocument.prototype['useInlineDiscount'] = true;

/**
 * inline vat ใช้งานส่วนลดและภาษี แยกตามรายการสินค้า
 * @member {Boolean} useInlineVat
 */
UpdateExpenseInlineDocument.prototype['useInlineVat'] = undefined;
 ...
 * @default 0
 */
UpdateExpenseInlineDocument.prototype['exemptAmount'] = 0;
 ...
 * @default 0
 */
UpdateExpenseInlineDocument.prototype['vatableAmount'] = 0;
...
// Implement ExpenseInlineDocumentAllOf interface:
/**
 * รายการสินค้าใช้งานสำหรับเอกสาร Inline Expense
 * @member {Array.<module:model/ExpenseInlineProductItem>} items
 */
...
export default UpdateExpenseInlineDocument;
