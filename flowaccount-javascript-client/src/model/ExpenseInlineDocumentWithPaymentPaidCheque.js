...
/**
 * The ExpenseInlineDocumentWithPaymentPaidCheque model module.
 * @module model/ExpenseInlineDocumentWithPaymentPaidCheque
 * @version 2-oas3
 */
class ExpenseInlineDocumentWithPaymentPaidCheque {
    /**
     * Constructs a new <code>ExpenseInlineDocumentWithPaymentPaidCheque</code>.
     * @alias module:model/ExpenseInlineDocumentWithPaymentPaidCheque
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, expensePaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        ExpenseInlineDocumentWithPaymentPaidCheque.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, expensePaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>ExpenseInlineDocumentWithPaymentPaidCheque</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExpenseInlineDocumentWithPaymentPaidCheque} obj Optional instance to populate.
     * @return {module:model/ExpenseInlineDocumentWithPaymentPaidCheque} The populated <code>ExpenseInlineDocumentWithPaymentPaidCheque</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExpenseInlineDocumentWithPaymentPaidCheque();
...
export default ExpenseInlineDocumentWithPaymentPaidCheque;
