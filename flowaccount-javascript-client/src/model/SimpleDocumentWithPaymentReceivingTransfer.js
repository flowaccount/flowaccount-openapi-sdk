...
/**
 * The SimpleDocumentWithPaymentReceivingTransfer model module.
 * @module model/SimpleDocumentWithPaymentReceivingTransfer
 * @version 2-oas3
 */
class SimpleDocumentWithPaymentReceivingTransfer {
    /**
     * Constructs a new <code>SimpleDocumentWithPaymentReceivingTransfer</code>.
     * @alias module:model/SimpleDocumentWithPaymentReceivingTransfer
     ...
     * @param documentPaymentStructureType {String} สร้างเอกสารแบบ Simple พร้อมรับชำระเงิน ด้วยการโอนเงิน
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        SimpleDocumentWithPaymentReceivingTransfer.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, documentPaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>SimpleDocumentWithPaymentReceivingTransfer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SimpleDocumentWithPaymentReceivingTransfer} obj Optional instance to populate.
     * @return {module:model/SimpleDocumentWithPaymentReceivingTransfer} The populated <code>SimpleDocumentWithPaymentReceivingTransfer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SimpleDocumentWithPaymentReceivingTransfer();
...
export default SimpleDocumentWithPaymentReceivingTransfer;
