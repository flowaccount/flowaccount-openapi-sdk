...
/**
 * The ExpenseSimpleDocumentWithPaymentPaidCash model module.
 * @module model/ExpenseSimpleDocumentWithPaymentPaidCash
 * @version 2-oas3
 */
class ExpenseSimpleDocumentWithPaymentPaidCash {
    /**
     * Constructs a new <code>ExpenseSimpleDocumentWithPaymentPaidCash</code>.
     * @alias module:model/ExpenseSimpleDocumentWithPaymentPaidCash
    ...
    constructor(contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, expensePaymentStructureType, paymentMethod, paymentDate, collected) { 
        ...
        ExpenseSimpleDocumentWithPaymentPaidCash.initialize(this, contactName, publishedOn, dueDate, totalAfterDiscount, grandTotal, expensePaymentStructureType, paymentMethod, paymentDate, collected);
    }
    ...
    /**
     * Constructs a <code>ExpenseSimpleDocumentWithPaymentPaidCash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExpenseSimpleDocumentWithPaymentPaidCash} obj Optional instance to populate.
     * @return {module:model/ExpenseSimpleDocumentWithPaymentPaidCash} The populated <code>ExpenseSimpleDocumentWithPaymentPaidCash</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExpenseSimpleDocumentWithPaymentPaidCash();
...
export default ExpenseSimpleDocumentWithPaymentPaidCash;
