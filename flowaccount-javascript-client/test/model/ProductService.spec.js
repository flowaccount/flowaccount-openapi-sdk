...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ProductService();
  });
  ...
  describe('ProductService', function() {
    it('should create an instance of ProductService', function() {
      // uncomment below and update the code to test ProductService
      //var instane = new FlowAccountOpenApi.ProductService();
      //expect(instance).to.be.a(FlowAccountOpenApi.ProductService);
    });
