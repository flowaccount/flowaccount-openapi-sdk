...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.UpdateWithholidingTaxDocument();
  });
  ...
  describe('UpdateWithholidingTaxDocument', function() {
    it('should create an instance of UpdateWithholidingTaxDocument', function() {
      // uncomment below and update the code to test UpdateWithholidingTaxDocument
      //var instane = new FlowAccountOpenApi.UpdateWithholidingTaxDocument();
      //expect(instance).to.be.a(FlowAccountOpenApi.UpdateWithholidingTaxDocument);
    });
