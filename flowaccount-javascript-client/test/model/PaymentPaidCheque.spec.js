...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.PaymentPaidCheque();
  });
  ...
  describe('PaymentPaidCheque', function() {
    it('should create an instance of PaymentPaidCheque', function() {
      // uncomment below and update the code to test PaymentPaidCheque
      //var instane = new FlowAccountOpenApi.PaymentPaidCheque();
      //expect(instance).to.be.a(FlowAccountOpenApi.PaymentPaidCheque);
    });
