...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.PaymentPaidCreditCard();
  });
  ...
  describe('PaymentPaidCreditCard', function() {
    it('should create an instance of PaymentPaidCreditCard', function() {
      // uncomment below and update the code to test PaymentPaidCreditCard
      //var instane = new FlowAccountOpenApi.PaymentPaidCreditCard();
      //expect(instance).to.be.a(FlowAccountOpenApi.PaymentPaidCreditCard);
    });
