...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ExpenseInlineDocumentWithPaymentPaidCreditCard();
  });
  ...
  describe('ExpenseInlineDocumentWithPaymentPaidCreditCard', function() {
    it('should create an instance of ExpenseInlineDocumentWithPaymentPaidCreditCard', function() {
      // uncomment below and update the code to test ExpenseInlineDocumentWithPaymentPaidCreditCard
      //var instane = new FlowAccountOpenApi.ExpenseInlineDocumentWithPaymentPaidCreditCard();
      //expect(instance).to.be.a(FlowAccountOpenApi.ExpenseInlineDocumentWithPaymentPaidCreditCard);
    });
