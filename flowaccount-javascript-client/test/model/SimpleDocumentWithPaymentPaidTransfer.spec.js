...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.SimpleDocumentWithPaymentPaidTransfer();
  });
  ...
  describe('SimpleDocumentWithPaymentPaidTransfer', function() {
    it('should create an instance of SimpleDocumentWithPaymentPaidTransfer', function() {
      // uncomment below and update the code to test SimpleDocumentWithPaymentPaidTransfer
      //var instane = new FlowAccountOpenApi.SimpleDocumentWithPaymentPaidTransfer();
      //expect(instance).to.be.a(FlowAccountOpenApi.SimpleDocumentWithPaymentPaidTransfer);
    });
