...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.InlineProductItemAllOf();
  });
  ...
  describe('InlineProductItemAllOf', function() {
    it('should create an instance of InlineProductItemAllOf', function() {
      // uncomment below and update the code to test InlineProductItemAllOf
      //var instane = new FlowAccountOpenApi.InlineProductItemAllOf();
      //expect(instance).to.be.a(FlowAccountOpenApi.InlineProductItemAllOf);
    });
