...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ExpenseSimpleDocumentWithPaymentPaidCash();
  });
  ...
  describe('ExpenseSimpleDocumentWithPaymentPaidCash', function() {
    it('should create an instance of ExpenseSimpleDocumentWithPaymentPaidCash', function() {
      // uncomment below and update the code to test ExpenseSimpleDocumentWithPaymentPaidCash
      //var instane = new FlowAccountOpenApi.ExpenseSimpleDocumentWithPaymentPaidCash();
      //expect(instance).to.be.a(FlowAccountOpenApi.ExpenseSimpleDocumentWithPaymentPaidCash);
    });
