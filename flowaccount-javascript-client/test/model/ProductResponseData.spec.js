...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ProductResponseData();
  });
  ...
  describe('ProductResponseData', function() {
    it('should create an instance of ProductResponseData', function() {
      // uncomment below and update the code to test ProductResponseData
