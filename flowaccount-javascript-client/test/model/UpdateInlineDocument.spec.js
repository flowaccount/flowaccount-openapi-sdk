...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.UpdateInlineDocument();
  });
  ...
  describe('UpdateInlineDocument', function() {
    it('should create an instance of UpdateInlineDocument', function() {
      // uncomment below and update the code to test UpdateInlineDocument
      //var instane = new FlowAccountOpenApi.UpdateInlineDocument();
      //expect(instance).to.be.a(FlowAccountOpenApi.UpdateInlineDocument);
    });
