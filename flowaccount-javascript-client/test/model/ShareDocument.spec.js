...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ShareDocument();
  });
  ...
  describe('ShareDocument', function() {
    it('should create an instance of ShareDocument', function() {
      // uncomment below and update the code to test ShareDocument
      //var instane = new FlowAccountOpenApi.ShareDocument();
      //expect(instance).to.be.a(FlowAccountOpenApi.ShareDocument);
    });
