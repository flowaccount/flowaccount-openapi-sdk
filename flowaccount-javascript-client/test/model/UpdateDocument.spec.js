...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.UpdateDocument();
  });
  ...
  describe('UpdateDocument', function() {
    it('should create an instance of UpdateDocument', function() {
      // uncomment below and update the code to test UpdateDocument
      //var instane = new FlowAccountOpenApi.UpdateDocument();
      //expect(instance).to.be.a(FlowAccountOpenApi.UpdateDocument);
    });
