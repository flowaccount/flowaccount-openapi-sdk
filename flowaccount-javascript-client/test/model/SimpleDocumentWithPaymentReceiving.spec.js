...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.SimpleDocumentWithPaymentReceiving();
  });
  ...
  describe('SimpleDocumentWithPaymentReceiving', function() {
    it('should create an instance of SimpleDocumentWithPaymentReceiving', function() {
      // uncomment below and update the code to test SimpleDocumentWithPaymentReceiving
      //var instane = new FlowAccountOpenApi.SimpleDocumentWithPaymentReceiving();
      //expect(instance).to.be.a(FlowAccountOpenApi.SimpleDocumentWithPaymentReceiving);
    });
