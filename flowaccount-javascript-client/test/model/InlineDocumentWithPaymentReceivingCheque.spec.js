...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.InlineDocumentWithPaymentReceivingCheque();
  });
  ...
  describe('InlineDocumentWithPaymentReceivingCheque', function() {
    it('should create an instance of InlineDocumentWithPaymentReceivingCheque', function() {
      // uncomment below and update the code to test InlineDocumentWithPaymentReceivingCheque
      //var instane = new FlowAccountOpenApi.InlineDocumentWithPaymentReceivingCheque();
      //expect(instance).to.be.a(FlowAccountOpenApi.InlineDocumentWithPaymentReceivingCheque);
    });
