...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.InlineDocumentWithPaymentPaid();
  });
  ...
  describe('InlineDocumentWithPaymentPaid', function() {
    it('should create an instance of InlineDocumentWithPaymentPaid', function() {
      // uncomment below and update the code to test InlineDocumentWithPaymentPaid
      //var instane = new FlowAccountOpenApi.InlineDocumentWithPaymentPaid();
      //expect(instance).to.be.a(FlowAccountOpenApi.InlineDocumentWithPaymentPaid);
    });
