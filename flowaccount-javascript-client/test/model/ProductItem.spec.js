...
(function(root, factory) {
  ...
  describe('ProductItem', function() {
    ...
    it('should have the property documentStructureType (base name: "documentStructureType")', function() {
      // uncomment below and update the code to test the property documentStructureType
      //var instane = new FlowAccountOpenApi.ProductItem();
