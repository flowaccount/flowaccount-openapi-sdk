...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.PaymentPaidCash();
  });
  ...
  describe('PaymentPaidCash', function() {
    it('should create an instance of PaymentPaidCash', function() {
      // uncomment below and update the code to test PaymentPaidCash
      //var instane = new FlowAccountOpenApi.PaymentPaidCash();
      //expect(instance).to.be.a(FlowAccountOpenApi.PaymentPaidCash);
    });
