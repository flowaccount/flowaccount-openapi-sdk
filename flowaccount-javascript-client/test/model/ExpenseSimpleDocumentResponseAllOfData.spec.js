...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ExpenseSimpleDocumentResponseAllOfData();
  });
  ...
  describe('ExpenseSimpleDocumentResponseAllOfData', function() {
    it('should create an instance of ExpenseSimpleDocumentResponseAllOfData', function() {
      // uncomment below and update the code to test ExpenseSimpleDocumentResponseAllOfData
      //var instane = new FlowAccountOpenApi.ExpenseSimpleDocumentResponseAllOfData();
      //expect(instance).to.be.a(FlowAccountOpenApi.ExpenseSimpleDocumentResponseAllOfData);
    });
