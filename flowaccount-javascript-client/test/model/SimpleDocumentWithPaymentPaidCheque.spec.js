...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.SimpleDocumentWithPaymentPaidCheque();
  });
  ...
  describe('SimpleDocumentWithPaymentPaidCheque', function() {
    it('should create an instance of SimpleDocumentWithPaymentPaidCheque', function() {
      // uncomment below and update the code to test SimpleDocumentWithPaymentPaidCheque
      //var instane = new FlowAccountOpenApi.SimpleDocumentWithPaymentPaidCheque();
      //expect(instance).to.be.a(FlowAccountOpenApi.SimpleDocumentWithPaymentPaidCheque);
    });
