...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.PaymentReceivingTransfer();
  });
  ...
  describe('PaymentReceivingTransfer', function() {
    it('should create an instance of PaymentReceivingTransfer', function() {
      // uncomment below and update the code to test PaymentReceivingTransfer
      //var instane = new FlowAccountOpenApi.PaymentReceivingTransfer();
      //expect(instance).to.be.a(FlowAccountOpenApi.PaymentReceivingTransfer);
    });
