...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.SimpleDocumentWithPaymentReceivingCreditCard();
  });
  ...
  describe('SimpleDocumentWithPaymentReceivingCreditCard', function() {
    it('should create an instance of SimpleDocumentWithPaymentReceivingCreditCard', function() {
      // uncomment below and update the code to test SimpleDocumentWithPaymentReceivingCreditCard
      //var instane = new FlowAccountOpenApi.SimpleDocumentWithPaymentReceivingCreditCard();
      //expect(instance).to.be.a(FlowAccountOpenApi.SimpleDocumentWithPaymentReceivingCreditCard);
    });
