...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ExpenseSimpleDocumentWithPaymentPaidCreditCard();
  });
  ...
  describe('ExpenseSimpleDocumentWithPaymentPaidCreditCard', function() {
    it('should create an instance of ExpenseSimpleDocumentWithPaymentPaidCreditCard', function() {
      // uncomment below and update the code to test ExpenseSimpleDocumentWithPaymentPaidCreditCard
      //var instane = new FlowAccountOpenApi.ExpenseSimpleDocumentWithPaymentPaidCreditCard();
      //expect(instance).to.be.a(FlowAccountOpenApi.ExpenseSimpleDocumentWithPaymentPaidCreditCard);
    });
