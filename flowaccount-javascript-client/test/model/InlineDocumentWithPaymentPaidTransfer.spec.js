...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.InlineDocumentWithPaymentPaidTransfer();
  });
  ...
  describe('InlineDocumentWithPaymentPaidTransfer', function() {
    it('should create an instance of InlineDocumentWithPaymentPaidTransfer', function() {
      // uncomment below and update the code to test InlineDocumentWithPaymentPaidTransfer
      //var instane = new FlowAccountOpenApi.InlineDocumentWithPaymentPaidTransfer();
      //expect(instance).to.be.a(FlowAccountOpenApi.InlineDocumentWithPaymentPaidTransfer);
    });
