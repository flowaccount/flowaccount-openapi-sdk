...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.PaymentReceivingCash();
  });
  ...
  describe('PaymentReceivingCash', function() {
    it('should create an instance of PaymentReceivingCash', function() {
      // uncomment below and update the code to test PaymentReceivingCash
      //var instane = new FlowAccountOpenApi.PaymentReceivingCash();
      //expect(instance).to.be.a(FlowAccountOpenApi.PaymentReceivingCash);
    });
