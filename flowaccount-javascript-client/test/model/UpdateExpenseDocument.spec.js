...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.UpdateExpenseDocument();
  });
  ...
  describe('UpdateExpenseDocument', function() {
    it('should create an instance of UpdateExpenseDocument', function() {
      // uncomment below and update the code to test UpdateExpenseDocument
      //var instane = new FlowAccountOpenApi.UpdateExpenseDocument();
      //expect(instance).to.be.a(FlowAccountOpenApi.UpdateExpenseDocument);
    });
    ...
    it('should have the property expenseStructureType (base name: "expenseStructureType")', function() {
      // uncomment below and update the code to test the property expenseStructureType
      //var instane = new FlowAccountOpenApi.UpdateExpenseDocument();
      //expect(instance).to.be();
    });
