...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.SimpleDocumentWithPaymentReceivingTransfer();
  });
  ...
  describe('SimpleDocumentWithPaymentReceivingTransfer', function() {
    it('should create an instance of SimpleDocumentWithPaymentReceivingTransfer', function() {
      // uncomment below and update the code to test SimpleDocumentWithPaymentReceivingTransfer
      //var instane = new FlowAccountOpenApi.SimpleDocumentWithPaymentReceivingTransfer();
      //expect(instance).to.be.a(FlowAccountOpenApi.SimpleDocumentWithPaymentReceivingTransfer);
    });
