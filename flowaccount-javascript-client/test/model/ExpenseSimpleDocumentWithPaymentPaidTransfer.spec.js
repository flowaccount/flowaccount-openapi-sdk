...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ExpenseSimpleDocumentWithPaymentPaidTransfer();
  });
  ...
  describe('ExpenseSimpleDocumentWithPaymentPaidTransfer', function() {
    it('should create an instance of ExpenseSimpleDocumentWithPaymentPaidTransfer', function() {
      // uncomment below and update the code to test ExpenseSimpleDocumentWithPaymentPaidTransfer
      //var instane = new FlowAccountOpenApi.ExpenseSimpleDocumentWithPaymentPaidTransfer();
      //expect(instance).to.be.a(FlowAccountOpenApi.ExpenseSimpleDocumentWithPaymentPaidTransfer);
    });
