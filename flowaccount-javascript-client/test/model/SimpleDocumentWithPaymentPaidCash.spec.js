...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.SimpleDocumentWithPaymentPaidCash();
  });
  ...
  describe('SimpleDocumentWithPaymentPaidCash', function() {
    it('should create an instance of SimpleDocumentWithPaymentPaidCash', function() {
      // uncomment below and update the code to test SimpleDocumentWithPaymentPaidCash
      //var instane = new FlowAccountOpenApi.SimpleDocumentWithPaymentPaidCash();
      //expect(instance).to.be.a(FlowAccountOpenApi.SimpleDocumentWithPaymentPaidCash);
    });
