...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.CompanyInfoResponse();
  });
  ...
  describe('CompanyInfoResponse', function() {
    it('should create an instance of CompanyInfoResponse', function() {
      // uncomment below and update the code to test CompanyInfoResponse
