...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.InlineDocumentWithPaymentPaidCash();
  });
  ...
  describe('InlineDocumentWithPaymentPaidCash', function() {
    it('should create an instance of InlineDocumentWithPaymentPaidCash', function() {
      // uncomment below and update the code to test InlineDocumentWithPaymentPaidCash
      //var instane = new FlowAccountOpenApi.InlineDocumentWithPaymentPaidCash();
      //expect(instance).to.be.a(FlowAccountOpenApi.InlineDocumentWithPaymentPaidCash);
    });
