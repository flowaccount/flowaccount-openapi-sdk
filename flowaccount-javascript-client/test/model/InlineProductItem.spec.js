...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.InlineProductItem();
  });
  ...
  describe('InlineProductItem', function() {
    it('should create an instance of InlineProductItem', function() {
      // uncomment below and update the code to test InlineProductItem
