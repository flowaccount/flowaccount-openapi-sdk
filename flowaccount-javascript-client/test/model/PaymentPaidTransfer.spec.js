...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.PaymentPaidTransfer();
  });
  ...
  describe('PaymentPaidTransfer', function() {
    it('should create an instance of PaymentPaidTransfer', function() {
      // uncomment below and update the code to test PaymentPaidTransfer
      //var instane = new FlowAccountOpenApi.PaymentPaidTransfer();
      //expect(instance).to.be.a(FlowAccountOpenApi.PaymentPaidTransfer);
    });
