...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.AttachmentResponse();
  });
  ...
  describe('AttachmentResponse', function() {
    it('should create an instance of AttachmentResponse', function() {
      ...
      //var instane = new FlowAccountOpenApi.AttachmentResponse();
      //expect(instance).to.be.a(FlowAccountOpenApi.AttachmentResponse);
    });
