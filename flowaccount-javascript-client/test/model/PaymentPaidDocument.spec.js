...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.PaymentPaidDocument();
  });
  ...
  describe('PaymentPaidDocument', function() {
    it('should create an instance of PaymentPaidDocument', function() {
      // uncomment below and update the code to test PaymentPaidDocument
      //var instane = new FlowAccountOpenApi.PaymentPaidDocument();
      //expect(instance).to.be.a(FlowAccountOpenApi.PaymentPaidDocument);
    });
