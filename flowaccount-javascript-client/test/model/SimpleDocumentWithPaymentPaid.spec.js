...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.SimpleDocumentWithPaymentPaid();
  });
  ...
  describe('SimpleDocumentWithPaymentPaid', function() {
    it('should create an instance of SimpleDocumentWithPaymentPaid', function() {
      // uncomment below and update the code to test SimpleDocumentWithPaymentPaid
      //var instane = new FlowAccountOpenApi.SimpleDocumentWithPaymentPaid();
      //expect(instance).to.be.a(FlowAccountOpenApi.SimpleDocumentWithPaymentPaid);
    });
