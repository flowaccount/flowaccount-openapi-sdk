...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.InlineDocumentWithPaymentPaidCheque();
  });
  ...
  describe('InlineDocumentWithPaymentPaidCheque', function() {
    it('should create an instance of InlineDocumentWithPaymentPaidCheque', function() {
      // uncomment below and update the code to test InlineDocumentWithPaymentPaidCheque
      //var instane = new FlowAccountOpenApi.InlineDocumentWithPaymentPaidCheque();
      //expect(instance).to.be.a(FlowAccountOpenApi.InlineDocumentWithPaymentPaidCheque);
    });
