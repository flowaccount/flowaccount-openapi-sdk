...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.AuthenResponse();
  });
  ...
  describe('AuthenResponse', function() {
    it('should create an instance of AuthenResponse', function() {
      // uncomment below and update the code to test AuthenResponse
      //var instane = new FlowAccountOpenApi.AuthenResponse();
      //expect(instance).to.be.a(FlowAccountOpenApi.AuthenResponse);
    });
