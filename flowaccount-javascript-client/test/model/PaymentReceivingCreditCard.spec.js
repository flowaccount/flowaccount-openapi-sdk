...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.PaymentReceivingCreditCard();
  });
  ...
  describe('PaymentReceivingCreditCard', function() {
    it('should create an instance of PaymentReceivingCreditCard', function() {
      // uncomment below and update the code to test PaymentReceivingCreditCard
      //var instane = new FlowAccountOpenApi.PaymentReceivingCreditCard();
      //expect(instance).to.be.a(FlowAccountOpenApi.PaymentReceivingCreditCard);
    });
