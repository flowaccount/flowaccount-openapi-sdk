...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ExpenseDocument();
  });
  ...
  describe('ExpenseDocument', function() {
    it('should create an instance of ExpenseDocument', function() {
      ...
      //var instane = new FlowAccountOpenApi.ExpenseDocument();
      //expect(instance).to.be.a(FlowAccountOpenApi.ExpenseDocument);
    });
