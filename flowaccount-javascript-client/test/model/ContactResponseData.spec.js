...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ContactResponseData();
  });
  ...
  describe('ContactResponseData', function() {
    it('should create an instance of ContactResponseData', function() {
      // uncomment below and update the code to test ContactResponseData
      //var instane = new FlowAccountOpenApi.ContactResponseData();
      //expect(instance).to.be.a(FlowAccountOpenApi.ContactResponseData);
    });
