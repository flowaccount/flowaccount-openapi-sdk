...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.InlineDocumentWithPaymentReceivingCash();
  });
  ...
  describe('InlineDocumentWithPaymentReceivingCash', function() {
    it('should create an instance of InlineDocumentWithPaymentReceivingCash', function() {
      // uncomment below and update the code to test InlineDocumentWithPaymentReceivingCash
      //var instane = new FlowAccountOpenApi.InlineDocumentWithPaymentReceivingCash();
      //expect(instance).to.be.a(FlowAccountOpenApi.InlineDocumentWithPaymentReceivingCash);
    });
