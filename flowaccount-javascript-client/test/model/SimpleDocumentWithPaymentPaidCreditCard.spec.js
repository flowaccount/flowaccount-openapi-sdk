...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.SimpleDocumentWithPaymentPaidCreditCard();
  });
  ...
  describe('SimpleDocumentWithPaymentPaidCreditCard', function() {
    it('should create an instance of SimpleDocumentWithPaymentPaidCreditCard', function() {
      // uncomment below and update the code to test SimpleDocumentWithPaymentPaidCreditCard
      //var instane = new FlowAccountOpenApi.SimpleDocumentWithPaymentPaidCreditCard();
      //expect(instance).to.be.a(FlowAccountOpenApi.SimpleDocumentWithPaymentPaidCreditCard);
    });
