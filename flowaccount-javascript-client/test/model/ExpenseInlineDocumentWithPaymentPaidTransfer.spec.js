...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ExpenseInlineDocumentWithPaymentPaidTransfer();
  });
  ...
  describe('ExpenseInlineDocumentWithPaymentPaidTransfer', function() {
    it('should create an instance of ExpenseInlineDocumentWithPaymentPaidTransfer', function() {
      // uncomment below and update the code to test ExpenseInlineDocumentWithPaymentPaidTransfer
      //var instane = new FlowAccountOpenApi.ExpenseInlineDocumentWithPaymentPaidTransfer();
      //expect(instance).to.be.a(FlowAccountOpenApi.ExpenseInlineDocumentWithPaymentPaidTransfer);
    });
