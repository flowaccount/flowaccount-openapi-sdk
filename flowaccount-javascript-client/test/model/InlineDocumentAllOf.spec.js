...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.InlineDocumentAllOf();
  });
  ...
  describe('InlineDocumentAllOf', function() {
    it('should create an instance of InlineDocumentAllOf', function() {
      // uncomment below and update the code to test InlineDocumentAllOf
      //var instane = new FlowAccountOpenApi.InlineDocumentAllOf();
      //expect(instance).to.be.a(FlowAccountOpenApi.InlineDocumentAllOf);
    });
