...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.DeleteResponse();
  });
  ...
  describe('DeleteResponse', function() {
    it('should create an instance of DeleteResponse', function() {
      ...
      //var instane = new FlowAccountOpenApi.DeleteResponse();
      //expect(instance).to.be.a(FlowAccountOpenApi.DeleteResponse);
    });
