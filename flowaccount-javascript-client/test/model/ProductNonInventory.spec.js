...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ProductNonInventory();
  });
  ...
  describe('ProductNonInventory', function() {
    it('should create an instance of ProductNonInventory', function() {
      // uncomment below and update the code to test ProductNonInventory
      //var instane = new FlowAccountOpenApi.ProductNonInventory();
      //expect(instance).to.be.a(FlowAccountOpenApi.ProductNonInventory);
    });
