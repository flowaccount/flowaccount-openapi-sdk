...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ExpenseInlineDocumentResponseAllOfData();
  });
  ...
  describe('ExpenseInlineDocumentResponseAllOfData', function() {
    it('should create an instance of ExpenseInlineDocumentResponseAllOfData', function() {
      // uncomment below and update the code to test ExpenseInlineDocumentResponseAllOfData
      //var instane = new FlowAccountOpenApi.ExpenseInlineDocumentResponseAllOfData();
      //expect(instance).to.be.a(FlowAccountOpenApi.ExpenseInlineDocumentResponseAllOfData);
    });
