...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.InlineDocumentWithPaymentReceiving();
  });
  ...
  describe('InlineDocumentWithPaymentReceiving', function() {
    it('should create an instance of InlineDocumentWithPaymentReceiving', function() {
      // uncomment below and update the code to test InlineDocumentWithPaymentReceiving
      //var instane = new FlowAccountOpenApi.InlineDocumentWithPaymentReceiving();
      //expect(instance).to.be.a(FlowAccountOpenApi.InlineDocumentWithPaymentReceiving);
    });
