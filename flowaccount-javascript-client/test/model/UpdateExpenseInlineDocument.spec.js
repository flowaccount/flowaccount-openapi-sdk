...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.UpdateExpenseInlineDocument();
  });
  ...
  describe('UpdateExpenseInlineDocument', function() {
    it('should create an instance of UpdateExpenseInlineDocument', function() {
      // uncomment below and update the code to test UpdateExpenseInlineDocument
      //var instane = new FlowAccountOpenApi.UpdateExpenseInlineDocument();
      //expect(instance).to.be.a(FlowAccountOpenApi.UpdateExpenseInlineDocument);
    });
