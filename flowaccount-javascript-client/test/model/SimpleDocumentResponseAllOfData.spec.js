...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.SimpleDocumentResponseAllOfData();
  });
  ...
  describe('SimpleDocumentResponseAllOfData', function() {
    it('should create an instance of SimpleDocumentResponseAllOfData', function() {
      // uncomment below and update the code to test SimpleDocumentResponseAllOfData
      //var instane = new FlowAccountOpenApi.SimpleDocumentResponseAllOfData();
      //expect(instance).to.be.a(FlowAccountOpenApi.SimpleDocumentResponseAllOfData);
    });
