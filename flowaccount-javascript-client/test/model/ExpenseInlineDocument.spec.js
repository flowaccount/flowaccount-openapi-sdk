...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ExpenseInlineDocument();
  });
  ...
  describe('ExpenseInlineDocument', function() {
    it('should create an instance of ExpenseInlineDocument', function() {
      // uncomment below and update the code to test ExpenseInlineDocument
      //var instane = new FlowAccountOpenApi.ExpenseInlineDocument();
      //expect(instance).to.be.a(FlowAccountOpenApi.ExpenseInlineDocument);
    });
