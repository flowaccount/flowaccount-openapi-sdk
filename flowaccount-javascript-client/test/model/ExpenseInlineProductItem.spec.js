...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.ExpenseInlineProductItem();
  });
  ...
  describe('ExpenseInlineProductItem', function() {
    it('should create an instance of ExpenseInlineProductItem', function() {
      // uncomment below and update the code to test ExpenseInlineProductItem
      //var instane = new FlowAccountOpenApi.ExpenseInlineProductItem();
      //expect(instance).to.be.a(FlowAccountOpenApi.ExpenseInlineProductItem);
    });
