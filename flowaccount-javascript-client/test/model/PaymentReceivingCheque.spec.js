...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlowAccountOpenApi.PaymentReceivingCheque();
  });
  ...
  describe('PaymentReceivingCheque', function() {
    it('should create an instance of PaymentReceivingCheque', function() {
      // uncomment below and update the code to test PaymentReceivingCheque
      //var instane = new FlowAccountOpenApi.PaymentReceivingCheque();
      //expect(instance).to.be.a(FlowAccountOpenApi.PaymentReceivingCheque);
    });
