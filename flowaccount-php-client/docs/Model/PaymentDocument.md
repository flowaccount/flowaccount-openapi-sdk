...
**collected** | **float** | จำนวนเงินยอดรับสุทธิ | [default to 0]
...
**payment_method** | **int** | ประเภทการเก็บเงิน &lt;br&gt; 1 &#x3D; เงินสด &lt;br&gt; 3 &#x3D; เช็ค &lt;br&gt; 5 &#x3D; โอนเงิน &lt;br&gt; 7 &#x3D; บัตรเครดิต | [default to 1]
**transfer_bank_account_id** | **int** | ธนาคารที่ใช้รับชำระเงิน ธนาคารที่ชำระเงิน | [optional] [default to 0]
**bank_account_id** | **int** | บัญชีธนาคารที่ใช้รับชำระเงิน &lt;br&gt; &lt;ex&gt;Example: 1012013014&lt;/ex&gt; | [optional] [default to 0]
...
**payment_remarks** | **string** | หมายเหตุ การรับชำระเงิน หรือ จ่ายเงิน | [optional] 
