...
class TaxInvoiceApi
{
     ...
     * @return \OpenAPI\Client\Model\InlineDocumentResponse
     */
    public function taxInvoicesInlineWithPaymentPost($authorization, $unknown_base_type)
    {
        list($response) = $this->taxInvoicesInlineWithPaymentPostWithHttpInfo($authorization, $unknown_base_type);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\InlineDocumentResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function taxInvoicesInlineWithPaymentPostWithHttpInfo($authorization, $unknown_base_type)
    {
        $request = $this->taxInvoicesInlineWithPaymentPostRequest($authorization, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function taxInvoicesInlineWithPaymentPostAsync($authorization, $unknown_base_type)
    {
        return $this->taxInvoicesInlineWithPaymentPostAsyncWithHttpInfo($authorization, $unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function taxInvoicesInlineWithPaymentPostAsyncWithHttpInfo($authorization, $unknown_base_type)
    {
        $returnType = '\OpenAPI\Client\Model\InlineDocumentResponse';
        $request = $this->taxInvoicesInlineWithPaymentPostRequest($authorization, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function taxInvoicesInlineWithPaymentPostRequest($authorization, $unknown_base_type)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($unknown_base_type === null || (is_array($unknown_base_type) && count($unknown_base_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unknown_base_type when calling taxInvoicesInlineWithPaymentPost'
            );
        }
     ...
     * @return \OpenAPI\Client\Model\SimpleDocumentResponse
     */
    public function taxInvoicesWithPaymentPost($authorization, $unknown_base_type)
    {
        list($response) = $this->taxInvoicesWithPaymentPostWithHttpInfo($authorization, $unknown_base_type);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\SimpleDocumentResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function taxInvoicesWithPaymentPostWithHttpInfo($authorization, $unknown_base_type)
    {
        $request = $this->taxInvoicesWithPaymentPostRequest($authorization, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function taxInvoicesWithPaymentPostAsync($authorization, $unknown_base_type)
    {
        return $this->taxInvoicesWithPaymentPostAsyncWithHttpInfo($authorization, $unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function taxInvoicesWithPaymentPostAsyncWithHttpInfo($authorization, $unknown_base_type)
    {
        $returnType = '\OpenAPI\Client\Model\SimpleDocumentResponse';
        $request = $this->taxInvoicesWithPaymentPostRequest($authorization, $unknown_base_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function taxInvoicesWithPaymentPostRequest($authorization, $unknown_base_type)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($unknown_base_type === null || (is_array($unknown_base_type) && count($unknown_base_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unknown_base_type when calling taxInvoicesWithPaymentPost'
            );
        }
