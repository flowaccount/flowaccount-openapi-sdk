...
class CashInvoiceApi
{
     ...
     * @return \OpenAPI\Client\Model\InlineDocumentResponse
     */
    public function cashInvoicesIdPut($authorization, $id, $inline_document)
    {
        list($response) = $this->cashInvoicesIdPutWithHttpInfo($authorization, $id, $inline_document);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\InlineDocumentResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function cashInvoicesIdPutWithHttpInfo($authorization, $id, $inline_document)
    {
        $request = $this->cashInvoicesIdPutRequest($authorization, $id, $inline_document);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cashInvoicesIdPutAsync($authorization, $id, $inline_document)
    {
        return $this->cashInvoicesIdPutAsyncWithHttpInfo($authorization, $id, $inline_document)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cashInvoicesIdPutAsyncWithHttpInfo($authorization, $id, $inline_document)
    {
        $returnType = '\OpenAPI\Client\Model\InlineDocumentResponse';
        $request = $this->cashInvoicesIdPutRequest($authorization, $id, $inline_document);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function cashInvoicesIdPutRequest($authorization, $id, $inline_document)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($inline_document === null || (is_array($inline_document) && count($inline_document) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inline_document when calling cashInvoicesIdPut'
            );
        }
