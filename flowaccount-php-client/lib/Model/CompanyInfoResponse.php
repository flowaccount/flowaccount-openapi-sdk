 ...
 * @link     https://openapi-generator.tech
 */
class CompanyInfoResponse implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['compnay_name'] === null) {
            $invalidProperties[] = "'compnay_name' can't be null";
        }
     ...
     * Sets compnay_name
     *
     * @param string $compnay_name ชื่อบริษัท
     *
     * @return $this
     */
