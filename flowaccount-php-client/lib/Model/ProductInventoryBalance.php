...
/**
 * ProductInventoryBalance Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ProductInventoryBalance implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductInventoryBalance';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['inventory_quantity'] = isset($data['inventory_quantity']) ? $data['inventory_quantity'] : 0;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inventory_published_on'] === null) {
            $invalidProperties[] = "'inventory_published_on' can't be null";
        }
        if ($this->container['inventory_quantity'] === null) {
            $invalidProperties[] = "'inventory_quantity' can't be null";
        }
        if ($this->container['inventory_price'] === null) {
            $invalidProperties[] = "'inventory_price' can't be null";
        }
     ...
     *
     * @param string|null $product_structure_type สร้างสินค้าประเภท นับสต๊อก พร้อมตั้งค่ายอดเริ่มต้น
     *
     * @return $this
     */
     ...
     *
     * @param string $inventory_published_on วันที่ตั้งต้นสินค้า รูปแบบ yyyy-MM-dd <br> <ex>Example: 2020-01-01</ex>
     *
     * @return $this
     */
     ...
     *
     * @param float $inventory_quantity จำนวนยอดตั้งต้นสินค้า
     *
     * @return $this
     */
