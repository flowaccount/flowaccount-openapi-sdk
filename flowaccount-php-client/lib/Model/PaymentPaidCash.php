...
/**
 * PaymentPaidCash Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PaymentPaidCash implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentPaidCash';
     ...
     *
     * @param string $payment_structure_type ชำระเงิน ด้วยเงินสด
     *
     * @return $this
     */
