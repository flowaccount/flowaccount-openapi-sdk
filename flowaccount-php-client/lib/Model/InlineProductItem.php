 ...
 * @link     https://openapi-generator.tech
 */
class InlineProductItem implements ModelInterface, ArrayAccess
{
    ...
    public function setUnitName($unit_name)
    {
        if (!is_null($unit_name) && (mb_strlen($unit_name) > 7)) {
            throw new \InvalidArgumentException('invalid length for $unit_name when calling InlineProductItem., must be smaller than or equal to 7.');
        }
