...
/**
 * PaymentPaidTransfer Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PaymentPaidTransfer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentPaidTransfer';
     ...
     *
     * @param string $payment_structure_type ชำระเงิน ด้วยการโอนเงิน
     *
     * @return $this
     */
