...
public class UpdateExpenseSimpleDocument extends UpdateExpenseDocument {
  ...
  public UpdateExpenseSimpleDocument items(List<ExpenseSimpleProductItem> items) {
    
    this.items = items;
    return this;
  }

  public UpdateExpenseSimpleDocument addItemsItem(ExpenseSimpleProductItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, updateExpenseSimpleDocument.items) &&
        super.equals(o);
  }
