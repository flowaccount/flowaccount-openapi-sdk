...
public class ExpenseSimpleDocumentAllOf {
  ...
  public ExpenseSimpleDocumentAllOf items(List<ExpenseSimpleProductItem> items) {
    
    this.items = items;
    return this;
  }

  public ExpenseSimpleDocumentAllOf addItemsItem(ExpenseSimpleProductItem itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, expenseSimpleDocumentAllOf.items);
  }
