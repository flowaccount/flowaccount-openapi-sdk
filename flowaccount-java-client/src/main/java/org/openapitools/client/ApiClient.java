...
public class ApiClient {
    ...
    private String basePath = "https://openapi.flowaccount.com/v1";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2-oas3/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://openapi.flowaccount.com/v1
