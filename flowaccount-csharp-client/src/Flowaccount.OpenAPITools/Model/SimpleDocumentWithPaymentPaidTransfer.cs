...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class SimpleDocumentWithPaymentPaidTransfer :  IEquatable<SimpleDocumentWithPaymentPaidTransfer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleDocumentWithPaymentPaidTransfer" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SimpleDocumentWithPaymentPaidTransfer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleDocumentWithPaymentPaidTransfer" /> class.
        /// </summary>
        ...
        /// <param name="documentPaymentStructureType">สร้างเอกสารแบบ Simple พร้อมชำระเงิน ด้วยการโอนเงิน (required).</param>
        ...
        public SimpleDocumentWithPaymentPaidTransfer(string contactCode = default(string), string contactName = default(string), string contactAddress = default(string), string contactTaxId = default(string), string contactBranch = default(string), string contactPerson = default(string), string contactEmail = default(string), string contactNumber = default(string), string contactZipCode = default(string), int contactGroup = 1, DateTime publishedOn = default(DateTime), int creditType = 1, int creditDays = 0, DateTime dueDate = default(DateTime), string salesName = "อีเมล หรือ ชื่อผู้สร้างเอกสาร", string projectName = default(string), string reference = default(string), bool isVatInclusive = false, bool useReceiptDeduction = false, decimal subTotal = 0M, int discountPercentage = 0, decimal discountAmount = 0M, decimal totalAfterDiscount = default(decimal), bool isVat = false, decimal vatAmount = default(decimal), decimal grandTotal = default(decimal), bool documentShowWithholdingTax = false, int documentWithholdingTaxPercentage = 0, decimal documentWithholdingTaxAmount = 0M, int documentDeductionType = 0, decimal documentDeductionAmount = 0M, string remarks = default(string), string internalNotes = default(string), bool showSignatureOrStamp = true, List<SimpleProductItem> items = default(List<SimpleProductItem>), List<UpgradeDocument> documentReference = default(List<UpgradeDocument>), string documentPaymentStructureType = default(string), long paymentMethod = 1, DateTime paymentDate = default(DateTime), decimal collected = 0M, long withheldPercentage = 0, decimal withheldAmount = 0M, long transferBankAccountId = 0, long bankAccountId = 0, decimal paymentCharge = 0M, string paymentRemarks = default(string), long remainingCollectedType = 0, decimal remainingCollected = 0M)
        {
            // to ensure "contactName" is required (not null)
            if (contactName == null)
            {
                throw new InvalidDataException("contactName is a required property for SimpleDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            if (publishedOn == null)
            {
                throw new InvalidDataException("publishedOn is a required property for SimpleDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            if (dueDate == null)
            {
                throw new InvalidDataException("dueDate is a required property for SimpleDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("totalAfterDiscount is a required property for SimpleDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            if (grandTotal == null)
            {
                throw new InvalidDataException("grandTotal is a required property for SimpleDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("documentPaymentStructureType is a required property for SimpleDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for SimpleDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            if (paymentDate == null)
            {
                throw new InvalidDataException("paymentDate is a required property for SimpleDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            if (collected == null)
            {
                throw new InvalidDataException("collected is a required property for SimpleDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SimpleDocumentWithPaymentPaidTransfer);
        }

        /// <summary>
        /// Returns true if SimpleDocumentWithPaymentPaidTransfer instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleDocumentWithPaymentPaidTransfer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleDocumentWithPaymentPaidTransfer input)
        {
            if (input == null)
                return false;
