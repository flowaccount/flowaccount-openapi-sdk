...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpenseInlineDocumentResponseAllOfData :  IEquatable<ExpenseInlineDocumentResponseAllOfData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpenseInlineDocumentResponseAllOfData" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ExpenseInlineDocumentResponseAllOfData);
        }

        /// <summary>
        /// Returns true if ExpenseInlineDocumentResponseAllOfData instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpenseInlineDocumentResponseAllOfData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpenseInlineDocumentResponseAllOfData input)
        {
            if (input == null)
                return false;
