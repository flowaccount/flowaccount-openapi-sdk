...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class ProductResponseData :  IEquatable<ProductResponseData>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="total">จำนวนสินค้าทั้งหมด.</param>
        /// <param name="currentPage">หน้าที่แสดงรายการสินค้า.</param>
        /// <param name="list">ข้อมูลรายการสินค้า.</param>
        /// <param name="isDB">database.</param>
        public ProductResponseData(int total = default(int), int currentPage = default(int), List<Product> list = default(List<Product>), bool isDB = default(bool))
        {
            this.Total = total;
        ...
        /// จำนวนสินค้าทั้งหมด
        /// </summary>
        /// <value>จำนวนสินค้าทั้งหมด</value>
        ...
        /// </summary>
        /// <value>หน้าที่แสดงรายการสินค้า</value>
