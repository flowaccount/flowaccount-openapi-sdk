...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class ProductService :  IEquatable<ProductService>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="ProductService" /> class.
        /// </summary>
        /// <param name="productStructureType">สร้างสินค้าประเภท บริการ.</param>
        ...
        public ProductService(string productStructureType = default(string), long type = 1, string code = default(string), string name = default(string), string sellDescription = default(string), decimal sellPrice = default(decimal), long sellVatType = 3, string unitName = default(string), string categoryName = default(string), string barcode = default(string))
        {
            this.ProductStructureType = productStructureType;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ProductService and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ProductService and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        /// </summary>
        /// <value>สร้างสินค้าประเภท บริการ</value>
        ...
        {
            return this.Equals(input as ProductService);
        }

        /// <summary>
        /// Returns true if ProductService instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductService input)
        {
            if (input == null)
                return false;
