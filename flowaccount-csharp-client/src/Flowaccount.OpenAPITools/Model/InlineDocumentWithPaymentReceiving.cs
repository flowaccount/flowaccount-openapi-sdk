...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class InlineDocumentWithPaymentReceiving :  IEquatable<InlineDocumentWithPaymentReceiving>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineDocumentWithPaymentReceiving" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineDocumentWithPaymentReceiving() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineDocumentWithPaymentReceiving" /> class.
        /// </summary>
        ...
        /// <param name="documentPaymentStructureType">สร้างเอกสารแบบ Inline พร้อมรับชำระเงิน ด้วยบัตรเครดิต (required).</param>
        ...
        /// <param name="bankAccountId">เลข id บัญชีธนาคารที่ใช้รับชำระเงิน &lt;br&gt;&lt;red&gt;สามารถ GET มาได้จาก My Company &gt; Bank Account &lt;/red&gt;&lt;br&gt; &lt;ex&gt;Example: 12345&lt;/ex&gt; (default to 0).</param>
        ...
        public InlineDocumentWithPaymentReceiving(string contactCode = default(string), string contactName = default(string), string contactAddress = default(string), string contactTaxId = default(string), string contactBranch = default(string), string contactPerson = default(string), string contactEmail = default(string), string contactNumber = default(string), string contactZipCode = default(string), int contactGroup = 1, DateTime publishedOn = default(DateTime), int creditType = 1, int creditDays = 0, DateTime dueDate = default(DateTime), string salesName = "อีเมล หรือ ชื่อผู้สร้างเอกสาร", string projectName = default(string), string reference = default(string), bool isVatInclusive = false, bool useReceiptDeduction = false, List<SimpleProductItem> items = default(List<SimpleProductItem>), decimal subTotal = 0M, int discountPercentage = 0, decimal discountAmount = 0M, decimal totalAfterDiscount = default(decimal), bool isVat = false, decimal vatAmount = default(decimal), decimal grandTotal = default(decimal), int discountType = 1, bool useInlineDiscount = true, bool useInlineVat = default(bool), decimal? exemptAmount = 0M, decimal? vatableAmount = 0M, bool documentShowWithholdingTax = false, int documentWithholdingTaxPercentage = 0, decimal documentWithholdingTaxAmount = 0M, int documentDeductionType = 0, decimal documentDeductionAmount = 0M, string remarks = default(string), string internalNotes = default(string), bool showSignatureOrStamp = true, List<UpgradeDocument> documentReference = default(List<UpgradeDocument>), string documentPaymentStructureType = default(string), long paymentMethod = 1, DateTime paymentDate = default(DateTime), decimal collected = 0M, long paymentDeductionType = 0, decimal paymentDeductionAmount = 0M, long withheldPercentage = 0, decimal withheldAmount = 0M, long transferBankAccountId = 0, long bankAccountId = 0, string paymentRemarks = default(string), long remainingCollectedType = 0, decimal remainingCollected = 0M, DateTime chequeDate = default(DateTime), string chequeNumber = default(string), long chequeBankAccountId = 0, long creditCardBankAccountId = 0)
        {
            // to ensure "contactName" is required (not null)
            if (contactName == null)
            {
                throw new InvalidDataException("contactName is a required property for InlineDocumentWithPaymentReceiving and cannot be null");
            }
            else
            {
            ...
            if (publishedOn == null)
            {
                throw new InvalidDataException("publishedOn is a required property for InlineDocumentWithPaymentReceiving and cannot be null");
            }
            else
            {
            ...
            if (dueDate == null)
            {
                throw new InvalidDataException("dueDate is a required property for InlineDocumentWithPaymentReceiving and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("totalAfterDiscount is a required property for InlineDocumentWithPaymentReceiving and cannot be null");
            }
            else
            {
            ...
            if (grandTotal == null)
            {
                throw new InvalidDataException("grandTotal is a required property for InlineDocumentWithPaymentReceiving and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("documentPaymentStructureType is a required property for InlineDocumentWithPaymentReceiving and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for InlineDocumentWithPaymentReceiving and cannot be null");
            }
            else
            {
            ...
            if (paymentDate == null)
            {
                throw new InvalidDataException("paymentDate is a required property for InlineDocumentWithPaymentReceiving and cannot be null");
            }
            else
            {
            ...
            if (collected == null)
            {
                throw new InvalidDataException("collected is a required property for InlineDocumentWithPaymentReceiving and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>สร้างเอกสารแบบ Inline พร้อมรับชำระเงิน ด้วยบัตรเครดิต</value>
        ...
        /// </summary>
        /// <value>ประเภทการเก็บเงิน &lt;br&gt; 7 &#x3D; บัตรเครดิต</value>
        ...
        /// </summary>
        /// <value>เลข id บัญชีธนาคารที่ใช้รับชำระเงิน &lt;br&gt;&lt;red&gt;สามารถ GET มาได้จาก My Company &gt; Bank Account &lt;/red&gt;&lt;br&gt; &lt;ex&gt;Example: 12345&lt;/ex&gt;</value>
        ...
        /// </summary>
        /// <value>ธนาคารที่รับชำระด้วยบัตรเครดิต &lt;br&gt; 1 &#x3D; ธนาคารกรุงเทพ &lt;br&gt; 2 &#x3D; ธนาคารกสิกรไทย &lt;br&gt; 3 &#x3D; ธนาคารกรุงไทย &lt;br&gt; 4 &#x3D; ธนาคารทหารไทย &lt;br&gt; 5 &#x3D; ธนาคารไทยพาณิชย์ &lt;br&gt; 6 &#x3D; ธนาคารสแตนดาร์ดชาร์เตอร์ด &lt;br&gt; 7 &#x3D; ธนาคารซีไอเอ็มบี ไทย &lt;br&gt; 8 &#x3D; ธนาคารยูโอบี &lt;br&gt; 10 &#x3D; ธนาคารกรุงศรีอยุธยา &lt;br&gt; 11 &#x3D; ธนาคารออมสิน &lt;br&gt; 12 &#x3D; ธนาคารธนชาต &lt;br&gt; 13 &#x3D; ธนาคารแลนด์ แอนด์ เฮ้าส์ &lt;br&gt; 14 &#x3D; ธนาคารเกียรตินาคิน &lt;br&gt; 15 &#x3D; ธนาคารซิตี้แบงก์ &lt;br&gt; 16 &#x3D; ธนาคารทิสโก้ &lt;br&gt; 53 &#x3D; ธนาคารเพื่อการเกษตรและสหกรณ์การเกษตร &lt;br&gt; 54 &#x3D; ธนาคารเพื่อการส่งออกและนำเข้าแห่งประเทศไทย &lt;br&gt; 55 &#x3D; ธนาคารอาคารสงเคราะห์ &lt;br&gt; 56 &#x3D; ธนาคารพัฒนาวิสาหกิจขนาดกลางและขนาดย่อมแห่งประเทศไทย &lt;br&gt; 57 &#x3D; ธนาคารอิสลามแห่งประเทศไทย &lt;br&gt; 58 &#x3D; ธนาคารแห่งประเทศจีน (ไทย) &lt;br&gt; 59 &#x3D; ธนาคารไอซีบีซี (ไทย) &lt;br&gt; 60 &#x3D; ธนาคารเมกะ สากลพาณิชย์ &lt;br&gt; 61 &#x3D; ธนาคารซูมิโตโม มิตซุย แบงกิ้ง คอร์ปอเรชั่น &lt;br&gt; 62 &#x3D; ธนาคารมิซูโฮ จำกัด (กรุงเทพฯ) &lt;br&gt; 63 &#x3D; ธนาคารฮ่องกงและเซี่ยงไฮ้แบงกิ้งคอร์ปอเรชั่น &lt;br&gt; 64 &#x3D; ธนาคารไทยเครดิต เพื่อรายย่อย </value>
        ...
        {
            return this.Equals(input as InlineDocumentWithPaymentReceiving);
        }

        /// <summary>
        /// Returns true if InlineDocumentWithPaymentReceiving instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineDocumentWithPaymentReceiving to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineDocumentWithPaymentReceiving input)
        {
            if (input == null)
                return false;
