...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class UpdateExpenseSimpleDocument : UpdateExpenseDocument,  IEquatable<UpdateExpenseSimpleDocument>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as UpdateExpenseSimpleDocument);
        }

        /// <summary>
        /// Returns true if UpdateExpenseSimpleDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateExpenseSimpleDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateExpenseSimpleDocument input)
        {
            if (input == null)
                return false;
