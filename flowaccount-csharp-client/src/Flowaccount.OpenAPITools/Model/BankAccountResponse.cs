...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class BankAccountResponse :  IEquatable<BankAccountResponse>, IValidatableObject
    {
        ...
        public BankAccountResponse(bool status = default(bool), string message = default(string), int code = default(int), BankAccountResponseData data = default(BankAccountResponseData))
        {
            this.Status = status;
        ...
        public BankAccountResponseData Data { get; set; }
