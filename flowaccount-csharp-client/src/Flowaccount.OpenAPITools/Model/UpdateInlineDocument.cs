...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateInlineDocument : UpdateDocument,  IEquatable<UpdateInlineDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateInlineDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateInlineDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateInlineDocument" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateInlineDocument);
        }

        /// <summary>
        /// Returns true if UpdateInlineDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateInlineDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateInlineDocument input)
        {
            if (input == null)
                return false;
