...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompanyInfoResponseData" /> class.
        /// </summary>
        ...
        /// <param name="compnayName">ชื่อบริษัท.</param>
        ...
        {
            return this.Equals(input as CompanyInfoResponseData);
        }

        /// <summary>
        /// Returns true if CompanyInfoResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyInfoResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyInfoResponseData input)
        {
            if (input == null)
                return false;
