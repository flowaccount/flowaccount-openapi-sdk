...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    [JsonConverter(typeof(JsonSubtypes), "ExpensePaymentStructureType")]
    public partial class ExpenseInlineDocumentWithPaymentPaidTransfer :  IEquatable<ExpenseInlineDocumentWithPaymentPaidTransfer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpenseInlineDocumentWithPaymentPaidTransfer" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExpenseInlineDocumentWithPaymentPaidTransfer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpenseInlineDocumentWithPaymentPaidTransfer" /> class.
        /// </summary>
        ...
        /// <param name="expensePaymentStructureType">สร้างเอกสารแบบ Simple พร้อมชำระเงิน ด้วยการโอนเงิน (required).</param>
        /// <param name="paymentMethod">ประเภทการชำระเงิน &lt;br&gt; 5 &#x3D; โอนเงิน  (required) (default to 1).</param>
        ...
        /// <param name="paymentCharge">ค่าธรรมเนียม ที่ชำระโดยการโอนเงิน &lt;ex&gt; Example : 100.00 &lt;/ex&gt; (default to 0M).</param>
        ...
        public ExpenseInlineDocumentWithPaymentPaidTransfer(string contactCode = default(string), string contactName = default(string), string contactAddress = default(string), string contactTaxId = default(string), string contactBranch = default(string), string contactPerson = default(string), string contactEmail = default(string), string contactNumber = default(string), string contactZipCode = default(string), int contactGroup = 1, DateTime publishedOn = default(DateTime), int creditType = 1, int creditDays = 0, DateTime dueDate = default(DateTime), string salesName = "อีเมล หรือ ชื่อผู้สร้างเอกสาร", string projectName = default(string), string reference = default(string), bool isVatInclusive = false, List<ExpenseInlineProductItem> items = default(List<ExpenseInlineProductItem>), decimal subTotal = 0M, int discountPercentage = 0, decimal discountAmount = 0M, decimal totalAfterDiscount = default(decimal), bool isVat = false, decimal vatAmount = default(decimal), decimal grandTotal = default(decimal), int discountType = 1, bool useInlineDiscount = true, bool useInlineVat = default(bool), decimal? exemptAmount = 0M, string remarks = default(string), string internalNotes = default(string), bool showSignatureOrStamp = true, string expensePaymentStructureType = default(string), long paymentMethod = 1, DateTime paymentDate = default(DateTime), decimal collected = 0M, long withheldPercentage = 0, decimal withheldAmount = 0M, long transferBankAccountId = 0, long bankAccountId = 0, decimal paymentCharge = 0M, string paymentRemarks = default(string), long remainingCollectedType = 0, decimal remainingCollected = 0M)
        {
            // to ensure "contactName" is required (not null)
            if (contactName == null)
            {
                throw new InvalidDataException("contactName is a required property for ExpenseInlineDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            if (publishedOn == null)
            {
                throw new InvalidDataException("publishedOn is a required property for ExpenseInlineDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            if (dueDate == null)
            {
                throw new InvalidDataException("dueDate is a required property for ExpenseInlineDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("totalAfterDiscount is a required property for ExpenseInlineDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            if (grandTotal == null)
            {
                throw new InvalidDataException("grandTotal is a required property for ExpenseInlineDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            // to ensure "expensePaymentStructureType" is required (not null)
            if (expensePaymentStructureType == null)
            {
                throw new InvalidDataException("expensePaymentStructureType is a required property for ExpenseInlineDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for ExpenseInlineDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            if (paymentDate == null)
            {
                throw new InvalidDataException("paymentDate is a required property for ExpenseInlineDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
            ...
            if (collected == null)
            {
                throw new InvalidDataException("collected is a required property for ExpenseInlineDocumentWithPaymentPaidTransfer and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>สร้างเอกสารแบบ Simple พร้อมชำระเงิน ด้วยการโอนเงิน</value>
        [DataMember(Name="expensePaymentStructureType", EmitDefaultValue=true)]
        public string ExpensePaymentStructureType { get; set; }

        /// <summary>
        /// ประเภทการชำระเงิน &lt;br&gt; 5 &#x3D; โอนเงิน 
        /// </summary>
        /// <value>ประเภทการชำระเงิน &lt;br&gt; 5 &#x3D; โอนเงิน </value>
        ...
        /// </summary>
        /// <value>ค่าธรรมเนียม ที่ชำระโดยการโอนเงิน &lt;ex&gt; Example : 100.00 &lt;/ex&gt;</value>
        ...
        {
            return this.Equals(input as ExpenseInlineDocumentWithPaymentPaidTransfer);
        }

        /// <summary>
        /// Returns true if ExpenseInlineDocumentWithPaymentPaidTransfer instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpenseInlineDocumentWithPaymentPaidTransfer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpenseInlineDocumentWithPaymentPaidTransfer input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ExpensePaymentStructureType == input.ExpensePaymentStructureType ||
                    (this.ExpensePaymentStructureType != null &&
                    this.ExpensePaymentStructureType.Equals(input.ExpensePaymentStructureType))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExpensePaymentStructureType != null)
                    hashCode = hashCode * 59 + this.ExpensePaymentStructureType.GetHashCode();
