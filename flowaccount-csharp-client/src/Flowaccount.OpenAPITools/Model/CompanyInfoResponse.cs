...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyInfoResponse :  IEquatable<CompanyInfoResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CompanyInfoResponse(long companyId = 0, string companyType = "10", string compnayName = default(string), string companyNameEn = default(string), string companyAddress = default(string), string companyAddressEn = default(string), string companyZipCode = default(string), string companyTaxId = default(string), string companyBranch = "สำนักงานใหญ่", string companyBranchEn = default(string), string companyBranchCode = default(string), string companyPhone = default(string), string companyMobile = default(string), string companyFax = default(string), string companyWebsite = default(string))
        {
            // to ensure "compnayName" is required (not null)
            if (compnayName == null)
            {
                throw new InvalidDataException("compnayName is a required property for CompanyInfoResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CompanyInfoResponse);
        }

        /// <summary>
        /// Returns true if CompanyInfoResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CompanyInfoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyInfoResponse input)
        {
            if (input == null)
                return false;
