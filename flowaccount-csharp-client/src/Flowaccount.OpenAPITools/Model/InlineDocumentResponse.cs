...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class InlineDocumentResponse : DocumentResponse,  IEquatable<InlineDocumentResponse>, IValidatableObject
    {
        ...
        public InlineDocumentResponse(InlineDocumentResponseAllOfData data = default(InlineDocumentResponseAllOfData), bool status = default(bool), string message = default(string), int code = default(int), string documentStructureType = default(string)) : base(status, message, code, documentStructureType)
        {
            this.Data = data;
        }
