...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class ProductNonInventory :  IEquatable<ProductNonInventory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductNonInventory" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProductNonInventory() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductNonInventory" /> class.
        /// </summary>
        /// <param name="productStructureType">สร้างสินค้าประเภท ไม่นับสต๊อก.</param>
        ...
        public ProductNonInventory(string productStructureType = default(string), long type = 1, string code = default(string), string name = default(string), string sellDescription = default(string), decimal sellPrice = default(decimal), long sellVatType = 3, string unitName = default(string), string categoryName = default(string), string barcode = default(string), string buyDescription = default(string), decimal buyPrice = default(decimal), long buyVatType = 3)
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ProductNonInventory and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        /// </summary>
        /// <value>สร้างสินค้าประเภท ไม่นับสต๊อก</value>
        ...
        {
            return this.Equals(input as ProductNonInventory);
        }

        /// <summary>
        /// Returns true if ProductNonInventory instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductNonInventory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductNonInventory input)
        {
            if (input == null)
                return false;
