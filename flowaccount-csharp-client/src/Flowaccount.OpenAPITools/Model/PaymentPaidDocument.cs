...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class PaymentPaidDocument :  IEquatable<PaymentPaidDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentPaidDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentPaidDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentPaidDocument" /> class.
        /// </summary>
        ...
        public PaymentPaidDocument(string paymentStructureType = default(string), long documentId = default(long), long paymentMethod = 1, DateTime paymentDate = default(DateTime), decimal collected = 0M, long withheldPercentage = 0, decimal withheldAmount = 0M, long transferBankAccountId = 0, long bankAccountId = 0, decimal paymentCharge = 0M, string paymentRemarks = default(string), long remainingCollectedType = 0, decimal remainingCollected = 0M, DateTime chequeDate = default(DateTime), string chequeNumber = default(string), long chequeBankAccountId = 0, long creditCardBankAccountId = 0)
        {
            // to ensure "paymentStructureType" is required (not null)
            if (paymentStructureType == null)
            {
                throw new InvalidDataException("paymentStructureType is a required property for PaymentPaidDocument and cannot be null");
            }
            else
            {
            ...
            if (documentId == null)
            {
                throw new InvalidDataException("documentId is a required property for PaymentPaidDocument and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for PaymentPaidDocument and cannot be null");
            }
            else
            {
            ...
            if (paymentDate == null)
            {
                throw new InvalidDataException("paymentDate is a required property for PaymentPaidDocument and cannot be null");
            }
            else
            {
            ...
            if (collected == null)
            {
                throw new InvalidDataException("collected is a required property for PaymentPaidDocument and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PaymentPaidDocument);
        }

        /// <summary>
        /// Returns true if PaymentPaidDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentPaidDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentPaidDocument input)
        {
            if (input == null)
                return false;
