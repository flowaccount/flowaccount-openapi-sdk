...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateExpenseInlineDocument : UpdateExpenseDocument,  IEquatable<UpdateExpenseInlineDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateExpenseInlineDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateExpenseInlineDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateExpenseInlineDocument" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateExpenseInlineDocument);
        }

        /// <summary>
        /// Returns true if UpdateExpenseInlineDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateExpenseInlineDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateExpenseInlineDocument input)
        {
            if (input == null)
                return false;
