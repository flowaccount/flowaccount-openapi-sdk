...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SimpleDocumentResponseAllOfData :  IEquatable<SimpleDocumentResponseAllOfData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleDocumentResponseAllOfData" /> class.
        /// </summary>
        ...
        /// <param name="contactName">ชื่อ ลูกค้า/ผู้จำหน่าย &lt;br&gt; &lt;ex&gt;Example: บริษัท ลูกค้า จำกัด, คุณลูกค้า ซื้อประจำ&lt;/ex&gt;.</param>
        ...
        /// <param name="totalWithoutVat">มูลค่าไม่รวมภาษีมูลค่าเพิ่ม.</param>
        ...
        /// <param name="items">รายการสินค้าใช้งานสำหรับเอกสาร Simple Document.</param>
        ...
        public SimpleDocumentResponseAllOfData(long recordId = 0, long documentId = 0, string documentSerial = default(string), string contactCode = default(string), string contactName = default(string), string contactAddress = default(string), string contactTaxId = default(string), string contactBranch = default(string), string contactPerson = default(string), string contactEmail = default(string), string contactNumber = default(string), string contactZipCode = default(string), int contactGroup = 1, DateTime publishedOn = default(DateTime), int creditType = 1, int creditDays = 0, DateTime dueDate = default(DateTime), string salesName = "อีเมล หรือ ชื่อผู้สร้างเอกสาร", string projectName = default(string), string reference = default(string), bool isVatInclusive = false, bool useReceiptDeduction = false, decimal subTotal = 0M, int discountPercentage = 0, decimal discountAmount = 0M, decimal totalAfterDiscount = default(decimal), decimal totalWithoutVat = default(decimal), bool isVat = false, decimal vatAmount = default(decimal), decimal grandTotal = default(decimal), bool documentShowWithholdingTax = false, int documentWithholdingTaxPercentage = 0, int documentDeductionType = 0, decimal documentDeductionAmount = 0M, string remarks = default(string), string internalNotes = default(string), bool showSignatureOrStamp = true, List<SimpleProductItem> items = default(List<SimpleProductItem>), List<ReferencedToMe> referencedToMe = default(List<ReferencedToMe>), List<ReferencedByMe> referencedByMe = default(List<ReferencedByMe>), SimpleDocumentResponseAllOfDataPayments payments = default(SimpleDocumentResponseAllOfDataPayments), SimpleDocumentResponseAllOfDataCompany company = default(SimpleDocumentResponseAllOfDataCompany), int status = default(int), int statusString = default(int), int documentType = default(int), bool allowDelete = default(bool))
        {
        ...
        /// </summary>
        /// <value>มูลค่าไม่รวมภาษีมูลค่าเพิ่ม</value>
        ...
        /// </summary>
        /// <value>รายการสินค้าใช้งานสำหรับเอกสาร Simple Document</value>
        ...
        /// </summary>
        /// <value>ข้อมูลเอกสารปลายทางที่อ้างอิง ถึง เอกสารฉบับนี้</value>
        ...
        /// </summary>
        /// <value>เอกสารต้นทางที่อ้างอิง ถึง เอกสารฉบับนี้</value>
        ...
        public SimpleDocumentResponseAllOfDataPayments Payments { get; set; }

        /// <summary>
        /// Gets or Sets Company
        /// </summary>
        [DataMember(Name="company", EmitDefaultValue=true)]
        public SimpleDocumentResponseAllOfDataCompany Company { get; set; }
        ...
        {
            return this.Equals(input as SimpleDocumentResponseAllOfData);
        }

        /// <summary>
        /// Returns true if SimpleDocumentResponseAllOfData instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleDocumentResponseAllOfData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleDocumentResponseAllOfData input)
        {
            if (input == null)
                return false;
