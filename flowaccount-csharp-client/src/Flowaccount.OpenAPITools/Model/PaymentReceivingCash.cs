...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class PaymentReceivingCash :  IEquatable<PaymentReceivingCash>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentReceivingCash" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentReceivingCash() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentReceivingCash" /> class.
        /// </summary>
        /// <param name="paymentStructureType">รับชำระเงิน ด้วยเงินสด (required).</param>
        ...
        public PaymentReceivingCash(string paymentStructureType = default(string), long documentId = default(long), long paymentMethod = 1, DateTime paymentDate = default(DateTime), decimal collected = 0M, long paymentDeductionType = 0, decimal paymentDeductionAmount = 0M, long withheldPercentage = 0, decimal withheldAmount = 0M, string paymentRemarks = default(string), long remainingCollectedType = 0, decimal remainingCollected = 0M)
        {
            // to ensure "paymentStructureType" is required (not null)
            if (paymentStructureType == null)
            {
                throw new InvalidDataException("paymentStructureType is a required property for PaymentReceivingCash and cannot be null");
            }
            else
            {
            ...
            if (documentId == null)
            {
                throw new InvalidDataException("documentId is a required property for PaymentReceivingCash and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for PaymentReceivingCash and cannot be null");
            }
            else
            {
            ...
            if (paymentDate == null)
            {
                throw new InvalidDataException("paymentDate is a required property for PaymentReceivingCash and cannot be null");
            }
            else
            {
            ...
            if (collected == null)
            {
                throw new InvalidDataException("collected is a required property for PaymentReceivingCash and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>รับชำระเงิน ด้วยเงินสด</value>
        ...
        {
            return this.Equals(input as PaymentReceivingCash);
        }

        /// <summary>
        /// Returns true if PaymentReceivingCash instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentReceivingCash to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentReceivingCash input)
        {
            if (input == null)
                return false;
