...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineDocumentResponseAllOfData :  IEquatable<InlineDocumentResponseAllOfData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineDocumentResponseAllOfData" /> class.
        /// </summary>
        ...
        /// <param name="items">รายการสินค้าใช้งานสำหรับเอกสาร Inline Document.</param>
        ...
        /// </summary>
        /// <value>รายการสินค้าใช้งานสำหรับเอกสาร Inline Document</value>
        ...
        {
            return this.Equals(input as InlineDocumentResponseAllOfData);
        }

        /// <summary>
        /// Returns true if InlineDocumentResponseAllOfData instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineDocumentResponseAllOfData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineDocumentResponseAllOfData input)
        {
            if (input == null)
                return false;
