...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class PaymentReceivingCreditCard :  IEquatable<PaymentReceivingCreditCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentReceivingCreditCard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentReceivingCreditCard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentReceivingCreditCard" /> class.
        /// </summary>
        ...
        public PaymentReceivingCreditCard(string paymentStructureType = default(string), long documentId = default(long), long paymentMethod = 1, DateTime paymentDate = default(DateTime), decimal collected = 0M, long paymentDeductionType = 0, decimal paymentDeductionAmount = 0M, long withheldPercentage = 0, decimal withheldAmount = 0M, long creditCardBankAccountId = 0, string paymentRemarks = default(string), long remainingCollectedType = 0, decimal remainingCollected = 0M)
        {
            // to ensure "paymentStructureType" is required (not null)
            if (paymentStructureType == null)
            {
                throw new InvalidDataException("paymentStructureType is a required property for PaymentReceivingCreditCard and cannot be null");
            }
            else
            {
            ...
            if (documentId == null)
            {
                throw new InvalidDataException("documentId is a required property for PaymentReceivingCreditCard and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for PaymentReceivingCreditCard and cannot be null");
            }
            else
            {
            ...
            if (paymentDate == null)
            {
                throw new InvalidDataException("paymentDate is a required property for PaymentReceivingCreditCard and cannot be null");
            }
            else
            {
            ...
            if (collected == null)
            {
                throw new InvalidDataException("collected is a required property for PaymentReceivingCreditCard and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PaymentReceivingCreditCard);
        }

        /// <summary>
        /// Returns true if PaymentReceivingCreditCard instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentReceivingCreditCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentReceivingCreditCard input)
        {
            if (input == null)
                return false;
