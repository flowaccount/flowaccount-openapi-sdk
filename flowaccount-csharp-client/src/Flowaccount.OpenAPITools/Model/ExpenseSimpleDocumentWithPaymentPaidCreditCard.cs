...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class ExpenseSimpleDocumentWithPaymentPaidCreditCard :  IEquatable<ExpenseSimpleDocumentWithPaymentPaidCreditCard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpenseSimpleDocumentWithPaymentPaidCreditCard" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExpenseSimpleDocumentWithPaymentPaidCreditCard() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpenseSimpleDocumentWithPaymentPaidCreditCard" /> class.
        /// </summary>
        ...
        public ExpenseSimpleDocumentWithPaymentPaidCreditCard(string contactCode = default(string), string contactName = default(string), string contactAddress = default(string), string contactTaxId = default(string), string contactBranch = default(string), string contactPerson = default(string), string contactEmail = default(string), string contactNumber = default(string), string contactZipCode = default(string), int contactGroup = 1, DateTime publishedOn = default(DateTime), int creditType = 1, int creditDays = 0, DateTime dueDate = default(DateTime), string salesName = "อีเมล หรือ ชื่อผู้สร้างเอกสาร", string projectName = default(string), string reference = default(string), bool isVatInclusive = false, List<ExpenseSimpleProductItem> items = default(List<ExpenseSimpleProductItem>), decimal subTotal = 0M, int discountPercentage = 0, decimal discountAmount = 0M, decimal totalAfterDiscount = default(decimal), bool isVat = false, decimal vatAmount = default(decimal), decimal grandTotal = default(decimal), string remarks = default(string), string internalNotes = default(string), bool showSignatureOrStamp = true, string expensePaymentStructureType = default(string), long paymentMethod = 1, DateTime paymentDate = default(DateTime), decimal collected = 0M, long withheldPercentage = 0, decimal withheldAmount = 0M, long creditCardBankAccountId = 0, string paymentRemarks = default(string), long remainingCollectedType = 0, decimal remainingCollected = 0M)
        {
            ...
            if (publishedOn == null)
            {
                throw new InvalidDataException("publishedOn is a required property for ExpenseSimpleDocumentWithPaymentPaidCreditCard and cannot be null");
            }
            else
            {
            ...
            if (dueDate == null)
            {
                throw new InvalidDataException("dueDate is a required property for ExpenseSimpleDocumentWithPaymentPaidCreditCard and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("totalAfterDiscount is a required property for ExpenseSimpleDocumentWithPaymentPaidCreditCard and cannot be null");
            }
            else
            {
            ...
            if (grandTotal == null)
            {
                throw new InvalidDataException("grandTotal is a required property for ExpenseSimpleDocumentWithPaymentPaidCreditCard and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("expensePaymentStructureType is a required property for ExpenseSimpleDocumentWithPaymentPaidCreditCard and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for ExpenseSimpleDocumentWithPaymentPaidCreditCard and cannot be null");
            }
            else
            {
            ...
            if (paymentDate == null)
            {
                throw new InvalidDataException("paymentDate is a required property for ExpenseSimpleDocumentWithPaymentPaidCreditCard and cannot be null");
            }
            else
            {
            ...
            if (collected == null)
            {
                throw new InvalidDataException("collected is a required property for ExpenseSimpleDocumentWithPaymentPaidCreditCard and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ExpenseSimpleDocumentWithPaymentPaidCreditCard);
        }

        /// <summary>
        /// Returns true if ExpenseSimpleDocumentWithPaymentPaidCreditCard instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpenseSimpleDocumentWithPaymentPaidCreditCard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpenseSimpleDocumentWithPaymentPaidCreditCard input)
        {
            if (input == null)
                return false;
