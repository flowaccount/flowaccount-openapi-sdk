...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class ContactResponse :  IEquatable<ContactResponse>, IValidatableObject
    {
        ...
        public ContactResponse(bool status = default(bool), string message = default(string), int code = default(int), ContactResponseData data = default(ContactResponseData))
        {
            this.Status = status;
        ...
        public ContactResponseData Data { get; set; }
