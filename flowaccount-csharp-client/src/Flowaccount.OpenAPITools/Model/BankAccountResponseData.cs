...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BankAccountResponseData :  IEquatable<BankAccountResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankAccountResponseData" /> class.
        /// </summary>
        ...
        public BankAccountResponseData(long bankAccountId = default(long), string bankAccountNumber = default(string), string bankAccountName = default(string), long bankAccountType = default(long), string bankBranch = default(string), long bankId = default(long), string bankName = default(string))
        {
        ...
        {
            return this.Equals(input as BankAccountResponseData);
        }

        /// <summary>
        /// Returns true if BankAccountResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of BankAccountResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankAccountResponseData input)
        {
            if (input == null)
                return false;
