...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class InlineProductItem :  IEquatable<InlineProductItem>, IValidatableObject
    {
        ...
        public InlineProductItem(int type = 1, string name = default(string), string description = default(string), decimal quantity = default(decimal), string unitName = default(string), decimal pricePerUnit = default(decimal), decimal total = default(decimal), string sellChartOfAccountCode = default(string), string buyChartOfAccountCode = default(string), decimal discountAmount = 0M, int vatRate = 7)
        {
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for InlineProductItem and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("pricePerUnit is a required property for InlineProductItem and cannot be null");
            }
            else
            {
            ...
            if (total == null)
            {
                throw new InvalidDataException("total is a required property for InlineProductItem and cannot be null");
            }
            else
            {
                this.Total = total;
