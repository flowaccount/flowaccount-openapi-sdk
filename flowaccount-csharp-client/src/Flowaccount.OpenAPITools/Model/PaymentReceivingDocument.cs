...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class PaymentReceivingDocument :  IEquatable<PaymentReceivingDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentReceivingDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentReceivingDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentReceivingDocument" /> class.
        /// </summary>
        ...
        public PaymentReceivingDocument(string paymentStructureType = default(string), long documentId = default(long), long paymentMethod = 1, DateTime paymentDate = default(DateTime), decimal collected = 0M, long paymentDeductionType = 0, decimal paymentDeductionAmount = 0M, long withheldPercentage = 0, decimal withheldAmount = 0M, long transferBankAccountId = 0, long bankAccountId = 0, string paymentRemarks = default(string), long remainingCollectedType = 0, decimal remainingCollected = 0M, DateTime chequeDate = default(DateTime), string chequeNumber = default(string), long chequeBankAccountId = 0, long creditCardBankAccountId = 0)
        {
            // to ensure "paymentStructureType" is required (not null)
            if (paymentStructureType == null)
            {
                throw new InvalidDataException("paymentStructureType is a required property for PaymentReceivingDocument and cannot be null");
            }
            else
            {
            ...
            if (documentId == null)
            {
                throw new InvalidDataException("documentId is a required property for PaymentReceivingDocument and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("paymentMethod is a required property for PaymentReceivingDocument and cannot be null");
            }
            else
            {
            ...
            if (paymentDate == null)
            {
                throw new InvalidDataException("paymentDate is a required property for PaymentReceivingDocument and cannot be null");
            }
            else
            {
            ...
            if (collected == null)
            {
                throw new InvalidDataException("collected is a required property for PaymentReceivingDocument and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as PaymentReceivingDocument);
        }

        /// <summary>
        /// Returns true if PaymentReceivingDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentReceivingDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentReceivingDocument input)
        {
            if (input == null)
                return false;
