...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    public partial class ProductType :  IEquatable<ProductType>, IValidatableObject
    {
        ...
        public ProductType(string productStructureType = default(string), long type = 1, string code = default(string), string name = default(string), string sellDescription = default(string), decimal sellPrice = default(decimal), long sellVatType = 3, string unitName = default(string), string categoryName = default(string), string barcode = default(string), string buyDescription = default(string), decimal buyPrice = default(decimal), long buyVatType = 3, string inventoryPublishedOn = "2020-01-01", decimal inventoryQuantity = 0M, decimal inventoryPrice = 0M)
        {
            ...
            if (unitName == null)
            {
                throw new InvalidDataException("unitName is a required property for ProductType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("inventoryPublishedOn is a required property for ProductType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("inventoryQuantity is a required property for ProductType and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("inventoryPrice is a required property for ProductType and cannot be null");
            }
            else
            {
