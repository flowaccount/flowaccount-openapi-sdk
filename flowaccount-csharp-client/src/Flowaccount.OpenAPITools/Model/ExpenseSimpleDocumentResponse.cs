...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpenseSimpleDocumentResponse :  IEquatable<ExpenseSimpleDocumentResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ExpenseSimpleDocumentResponse(bool status = default(bool), string message = default(string), int code = default(int), Object data = default(Object))
        {
            this.Status = status;
