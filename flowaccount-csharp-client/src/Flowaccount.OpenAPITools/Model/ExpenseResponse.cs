...
namespace Flowaccount.OpenAPITools.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(ExpenseInlineDocumentResponse), "ExpenseInlineDocumentResponse")]
    [JsonSubtypes.KnownSubType(typeof(ExpenseSimpleDocumentResponse), "ExpenseSimpleDocumentResponse")]
    public partial class ExpenseResponse :  IEquatable<ExpenseResponse>, IValidatableObject
    {
        ...
        public ExpenseResponse(bool status = default(bool), string message = default(string), int code = default(int), string expenseStructureType = default(string))
        {
