...
namespace Flowaccount.OpenAPITools.Api
{
    ...
    public interface IBankAccountApi : IApiAccessor
    {
        ...
        /// <returns>AllBankAccountResponse</returns>
        ...
        /// <exception cref="Flowaccount.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization"></param>
        /// <returns>ApiResponse of AllBankAccountResponse</returns>
        ApiResponse<AllBankAccountResponse> BankAccountsGetWithHttpInfo (string authorization);
        /// <summary>
        /// Create bank account.
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Flowaccount.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization"></param>
        /// <returns>Task of AllBankAccountResponse</returns>
        System.Threading.Tasks.Task<AllBankAccountResponse> BankAccountsGetAsync (string authorization);
        ...
        /// <exception cref="Flowaccount.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization"></param>
        /// <returns>Task of ApiResponse (AllBankAccountResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<AllBankAccountResponse>> BankAccountsGetAsyncWithHttpInfo (string authorization);
        /// <summary>
        /// Create bank account.
        /// </summary>
        /// <remarks>
    ...
    public partial class BankAccountApi : IBankAccountApi
    {
        ...
        /// <param name="authorization"></param>
        /// <returns>AllBankAccountResponse</returns>
        public AllBankAccountResponse BankAccountsGet (string authorization)
        {
             ApiResponse<AllBankAccountResponse> localVarResponse = BankAccountsGetWithHttpInfo(authorization);
        ...
        /// <param name="authorization"></param>
        /// <returns>ApiResponse of AllBankAccountResponse</returns>
        public ApiResponse<AllBankAccountResponse> BankAccountsGetWithHttpInfo (string authorization)
        {
            ...
            return new ApiResponse<AllBankAccountResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (AllBankAccountResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(AllBankAccountResponse)));
        }
        ...
        /// <param name="authorization"></param>
        /// <returns>Task of AllBankAccountResponse</returns>
        public async System.Threading.Tasks.Task<AllBankAccountResponse> BankAccountsGetAsync (string authorization)
        {
             ApiResponse<AllBankAccountResponse> localVarResponse = await BankAccountsGetAsyncWithHttpInfo(authorization);
             return localVarResponse.Data;
        ...
        /// <param name="authorization"></param>
        /// <returns>Task of ApiResponse (AllBankAccountResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AllBankAccountResponse>> BankAccountsGetAsyncWithHttpInfo (string authorization)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling BankAccountApi->BankAccountsGet");
