...
${nuget_cmd} install src/Flowaccount.OpenAPITools/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Flowaccount.OpenAPITools.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Flowaccount.OpenAPITools.dll \
-recurse:'src/Flowaccount.OpenAPITools/*.cs' \
-doc:bin/Flowaccount.OpenAPITools.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Flowaccount.OpenAPITools.dll was created successfully"
fi
