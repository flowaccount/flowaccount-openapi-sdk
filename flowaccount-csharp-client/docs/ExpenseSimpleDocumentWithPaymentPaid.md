...
# Flowaccount.OpenAPITools.Model.ExpenseSimpleDocumentWithPaymentPaid
...
**PaymentMethod** | **long** | ประเภทการชำระเงิน &lt;br&gt; 7 &#x3D; บัตรเครดิต | [default to 1]
...
**PaymentCharge** | **decimal** | ค่าธรรมเนียม ที่ชำระโดยเช็ค &lt;br&gt; &lt;ex&gt; Example : 100.00 &lt;/ex&gt; | [optional] [default to 0M]
