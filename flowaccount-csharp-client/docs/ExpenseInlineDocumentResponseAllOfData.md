...
# Flowaccount.OpenAPITools.Model.ExpenseInlineDocumentResponseAllOfData
...
**Payments** | [**List&lt;PaymentDocumentResponse&gt;**](PaymentDocumentResponse.md) | ข้อมูลการจ่ายเงินของเอกสารค่าใช้จ่าย | [optional] 
