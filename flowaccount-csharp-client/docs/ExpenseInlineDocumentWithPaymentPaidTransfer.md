...
# Flowaccount.OpenAPITools.Model.ExpenseInlineDocumentWithPaymentPaidTransfer
...
**PaymentMethod** | **long** | ประเภทการชำระเงิน &lt;br&gt; 5 &#x3D; โอนเงิน  | [default to 1]
...
**BankAccountId** | **long** | เลข id บัญชีธนาคารที่ใช้ชำระเงิน &lt;br&gt;&lt;red&gt;สามารถ GET มาได้จาก My Company &gt; Bank Account &lt;/red&gt;&lt;br&gt; &lt;ex&gt;Example: 12345&lt;/ex&gt; | [optional] [default to 0]
**PaymentCharge** | **decimal** | ค่าธรรมเนียม ที่ชำระโดยการโอนเงิน &lt;ex&gt; Example : 100.00 &lt;/ex&gt; | [optional] [default to 0M]
