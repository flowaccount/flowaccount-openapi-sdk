...
public struct CompanyInfo: Codable { 
    ...
    public init(companyType: String?, compnayName: String, companyNameEn: String?, companyAddress: String?, companyAddressEn: String?, companyZipCode: String?, companyTaxId: String?, companyBranch: String?, companyBranchEn: String?, companyBranchCode: String?, companyPhone: String?, companyMobile: String?, companyFax: String?, companyWebsite: String?) {
