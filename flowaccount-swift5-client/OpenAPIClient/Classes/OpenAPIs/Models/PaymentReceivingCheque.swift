...
public struct PaymentReceivingCheque: Codable { 
    ...
    public init(paymentStructureType: String?, documentId: Int64, paymentMethod: Int64, paymentDate: Date, collected: Double, paymentDeductionType: Int64?, paymentDeductionAmount: Double?, withheldPercentage: Int64?, withheldAmount: Double?, chequeDate: Date?, chequeNumber: String?, chequeBankAccountId: Int64?, paymentRemarks: String?, remainingCollectedType: Int64?, remainingCollected: Double?) {
