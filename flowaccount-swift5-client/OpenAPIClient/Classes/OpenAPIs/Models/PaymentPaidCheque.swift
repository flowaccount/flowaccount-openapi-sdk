...
public struct PaymentPaidCheque: Codable { 
    ...
    public init(paymentStructureType: String?, documentId: Int64, paymentMethod: Int64, paymentDate: Date, collected: Double, withheldPercentage: Int64?, withheldAmount: Double?, chequeDate: Date?, chequeNumber: String?, chequeBankAccountId: Int64?, bankAccountId: Int64?, paymentCharge: Double?, paymentRemarks: String?, remainingCollectedType: Int64?, remainingCollected: Double?) {
