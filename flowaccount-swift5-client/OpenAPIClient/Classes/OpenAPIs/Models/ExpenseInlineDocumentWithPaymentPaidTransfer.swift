//
// ExpenseInlineDocumentWithPaymentPaidTransfer.swift
//
...
public struct ExpenseInlineDocumentWithPaymentPaidTransfer: Codable { 
    ...
    public init(contactCode: String?, contactName: String, contactAddress: String?, contactTaxId: String?, contactBranch: String?, contactPerson: String?, contactEmail: String?, contactNumber: String?, contactZipCode: String?, contactGroup: Int?, publishedOn: Date, creditType: Int?, creditDays: Int?, dueDate: Date, salesName: String?, projectName: String?, reference: String?, isVatInclusive: Bool?, items: [ExpenseInlineProductItem]?, subTotal: Double?, discountPercentage: Int?, discountAmount: Double?, totalAfterDiscount: Double, isVat: Bool?, vatAmount: Double?, grandTotal: Double, discountType: Int?, useInlineDiscount: Bool?, useInlineVat: Bool?, exemptAmount: Double?, remarks: String?, internalNotes: String?, showSignatureOrStamp: Bool?, expensePaymentStructureType: String?, paymentMethod: Int64, paymentDate: Date, collected: Double, withheldPercentage: Int64?, withheldAmount: Double?, transferBankAccountId: Int64?, bankAccountId: Int64?, paymentCharge: Double?, paymentRemarks: String?, remainingCollectedType: Int64?, remainingCollected: Double?) {
