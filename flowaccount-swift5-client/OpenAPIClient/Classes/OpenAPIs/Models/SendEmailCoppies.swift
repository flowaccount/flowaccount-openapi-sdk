...
public struct SendEmailCoppies: Codable { 
    ...
    public init(documentId: Int64, fromemail: String, toemail: String, cCMyself: Bool?, ccEmail: String?, bccEmail: String?, subject: String, message: String?, doCopy: Bool?) {
