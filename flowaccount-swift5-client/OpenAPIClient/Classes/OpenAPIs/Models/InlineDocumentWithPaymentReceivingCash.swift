//
// InlineDocumentWithPaymentReceivingCash.swift
//
...
public struct InlineDocumentWithPaymentReceivingCash: Codable { 
    ...
    public init(contactCode: String?, contactName: String, contactAddress: String?, contactTaxId: String?, contactBranch: String?, contactPerson: String?, contactEmail: String?, contactNumber: String?, contactZipCode: String?, contactGroup: Int?, publishedOn: Date, creditType: Int?, creditDays: Int?, dueDate: Date, salesName: String?, projectName: String?, reference: String?, isVatInclusive: Bool?, useReceiptDeduction: Bool?, items: [SimpleProductItem]?, subTotal: Double?, discountPercentage: Int?, discountAmount: Double?, totalAfterDiscount: Double, isVat: Bool?, vatAmount: Double?, grandTotal: Double, discountType: Int?, useInlineDiscount: Bool?, useInlineVat: Bool?, exemptAmount: Double?, vatableAmount: Double?, documentShowWithholdingTax: Bool?, documentWithholdingTaxPercentage: Int?, documentWithholdingTaxAmount: Double?, documentDeductionType: Int?, documentDeductionAmount: Double?, remarks: String?, internalNotes: String?, showSignatureOrStamp: Bool?, documentReference: [UpgradeDocument]?, documentPaymentStructureType: String?, paymentMethod: Int64, paymentDate: Date, collected: Double, paymentDeductionType: Int64?, paymentDeductionAmount: Double?, withheldPercentage: Int64?, withheldAmount: Double?, paymentRemarks: String?, remainingCollectedType: Int64?, remainingCollected: Double?) {
