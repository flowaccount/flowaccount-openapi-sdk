...
public struct UpdateInlineDocument: Codable { 
    ...
    public init(recordId: Int64?, companyName: String, companyNameEn: String?, companyAddress: String?, companyAddressEn: String?, companyTaxId: String?, companyBranch: String, companyBranchEn: String?, companyPhone: String?, companyMobile: String?, companyFax: String?, companyWebsite: String?, contactCode: String?, contactName: String, contactAddress: String?, contactTaxId: String?, contactBranch: String?, contactPerson: String?, contactEmail: String?, contactNumber: String?, contactZipCode: String?, contactGroup: Int?, publishedOn: Date, creditType: Int?, creditDays: Int?, dueDate: Date, salesName: String?, projectName: String?, reference: String?, isVatInclusive: Bool?, useReceiptDeduction: Bool?, subTotal: Double?, discountPercentage: Int?, discountAmount: Double?, totalAfterDiscount: Double, isVat: Bool?, vatAmount: Double?, grandTotal: Double, documentShowWithholdingTax: Bool?, documentWithholdingTaxPercentage: Int?, documentWithholdingTaxAmount: Double?, documentDeductionType: Int?, documentDeductionAmount: Double?, remarks: String?, internalNotes: String?, showSignatureOrStamp: Bool?, documentStructureType: String?, discountType: Int?, useInlineDiscount: Bool?, useInlineVat: Bool?, exemptAmount: Double?, vatableAmount: Double?, items: [InlineProductItem]?, documentReference: [UpgradeDocument]?) {
