//
// PaymentReceivingDocument.swift
//
...
public struct PaymentReceivingDocument: Codable { 
    ...
    public init(paymentStructureType: String?, documentId: Int64, paymentMethod: Int64, paymentDate: Date, collected: Double, paymentDeductionType: Int64?, paymentDeductionAmount: Double?, withheldPercentage: Int64?, withheldAmount: Double?, paymentRemarks: String?, remainingCollectedType: Int64?, remainingCollected: Double?, transferBankAccountId: Int64?, bankAccountId: Int64?, chequeDate: Date?, chequeNumber: String?, chequeBankAccountId: Int64?, creditCardBankAccountId: Int64?) {
