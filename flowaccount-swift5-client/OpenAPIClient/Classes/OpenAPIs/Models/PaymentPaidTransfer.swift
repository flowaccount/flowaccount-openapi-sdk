...
public struct PaymentPaidTransfer: Codable { 
    ...
    public init(paymentStructureType: String?, documentId: Int64, paymentMethod: Int64, paymentDate: Date, collected: Double, withheldPercentage: Int64?, withheldAmount: Double?, transferBankAccountId: Int64?, bankAccountId: Int64?, paymentCharge: Double?, paymentRemarks: String?, remainingCollectedType: Int64?, remainingCollected: Double?) {
