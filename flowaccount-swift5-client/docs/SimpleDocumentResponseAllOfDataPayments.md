...
**collected** | **Double** | จำนวนเงินยอดรับสุทธิ | [optional] [default to 0]
...
**paymentDeductionAmount** | **Double** | จำนวนเงินยอดรายการปรับลด &lt;br&gt; (เฉพาะเอกสารใบกำกับภาษี/ใบเสร็จรับเงิน) | [optional] [default to 0]
**withheldPercentage** | **Int64** | เปอร์เซ็น หัก ณ ที่จ่าย | [optional] [default to 0]
**withheldAmount** | **Double** | จำนวน ยอดหัก ณ ที่จ่าย | [optional] [default to 0]
**paymentCharge** | **Double** | ค่าธรรมเนียม ที่ชำระโดยการโอนเงิน หรือ เช็ค &lt;br&gt; (เฉพาะเอกสารค่าใช้จ่าย) | [optional] [default to 0]
...
**remainingCollected** | **Double** | จำนวน ยอดเงินขาด หรือ เงินเกิน | [optional] [default to 0]
