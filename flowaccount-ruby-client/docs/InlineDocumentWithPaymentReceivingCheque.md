# OpenapiClient::InlineDocumentWithPaymentReceivingCheque
...
**document_payment_structure_type** | **String** | สร้างเอกสารแบบ Inline พร้อมรับชำระเงิน ด้วยเช็ค | 
...
instance = OpenapiClient::InlineDocumentWithPaymentReceivingCheque.new(contact_code: null,
