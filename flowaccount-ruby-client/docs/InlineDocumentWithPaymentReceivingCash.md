# OpenapiClient::InlineDocumentWithPaymentReceivingCash
...
**document_payment_structure_type** | **String** | สร้างเอกสารแบบ Inline พร้อมรับชำระเงิน ด้วยเงินสด | 
...
instance = OpenapiClient::InlineDocumentWithPaymentReceivingCash.new(contact_code: null,
