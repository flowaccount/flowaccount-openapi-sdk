# OpenapiClient::SimpleDocumentWithPaymentReceivingCash
...
**document_payment_structure_type** | **String** | สร้างเอกสารแบบ Simple พร้อมรับชำระเงิน ด้วยเงินสด | 
**payment_method** | **Integer** | ประเภทการเก็บเงิน &lt;br&gt; 1 &#x3D; เงินสด | [default to 1]
...
instance = OpenapiClient::SimpleDocumentWithPaymentReceivingCash.new(contact_code: null,
