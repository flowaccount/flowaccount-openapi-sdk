# OpenapiClient::SimpleDocumentWithPaymentReceiving
...
**document_payment_structure_type** | **String** | สร้างเอกสารแบบ Simple พร้อมรับชำระเงิน ด้วยบัตรเครดิต | 
...
instance = OpenapiClient::SimpleDocumentWithPaymentReceiving.new(contact_code: null,
