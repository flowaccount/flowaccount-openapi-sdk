# OpenapiClient::InlineDocumentWithPaymentPaidCreditCard
...
**document_payment_structure_type** | **String** | สร้างเอกสารแบบ Inline พร้อมชำระเงิน ด้วยบัตรเครดิต | 
...
instance = OpenapiClient::InlineDocumentWithPaymentPaidCreditCard.new(contact_code: null,
