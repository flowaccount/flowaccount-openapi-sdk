# OpenapiClient::SimpleDocumentWithPaymentPaidCreditCard
...
**document_payment_structure_type** | **String** | สร้างเอกสารแบบ Simple พร้อมชำระเงิน ด้วยบัตรเครดิต | 
**payment_method** | **Integer** | ประเภทการชำระเงิน &lt;br&gt; 7 &#x3D; บัตรเครดิต | [default to 1]
...
instance = OpenapiClient::SimpleDocumentWithPaymentPaidCreditCard.new(contact_code: null,
