# OpenapiClient::SimpleDocumentResponseAllOfData
...
**items** | [**Array&lt;SimpleProductItem&gt;**](SimpleProductItem.md) | รายการสินค้าใช้งานสำหรับเอกสาร Simple Document | [optional] 
...
instance = OpenapiClient::SimpleDocumentResponseAllOfData.new(record_id: null,
                                 document_id: null,
