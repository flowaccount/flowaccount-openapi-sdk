# OpenapiClient::SimpleDocumentWithPaymentPaidCash
...
**document_payment_structure_type** | **String** | สร้างเอกสารแบบ Simple พร้อมชำระเงิน ด้วยเงินสด | 
...
instance = OpenapiClient::SimpleDocumentWithPaymentPaidCash.new(contact_code: null,
