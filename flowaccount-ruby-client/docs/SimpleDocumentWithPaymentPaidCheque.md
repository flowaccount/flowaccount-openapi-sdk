# OpenapiClient::SimpleDocumentWithPaymentPaidCheque
...
**document_payment_structure_type** | **String** | สร้างเอกสารแบบ Simple พร้อมชำระเงิน ด้วยเช็ค | 
...
instance = OpenapiClient::SimpleDocumentWithPaymentPaidCheque.new(contact_code: null,
