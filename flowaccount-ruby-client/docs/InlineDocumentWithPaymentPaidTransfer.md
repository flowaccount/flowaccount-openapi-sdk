# OpenapiClient::InlineDocumentWithPaymentPaidTransfer
...
**document_payment_structure_type** | **String** | สร้างเอกสารแบบ Inline พร้อมชำระเงิน ด้วยการโอนเงิน | 
...
instance = OpenapiClient::InlineDocumentWithPaymentPaidTransfer.new(contact_code: null,
