# OpenapiClient::InlineDocumentWithPaymentPaidCash
...
**document_payment_structure_type** | **String** | สร้างเอกสารแบบ Inline พร้อมชำระเงิน ด้วยเงินสด | 
...
instance = OpenapiClient::InlineDocumentWithPaymentPaidCash.new(contact_code: null,
