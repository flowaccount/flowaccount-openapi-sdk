...
module OpenapiClient
  class Product
    ...
    attr_accessor :remaining_stock

    # มูลค่าสินค้าคงเหลือในสต๊อก
    attr_accessor :total_value_in_hand
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'average_sell_price')
        self.average_sell_price = attributes[:'average_sell_price']
      end

      if attributes.key?(:'remaining_stock')
        self.remaining_stock = attributes[:'remaining_stock']
      end

      if attributes.key?(:'total_value_in_hand')
        self.total_value_in_hand = attributes[:'total_value_in_hand']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_value_in_hand == o.total_value_in_hand
    end
