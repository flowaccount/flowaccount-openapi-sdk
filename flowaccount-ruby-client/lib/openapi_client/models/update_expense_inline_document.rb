...
module OpenapiClient
  class UpdateExpenseInlineDocument < UpdateExpenseDocument
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::UpdateExpenseInlineDocument` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::UpdateExpenseInlineDocument`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vatable_amount == o.vatable_amount && super(o)
    end
    ...
    def hash
      [items, discount_type, use_inline_discount, use_inline_vat, exempt_amount, vatable_amount].hash
    end
