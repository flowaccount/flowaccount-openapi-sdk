...
export class CashInvoiceApi {
     ...
     */
    public async cashInvoicesIdPaymentPost (authorization: string, id: string, paymentReceivingDocument: PaymentReceivingDocument, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InlineDocumentResponse;  }> {
     ...
     */
    public async cashInvoicesInlineWithPaymentPost (authorization: string, inlineDocumentWithPaymentReceiving: InlineDocumentWithPaymentReceiving, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InlineDocumentResponse;  }> {
     ...
     */
    public async cashInvoicesWithPaymentPost (authorization: string, simpleDocumentWithPaymentReceiving: SimpleDocumentWithPaymentReceiving, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SimpleDocumentResponse;  }> {
