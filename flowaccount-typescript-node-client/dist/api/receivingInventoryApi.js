...
class ReceivingInventoryApi {
    ...
    purchasesGet(currentPage, pageSize, authorization, sortBy, filter, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    purchasesIdPut(authorization, id, updateInlineDocument, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/purchases/{id}'
                .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
            let localVarQueryParameters = {};
    ...
    purchasesIdStatusStatusIdPost(authorization, id, statusId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
