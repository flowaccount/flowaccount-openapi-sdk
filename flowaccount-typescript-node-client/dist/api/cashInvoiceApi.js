...
class CashInvoiceApi {
    ...
    cashInvoicesIdPaymentPost(authorization, id, paymentReceivingDocument, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (paymentReceivingDocument === null || paymentReceivingDocument === undefined) {
                throw new Error('Required parameter paymentReceivingDocument was null or undefined when calling cashInvoicesIdPaymentPost.');
            }
            localVarHeaderParams['Authorization'] = models_1.ObjectSerializer.serialize(authorization, "string");
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
    ...
    cashInvoicesInlineWithPaymentPost(authorization, inlineDocumentWithPaymentReceiving, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (inlineDocumentWithPaymentReceiving === null || inlineDocumentWithPaymentReceiving === undefined) {
                throw new Error('Required parameter inlineDocumentWithPaymentReceiving was null or undefined when calling cashInvoicesInlineWithPaymentPost.');
            }
            localVarHeaderParams['Authorization'] = models_1.ObjectSerializer.serialize(authorization, "string");
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
    ...
    cashInvoicesWithPaymentPost(authorization, simpleDocumentWithPaymentReceiving, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (simpleDocumentWithPaymentReceiving === null || simpleDocumentWithPaymentReceiving === undefined) {
                throw new Error('Required parameter simpleDocumentWithPaymentReceiving was null or undefined when calling cashInvoicesWithPaymentPost.');
            }
            localVarHeaderParams['Authorization'] = models_1.ObjectSerializer.serialize(authorization, "string");
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
